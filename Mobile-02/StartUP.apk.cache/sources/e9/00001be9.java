...
public final class EthereumModule_Companion_ProvidesETCTxRepository$ethereum_releaseFactory implements d<IETCTxRepository> {
    ...
    public EthereumModule_Companion_ProvidesETCTxRepository$ethereum_releaseFactory(Provider<AddressDao> provider, Provider<EthereumSignedTxDao> provider2, Provider<WalletDao> provider3, Provider<ERC20Dao> provider4, Provider<MinerFeeAPI> provider5, Provider<ERC20TokenAPI> provider6, Provider<CipherCoreInterface> provider7, Provider<StoreInterface> provider8) {
    ...
    public static EthereumModule_Companion_ProvidesETCTxRepository$ethereum_releaseFactory create(Provider<AddressDao> provider, Provider<EthereumSignedTxDao> provider2, Provider<WalletDao> provider3, Provider<ERC20Dao> provider4, Provider<MinerFeeAPI> provider5, Provider<ERC20TokenAPI> provider6, Provider<CipherCoreInterface> provider7, Provider<StoreInterface> provider8) {
        return new EthereumModule_Companion_ProvidesETCTxRepository$ethereum_releaseFactory(provider, provider2, provider3, provider4, provider5, provider6, provider7, provider8);
    }
    ...
    public static IETCTxRepository providesETCTxRepository$ethereum_release(AddressDao addressDao, EthereumSignedTxDao ethereumSignedTxDao, WalletDao walletDao, ERC20Dao eRC20Dao, MinerFeeAPI minerFeeAPI, ERC20TokenAPI eRC20TokenAPI, CipherCoreInterface cipherCoreInterface, StoreInterface storeInterface) {
        return (IETCTxRepository) h.f(EthereumModule.Companion.providesETCTxRepository$ethereum_release(addressDao, ethereumSignedTxDao, walletDao, eRC20Dao, minerFeeAPI, eRC20TokenAPI, cipherCoreInterface, storeInterface));
    }
