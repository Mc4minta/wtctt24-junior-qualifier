...
public class JPAKEParticipant {
    ...
    private BigInteger f17785b;
    private final Digest digest;

    /* renamed from: g  reason: collision with root package name */
    private final BigInteger f17786g;
    ...
    public BigInteger calculateKeyingMaterial() {
        ...
        if (i2 >= 50) {
            ...
            this.password = null;
            BigInteger calculateKeyingMaterial = JPAKEUtil.calculateKeyingMaterial(this.p, this.q, this.gx4, this.x2, calculateS, this.f17785b);
            this.x1 = null;
            this.x2 = null;
            this.f17785b = null;
            this.state = 50;
    ...
    public JPAKERound1Payload createRound1PayloadToSend() {
        if (this.state < 10) {
            ...
            this.gx1 = JPAKEUtil.calculateGx(this.p, this.f17786g, this.x1);
            this.gx2 = JPAKEUtil.calculateGx(this.p, this.f17786g, this.x2);
            BigInteger[] calculateZeroKnowledgeProof = JPAKEUtil.calculateZeroKnowledgeProof(this.p, this.q, this.f17786g, this.gx1, this.x1, this.participantId, this.digest, this.random);
            BigInteger[] calculateZeroKnowledgeProof2 = JPAKEUtil.calculateZeroKnowledgeProof(this.p, this.q, this.f17786g, this.gx2, this.x2, this.participantId, this.digest, this.random);
            this.state = 10;
    ...
    public void validateRound1PayloadReceived(JPAKERound1Payload jPAKERound1Payload) throws CryptoException {
        if (this.state < 20) {
            ...
            JPAKEUtil.validateZeroKnowledgeProof(this.p, this.q, this.f17786g, this.gx3, knowledgeProofForX1, jPAKERound1Payload.getParticipantId(), this.digest);
            JPAKEUtil.validateZeroKnowledgeProof(this.p, this.q, this.f17786g, this.gx4, knowledgeProofForX2, jPAKERound1Payload.getParticipantId(), this.digest);
            this.state = 20;
            return;
        }
    ...
    public void validateRound2PayloadReceived(JPAKERound2Payload jPAKERound2Payload) throws CryptoException {
        ...
        if (i2 >= 40) {
            ...
            this.f17785b = jPAKERound2Payload.getA();
            ...
            JPAKEUtil.validateZeroKnowledgeProof(this.p, this.q, calculateGA, this.f17785b, knowledgeProofForX2s, jPAKERound2Payload.getParticipantId(), this.digest);
            this.state = 40;
        } else {
    ...
    public JPAKEParticipant(String str, char[] cArr, JPAKEPrimeOrderGroup jPAKEPrimeOrderGroup, Digest digest, SecureRandom secureRandom) {
        ...
        if (cArr.length != 0) {
            ...
            this.f17786g = jPAKEPrimeOrderGroup.getG();
            this.digest = digest;
