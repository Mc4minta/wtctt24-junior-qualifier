...
final class ActionSheetDialogHelper$create$1$1 extends o implements l<View, x> {
    final /* synthetic */ ActionSheetDialogHelper.Action $action;
    final /* synthetic */ d0<DialogInterface> $dialogInterface;

    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public ActionSheetDialogHelper$create$1$1(ActionSheetDialogHelper.Action action, d0<DialogInterface> d0Var) {
        super(1);
        this.$action = action;
