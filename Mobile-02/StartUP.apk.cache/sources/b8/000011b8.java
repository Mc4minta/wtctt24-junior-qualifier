...
final class EventProperty_ApplicationKt$TopLevelDomain$2 extends o implements a<EventProperty> {
    public static final EventProperty_ApplicationKt$TopLevelDomain$2 INSTANCE = new EventProperty_ApplicationKt$TopLevelDomain$2();

    EventProperty_ApplicationKt$TopLevelDomain$2() {
        super(0);
    }
    ...
    public final EventProperty invoke() {
        return new EventProperty("top_level_domain");
    }
}