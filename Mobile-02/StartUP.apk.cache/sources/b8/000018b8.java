...
final class TransferMethodsAdapter$AddPaymentMethodViewHolder$bind$1 extends o implements l<View, x> {
    final /* synthetic */ AddPaymentTransferItem $item;
    final /* synthetic */ l<ConsumerTransferMethodItem, x> $onItemClickListener;

    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    /* JADX WARN: Multi-variable type inference failed */
    public TransferMethodsAdapter$AddPaymentMethodViewHolder$bind$1(l<? super ConsumerTransferMethodItem, x> lVar, AddPaymentTransferItem addPaymentTransferItem) {
        super(1);
        this.$onItemClickListener = lVar;
        this.$item = addPaymentTransferItem;
    }
    ...
    public final void invoke2(View it) {
        m.g(it, "it");
        this.$onItemClickListener.invoke(this.$item);
    }
}