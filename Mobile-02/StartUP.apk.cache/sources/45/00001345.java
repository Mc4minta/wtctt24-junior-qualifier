...
final class AddressKind_BitcoinKt$BitcoinLegacy$2 extends o implements a<AddressType> {
    public static final AddressKind_BitcoinKt$BitcoinLegacy$2 INSTANCE = new AddressKind_BitcoinKt$BitcoinLegacy$2();

    AddressKind_BitcoinKt$BitcoinLegacy$2() {
        super(0);
    }
    ...
    public final AddressType invoke() {
        return new AddressType("BitcoinLegacy");
    }
}