...
final class SendDestinationPickerFragment$wallet$2 extends kotlin.jvm.internal.o implements kotlin.e0.c.a<Wallet> {
    final /* synthetic */ SendDestinationPickerFragment this$0;

    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public SendDestinationPickerFragment$wallet$2(SendDestinationPickerFragment sendDestinationPickerFragment) {
        super(0);
    ...
    public final Wallet invoke() {
        return (Wallet) Bundle_CommonKt.requireParcelable(this.this$0.getArguments(), SendDestinationPickerArgs.WALLET);
    }
}