...
final class BackupRecoveryPhraseFragment$showBannedDialog$1 extends kotlin.jvm.internal.o implements kotlin.e0.c.l<c.a, kotlin.x> {
    public static final BackupRecoveryPhraseFragment$showBannedDialog$1 INSTANCE = new BackupRecoveryPhraseFragment$showBannedDialog$1();

    BackupRecoveryPhraseFragment$showBannedDialog$1() {
        super(1);
    }
    ...
    public final void invoke2(c.a showDialog) {
        ...
        showDialog.f(R.string.banned_location_dialog_recover_message);
