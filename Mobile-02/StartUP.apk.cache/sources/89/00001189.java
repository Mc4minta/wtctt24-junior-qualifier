...
final class EventFeature_ApplicationKt$Swap$2 extends o implements a<EventFeature> {
    public static final EventFeature_ApplicationKt$Swap$2 INSTANCE = new EventFeature_ApplicationKt$Swap$2();

    EventFeature_ApplicationKt$Swap$2() {
        super(0);
    }
