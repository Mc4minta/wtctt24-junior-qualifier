...
public class DigestScheme extends RFC2617Scheme {
    ...
    private Header createDigestHeader(Credentials credentials, HttpRequest httpRequest) throws AuthenticationException {
        ...
        String parameter3 = getParameter(AdjustableMinerFeeArgs.NONCE);
        ...
        if (parameter7 != null) {
            ...
            if ((httpRequest instanceof HttpEntityEnclosingRequest) && hashSet.contains("auth-int")) {
                ...
                c2 = hashSet.contains("auth") ? (char) 2 : (char) 65535;
            }
        } else {
            str = "qop";
            c2 = 0;
        ...
        if (c2 != 65535) {
            ...
            try {
                ...
                arrayList.add(new BasicNameValuePair(AdjustableMinerFeeArgs.NONCE, parameter3));
                arrayList.add(new BasicNameValuePair("uri", str4));
                arrayList.add(new BasicNameValuePair(Payload.RESPONSE, encode4));
                if (c2 != 0) {
                    if (c2 == 1) {
                        str5 = str2;
                    }
                ...
                for (int i3 = i2; i3 < arrayList.size(); i3++) {
                    ...
                    BasicHeaderValueFormatter.INSTANCE.formatNameValuePair(charArrayBuffer, nameValuePair, !(("nc".equals(name2) || str6.equals(name2) || "algorithm".equals(name2)) ? true : i2));
                }
    ...
    public Header authenticate(Credentials credentials, HttpRequest httpRequest, HttpContext httpContext) throws AuthenticationException {
        ...
        if (getParameter("realm") != null) {
            if (getParameter(AdjustableMinerFeeArgs.NONCE) != null) {
