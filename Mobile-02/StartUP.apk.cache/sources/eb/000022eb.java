...
public final class SwapInterstitialFragment$special$$inlined$viewModel$1 extends o implements kotlin.e0.c.a<d0.b> {
    final /* synthetic */ Fragment $this_viewModel;
    final /* synthetic */ SwapInterstitialFragment this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public SwapInterstitialFragment$special$$inlined$viewModel$1(Fragment fragment, SwapInterstitialFragment swapInterstitialFragment) {
        super(0);
    ...
    public final d0.b invoke() {
        ...
        return new androidx.lifecycle.a(arguments, this.this$0) { // from class: com.coinbase.wallet.features.swap.views.SwapInterstitialFragment$special$$inlined$viewModel$1.1
            final /* synthetic */ SwapInterstitialFragment this$0;
            ...
            protected <T extends b0> T create(String key, Class<T> modelClass, z handle) {
                ...
                m.g(handle, "handle");
                return this.this$0.getSwapInterstitialViewModelFactory().create(handle);
            }
        };
    }
}