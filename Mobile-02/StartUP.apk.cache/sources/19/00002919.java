...
public final class TxManagingModule_ProvidesBCHTxManaging$wallets_releaseFactory implements d<TxManaging> {
    ...
    public static TxManagingModule_ProvidesBCHTxManaging$wallets_releaseFactory create(Provider<BCHService> provider, Provider<AddressDao> provider2, Provider<WalletDao> provider3, Provider<BIP44SignedTxDao> provider4, Provider<CipherCoreInterface> provider5, Provider<StoreInterface> provider6, Provider<Tracing> provider7, Provider<BatchBalanceAPI> provider8) {
        return new TxManagingModule_ProvidesBCHTxManaging$wallets_releaseFactory(provider, provider2, provider3, provider4, provider5, provider6, provider7, provider8);
    }
    ...
    public static TxManaging providesBCHTxManaging$wallets_release(BCHService bCHService, AddressDao addressDao, WalletDao walletDao, BIP44SignedTxDao bIP44SignedTxDao, CipherCoreInterface cipherCoreInterface, StoreInterface storeInterface, Tracing tracing, BatchBalanceAPI batchBalanceAPI) {
        TxManaging providesBCHTxManaging$wallets_release;
        providesBCHTxManaging$wallets_release = TxManagingModule.Companion.providesBCHTxManaging$wallets_release(bCHService, addressDao, walletDao, bIP44SignedTxDao, cipherCoreInterface, storeInterface, tracing, batchBalanceAPI);
        return (TxManaging) h.f(providesBCHTxManaging$wallets_release);
    }
