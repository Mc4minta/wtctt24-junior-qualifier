...
final class EventProperty_ApplicationKt$WalletNumber$2 extends o implements a<EventProperty> {
    public static final EventProperty_ApplicationKt$WalletNumber$2 INSTANCE = new EventProperty_ApplicationKt$WalletNumber$2();

    EventProperty_ApplicationKt$WalletNumber$2() {
        super(0);
    }
    ...
    public final EventProperty invoke() {
        return new EventProperty("wallet_number");
    }
}