...
public final class Huffman {
    ...
    private final void addCode(int i2, int i3, int i4) {
        ...
        kotlin.a0.m.k(children2, node, i7, i8 + i7);
    }

    public final void decode(h source, long j2, g sink) {
        m.h(source, "source");
        m.h(sink, "sink");
        Node node = root;
        int i2 = 0;
        ...
        for (long j3 = 0; j3 < j2; j3++) {
            i2 = (i2 << 8) | Util.and(source.m0(), 255);
            i3 += 8;
            while (i3 >= 8) {
                int i4 = i3 - 8;
                int i5 = (i2 >>> i4) & 255;
    ...
    public final void encode(i source, g sink) throws IOException {
        ...
        for (int i3 = 0; i3 < Q; i3++) {
            int and = Util.and(source.A(i3), 255);
            int i4 = CODES[and];
    ...
    public final int encodedLength(i bytes) {
        ...
        for (int i2 = 0; i2 < Q; i2++) {
            j2 += CODE_BIT_COUNTS[Util.and(bytes.A(i2), 255)];
        }
        return (int) ((j2 + 7) >> 3);
    }
    ...
    /* compiled from: Huffman.kt */
    @Metadata(bv = {1, 0, 3}, d1 = {"\u0000\u0018\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\u0010\b\n\u0002\b\u0004\n\u0002\u0010\u0011\n\u0002\b\u000b\b\u0002\u0018\u00002\u00020\u0001B\t\b\u0016¢\u0006\u0004\b\u000e\u0010\u000fB\u0019\b\u0016\u0012\u0006\u0010\u0003\u001a\u00020\u0002\u0012\u0006\u0010\u0010\u001a\u00020\u0002¢\u0006\u0004\b\u000e\u0010\u0011R\u0019\u0010\u0003\u001a\u00020\u00028\u0006@\u0006¢\u0006\f\n\u0004\b\u0003\u0010\u0004\u001a\u0004\b\u0005\u0010\u0006R#\u0010\b\u001a\f\u0012\u0006\u0012\u0004\u0018\u00010\u0000\u0018\u00010\u00078\u0006@\u0006¢\u0006\f\n\u0004\b\b\u0010\t\u001a\u0004\b\n\u0010\u000bR\u0019\u0010\f\u001a\u00020\u00028\u0006@\u0006¢\u0006\f\n\u0004\b\f\u0010\u0004\u001a\u0004\b\r\u0010\u0006¨\u0006\u0012"}, d2 = {"Lokhttp3/internal/http2/Huffman$Node;", "", "", "symbol", "I", "getSymbol", "()I", "", "children", "[Lokhttp3/internal/http2/Huffman$Node;", "getChildren", "()[Lokhttp3/internal/http2/Huffman$Node;", "terminalBitCount", "getTerminalBitCount", "<init>", "()V", "bits", "(II)V", "okhttp"}, k = 1, mv = {1, 4, 0})
    /* loaded from: classes3.dex */
