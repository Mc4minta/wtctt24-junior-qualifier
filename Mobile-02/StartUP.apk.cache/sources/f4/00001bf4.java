...
public final class EthereumModule_ProvidesETHTxRepository$ethereum_releaseFactory implements d<IETHTxRepository> {
    ...
    public static EthereumModule_ProvidesETHTxRepository$ethereum_releaseFactory create(Provider<AddressDao> provider, Provider<WalletDao> provider2, Provider<EthereumSignedTxDao> provider3, Provider<ERC20Dao> provider4, Provider<MinerFeeAPI> provider5, Provider<ERC20TokenAPI> provider6, Provider<CipherCoreInterface> provider7, Provider<StoreInterface> provider8) {
        return new EthereumModule_ProvidesETHTxRepository$ethereum_releaseFactory(provider, provider2, provider3, provider4, provider5, provider6, provider7, provider8);
    }
    ...
    public static IETHTxRepository providesETHTxRepository$ethereum_release(AddressDao addressDao, WalletDao walletDao, EthereumSignedTxDao ethereumSignedTxDao, ERC20Dao eRC20Dao, MinerFeeAPI minerFeeAPI, ERC20TokenAPI eRC20TokenAPI, CipherCoreInterface cipherCoreInterface, StoreInterface storeInterface) {
        IETHTxRepository providesETHTxRepository$ethereum_release;
        providesETHTxRepository$ethereum_release = EthereumModule.Companion.providesETHTxRepository$ethereum_release(addressDao, walletDao, ethereumSignedTxDao, eRC20Dao, minerFeeAPI, eRC20TokenAPI, cipherCoreInterface, storeInterface);
        return (IETHTxRepository) h.f(providesETHTxRepository$ethereum_release);
    }
