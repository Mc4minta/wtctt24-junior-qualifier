...
final class EventProperty_ApplicationKt$SendCount$2 extends o implements a<EventProperty> {
    public static final EventProperty_ApplicationKt$SendCount$2 INSTANCE = new EventProperty_ApplicationKt$SendCount$2();

    EventProperty_ApplicationKt$SendCount$2() {
        super(0);
    }
    ...
    public final EventProperty invoke() {
        return new EventProperty("send_count");
    }
}