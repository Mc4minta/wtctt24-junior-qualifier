...
public class LitecoinService {
    ...
    /* compiled from: LitecoinService.kt */
    @Metadata(bv = {1, 0, 3}, d1 = {"\u0000\f\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0003\b\u0086\u0003\u0018\u00002\u00020\u0001B\t\b\u0002¢\u0006\u0004\b\u0002\u0010\u0003¨\u0006\u0004"}, d2 = {"Lcom/coinbase/walletengine/services/litecoin/LitecoinService$Companion;", "", "<init>", "()V", "wallet-engine_release"}, k = 1, mv = {1, 5, 1})
    /* loaded from: classes2.dex */
    ...
    public LitecoinService(WalletEngine walletEngine) {
    ...
    public static /* synthetic */ SignedTransaction a(LitecoinService litecoinService, String str) {
        return m2056signTransaction$lambda13(litecoinService, str);
    }

    public static /* synthetic */ Boolean b(LitecoinService litecoinService, String str) {
        return m2053isAddressUsed$lambda2(litecoinService, str);
    }

    public static /* synthetic */ BigInteger c(LitecoinService litecoinService, String str) {
        return m2049getBalance$lambda4(litecoinService, str);
    }
    ...
    private final b0<String> call(String str, Map<String, ? extends Object> map) {
        ...
        return walletEngine.call("litecoin", str, encodedParams);
    }

    public static /* synthetic */ TransactionResult d(LitecoinService litecoinService, String str) {
        return m2051getTransactionResult$lambda15(litecoinService, str);
    }
    ...
    public static final String m2046deriveLegacyAddressFromXpubKey_Yuhug_o$lambda0(LitecoinService this$0, String it) {
    ...
    public static final String m2047deriveSegwitAddressFromXpubKey_Yuhug_o$lambda16(LitecoinService this$0, String it) {
        kotlin.jvm.internal.m.g(this$0, "this$0");
        kotlin.jvm.internal.m.g(it, "it");
        return (String) this$0.decodeJson(String.class, it);
    }

    public static /* synthetic */ List e(LitecoinService litecoinService, String str) {
        return m2052getUTXOs$lambda7(litecoinService, str);
    }

    /* renamed from: estimateFee$lambda-5 */
    public static final List m2048estimateFee$lambda5(LitecoinService this$0, String it) {
        kotlin.jvm.internal.m.g(this$0, "this$0");
        kotlin.jvm.internal.m.g(it, "it");
    ...
    public static /* synthetic */ UInt f(LitecoinService litecoinService, String str) {
        return m2050getBlockHeight$lambda3(litecoinService, str);
    }

    public static /* synthetic */ x g(String str) {
        return m2057submitSignedTransaction$lambda14(str);
    }

    /* renamed from: getBalance$lambda-4 */
    public static final BigInteger m2049getBalance$lambda4(LitecoinService this$0, String it) {
        kotlin.jvm.internal.m.g(this$0, "this$0");
        kotlin.jvm.internal.m.g(it, "it");
    ...
    public static final UInt m2050getBlockHeight$lambda3(LitecoinService this$0, String it) {
        kotlin.jvm.internal.m.g(this$0, "this$0");
        kotlin.jvm.internal.m.g(it, "it");
    ...
    public static final TransactionResult m2051getTransactionResult$lambda15(LitecoinService this$0, String it) {
        kotlin.jvm.internal.m.g(this$0, "this$0");
        kotlin.jvm.internal.m.g(it, "it");
    ...
    public static final List m2052getUTXOs$lambda7(LitecoinService this$0, String it) {
        kotlin.jvm.internal.m.g(this$0, "this$0");
        kotlin.jvm.internal.m.g(it, "it");
    ...
    public static /* synthetic */ String h(LitecoinService litecoinService, String str) {
        return m2047deriveSegwitAddressFromXpubKey_Yuhug_o$lambda16(litecoinService, str);
    }

    public static /* synthetic */ String i(LitecoinService litecoinService, String str) {
        return m2046deriveLegacyAddressFromXpubKey_Yuhug_o$lambda0(litecoinService, str);
    }

    /* renamed from: isAddressUsed$lambda-2 */
    public static final Boolean m2053isAddressUsed$lambda2(LitecoinService this$0, String it) {
        kotlin.jvm.internal.m.g(this$0, "this$0");
        kotlin.jvm.internal.m.g(it, "it");
    ...
    public static final Boolean m2054isAddressValid$lambda1(LitecoinService this$0, String it) {
        kotlin.jvm.internal.m.g(this$0, "this$0");
        kotlin.jvm.internal.m.g(it, "it");
        return (Boolean) this$0.decodeJson(Boolean.class, it);
    }

    public static /* synthetic */ List j(LitecoinService litecoinService, String str) {
        return m2048estimateFee$lambda5(litecoinService, str);
    }

    public static /* synthetic */ CoinSelection k(LitecoinService litecoinService, String str) {
        return m2055selectCoins$lambda9(litecoinService, str);
    }

    public static /* synthetic */ Boolean l(LitecoinService litecoinService, String str) {
        return m2054isAddressValid$lambda1(litecoinService, str);
    }

    public static /* synthetic */ CoinSelection m(LitecoinService litecoinService, String str) {
        return m2058sweepCoins$lambda11(litecoinService, str);
    }

    /* renamed from: selectCoins$lambda-9 */
    public static final CoinSelection m2055selectCoins$lambda9(LitecoinService this$0, String it) {
        kotlin.jvm.internal.m.g(this$0, "this$0");
        kotlin.jvm.internal.m.g(it, "it");
    ...
    public static final SignedTransaction m2056signTransaction$lambda13(LitecoinService this$0, String it) {
        kotlin.jvm.internal.m.g(this$0, "this$0");
        kotlin.jvm.internal.m.g(it, "it");
    ...
    public static final x m2057submitSignedTransaction$lambda14(String it) {
        kotlin.jvm.internal.m.g(it, "it");
        return x.a;
    }

    /* renamed from: sweepCoins$lambda-11 */
    public static final CoinSelection m2058sweepCoins$lambda11(LitecoinService this$0, String it) {
        kotlin.jvm.internal.m.g(this$0, "this$0");
        kotlin.jvm.internal.m.g(it, "it");
        return (CoinSelection) this$0.decodeJson(CoinSelection.class, it);
    }
    ...
    public b0<String> m2059deriveLegacyAddressFromXpubKeyYuhug_o(String xpubKey, int i2, boolean z, boolean z2) {
        ...
        b0 map = call("deriveLegacyAddressFromXpubKey", l2).map(new n() { // from class: com.coinbase.walletengine.services.litecoin.i
            @Override // h.c.m0.n
            public final Object apply(Object obj) {
                return LitecoinService.i(LitecoinService.this, (String) obj);
            }
        });
    ...
    public b0<String> m2060deriveSegwitAddressFromXpubKeyYuhug_o(String xpubKey, int i2, boolean z, boolean z2) {
        Map<String, ? extends Object> l2;
        kotlin.jvm.internal.m.g(xpubKey, "xpubKey");
        l2 = m0.l(u.a("xpubKey", xpubKey), u.a("index", UInt.h(i2)), u.a("change", Boolean.valueOf(z)), u.a("testnet", Boolean.valueOf(z2)));
        b0 map = call("deriveSegwitAddressFromXpubKey", l2).map(new n() { // from class: com.coinbase.walletengine.services.litecoin.h
            @Override // h.c.m0.n
            public final Object apply(Object obj) {
                return LitecoinService.h(LitecoinService.this, (String) obj);
            }
        });
    ...
    public b0<List<BigInteger>> estimateFee(boolean z) {
        ...
        b0 map = call("estimateFee", e2).map(new n() { // from class: com.coinbase.walletengine.services.litecoin.j
            @Override // h.c.m0.n
            public final Object apply(Object obj) {
                return LitecoinService.j(LitecoinService.this, (String) obj);
            }
        });
    ...
    public b0<BigInteger> getBalance(String address, boolean z) {
        ...
        b0 map = call("getBalance", l2).map(new n() { // from class: com.coinbase.walletengine.services.litecoin.c
            @Override // h.c.m0.n
            public final Object apply(Object obj) {
                return LitecoinService.c(LitecoinService.this, (String) obj);
            }
        });
    ...
    public b0<UInt> getBlockHeight(boolean z) {
        Map<String, ? extends Object> e2;
        e2 = l0.e(u.a("testnet", Boolean.valueOf(z)));
        b0 map = call("getBlockHeight", e2).map(new n() { // from class: com.coinbase.walletengine.services.litecoin.f
            @Override // h.c.m0.n
            public final Object apply(Object obj) {
                return LitecoinService.f(LitecoinService.this, (String) obj);
            }
        });
    ...
    public b0<TransactionResult> getTransactionResult(String txHash, boolean z) {
        ...
        b0 map = call("getTransactionResult", l2).map(new n() { // from class: com.coinbase.walletengine.services.litecoin.d
            @Override // h.c.m0.n
            public final Object apply(Object obj) {
                return LitecoinService.d(LitecoinService.this, (String) obj);
            }
        });
    ...
    public b0<List<UTXO>> getUTXOs(List<String> addresses, boolean z) {
        ...
        l2 = m0.l(oVarArr);
        b0 map = call("getUTXOs", l2).map(new n() { // from class: com.coinbase.walletengine.services.litecoin.e
            @Override // h.c.m0.n
            public final Object apply(Object obj) {
                return LitecoinService.e(LitecoinService.this, (String) obj);
            }
        });
    ...
    public b0<Boolean> isAddressUsed(String address, boolean z) {
        ...
        kotlin.jvm.internal.m.g(address, "address");
        l2 = m0.l(u.a("address", address), u.a("testnet", Boolean.valueOf(z)));
        b0 map = call("isAddressUsed", l2).map(new n() { // from class: com.coinbase.walletengine.services.litecoin.b
            @Override // h.c.m0.n
            public final Object apply(Object obj) {
                return LitecoinService.b(LitecoinService.this, (String) obj);
            }
        });
    ...
    public b0<Boolean> isAddressValid(String address, boolean z) {
        ...
        kotlin.jvm.internal.m.g(address, "address");
        l2 = m0.l(u.a("address", address), u.a("testnet", Boolean.valueOf(z)));
        b0 map = call("isAddressValid", l2).map(new n() { // from class: com.coinbase.walletengine.services.litecoin.l
            @Override // h.c.m0.n
            public final Object apply(Object obj) {
                return LitecoinService.l(LitecoinService.this, (String) obj);
            }
        });
        kotlin.jvm.internal.m.f(map, "call(\n                \"isAddressValid\",\n                mapOf(\n                        \"address\" to address,\n                        \"testnet\" to testnet\n                )\n        )\n                .map { decodeJson<Boolean>(Boolean::class.javaObjectType, it) }");
        return map;
    ...
    public b0<CoinSelection> selectCoins(List<UTXO> utxos, String toAddress, String changeAddress, BigInteger amount, BigInteger feeRate, boolean z) {
        ...
        ArrayList arrayList = new ArrayList();
        for (UTXO utxo : utxos) {
            asJSONMap = LitecoinServiceKt.asJSONMap(utxo);
            if (asJSONMap != null) {
        ...
        l2 = m0.l(oVarArr);
        b0 map = call("selectCoins", l2).map(new n() { // from class: com.coinbase.walletengine.services.litecoin.k
            @Override // h.c.m0.n
            public final Object apply(Object obj) {
                return LitecoinService.k(LitecoinService.this, (String) obj);
            }
        });
    ...
    public b0<SignedTransaction> signTransaction(Map<String, byte[]> privateKeys, CoinSelection coinSelection, boolean z) {
        ...
        asJSONMap = LitecoinServiceKt.asJSONMap(coinSelection);
        oVarArr[1] = u.a("coinSelection", asJSONMap);
        oVarArr[2] = u.a("testnet", Boolean.valueOf(z));
        l2 = m0.l(oVarArr);
        b0 map = call("signTransaction", l2).map(new n() { // from class: com.coinbase.walletengine.services.litecoin.a
            @Override // h.c.m0.n
            public final Object apply(Object obj) {
                return LitecoinService.a(LitecoinService.this, (String) obj);
            }
        });
    ...
    public b0<x> submitSignedTransaction(byte[] signedTxData, boolean z) {
        ...
        b0 map = call("submitSignedTransaction", l2).map(new n() { // from class: com.coinbase.walletengine.services.litecoin.g
            @Override // h.c.m0.n
            public final Object apply(Object obj) {
                return LitecoinService.g((String) obj);
            }
        });
    ...
    public b0<CoinSelection> sweepCoins(List<UTXO> utxos, String toAddress, BigInteger feeRate, boolean z) {
        ...
        l2 = m0.l(oVarArr);
        b0 map = call("sweepCoins", l2).map(new n() { // from class: com.coinbase.walletengine.services.litecoin.m
            @Override // h.c.m0.n
            public final Object apply(Object obj) {
                return LitecoinService.m(LitecoinService.this, (String) obj);
            }
        });
        kotlin.jvm.internal.m.f(map, "call(\n                \"sweepCoins\",\n                mapOf(\n                        \"utxos\" to utxos.mapNotNull { it.asJSONMap() },\n                        \"toAddress\" to toAddress,\n                        \"feeRate\" to feeRate.toString(),\n                        \"testnet\" to testnet\n                )\n        )\n                .map { decodeJson<CoinSelection>(CoinSelection::class.java, it) }");
        return map;
