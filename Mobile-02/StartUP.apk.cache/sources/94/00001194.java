...
final class EventProperty_ApplicationKt$CollectibleType$2 extends o implements a<EventProperty> {
    public static final EventProperty_ApplicationKt$CollectibleType$2 INSTANCE = new EventProperty_ApplicationKt$CollectibleType$2();

    EventProperty_ApplicationKt$CollectibleType$2() {
        super(0);
    }
    ...
    public final EventProperty invoke() {
        return new EventProperty("collectible_type_name");
    }
}