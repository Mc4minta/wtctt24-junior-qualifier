...
final class EventProperty_ApplicationKt$NetworkIsTestNet$2 extends o implements a<EventProperty> {
    public static final EventProperty_ApplicationKt$NetworkIsTestNet$2 INSTANCE = new EventProperty_ApplicationKt$NetworkIsTestNet$2();

    EventProperty_ApplicationKt$NetworkIsTestNet$2() {
        super(0);
    }
    ...
    public final EventProperty invoke() {
        return new EventProperty("network_is_testnet");
    }
}