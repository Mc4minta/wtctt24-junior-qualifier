...
public class ErrorUtils {
    ...
    public static class ErrorScope implements MemberScope {
        ...
        */
        ...
        public ClassifierDescriptor mo2216getContributedClassifier(Name name, LookupLocation lookupLocation) {
            if (name == null) {
                $$$reportNull$$$0(1);
            }
    ...
    public static class UninferredParameterTypeConstructor implements TypeConstructor {
        ...
        public ClassifierDescriptor mo2214getDeclarationDescriptor() {
            return this.errorTypeConstructor.mo2214getDeclarationDescriptor();
        }
        ...
        public Collection<KotlinType> mo2215getSupertypes() {
            Collection<KotlinType> mo2215getSupertypes = this.errorTypeConstructor.mo2215getSupertypes();
