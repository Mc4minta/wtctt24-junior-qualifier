...
final class EventProperty_WalletsKt$Blockchain$2 extends o implements a<EventProperty> {
    public static final EventProperty_WalletsKt$Blockchain$2 INSTANCE = new EventProperty_WalletsKt$Blockchain$2();

    EventProperty_WalletsKt$Blockchain$2() {
        super(0);
    }
    ...
    public final EventProperty invoke() {
        return new EventProperty(RouteActionKey.RouteActionKeys.BLOCKCHAIN);
    }
}