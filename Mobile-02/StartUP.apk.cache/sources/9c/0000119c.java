...
final class EventProperty_ApplicationKt$FastPrice$2 extends o implements a<EventProperty> {
    public static final EventProperty_ApplicationKt$FastPrice$2 INSTANCE = new EventProperty_ApplicationKt$FastPrice$2();

    EventProperty_ApplicationKt$FastPrice$2() {
        super(0);
    }
    ...
    public final EventProperty invoke() {
        return new EventProperty("gas_price_fast");
    }
}