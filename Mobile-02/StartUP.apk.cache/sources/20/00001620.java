...
final class EventProperty_ConsumerKt$BuyStatus$2 extends o implements a<EventProperty> {
    public static final EventProperty_ConsumerKt$BuyStatus$2 INSTANCE = new EventProperty_ConsumerKt$BuyStatus$2();

    EventProperty_ConsumerKt$BuyStatus$2() {
        super(0);
    }
    ...
    public final EventProperty invoke() {
        return new EventProperty("buy_status");
    }
}