...
@e.f.m.x.a.a(name = AndroidInfoModule.NAME)
@SuppressLint({"HardwareIds"})
/* loaded from: classes2.dex */
public class AndroidInfoModule extends NativePlatformConstantsAndroidSpec implements com.facebook.react.turbomodule.core.interfaces.a {
    ...
    private String getServerHost() {
        return a.c(Integer.valueOf(getReactApplicationContext().getApplicationContext().getResources().getInteger(g.a)));
    }
