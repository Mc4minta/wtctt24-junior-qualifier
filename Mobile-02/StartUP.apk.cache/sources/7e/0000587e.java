...
public final class DeserializedMemberScope$NoReorderImplementation$variableNames$2 extends o implements a<Set<? extends Name>> {
    ...
    public final Set<? extends Name> invoke() {
        ...
        for (MessageLite messageLite : list) {
            linkedHashSet.add(NameResolverUtilKt.getName(deserializedMemberScope.f17407c.getNameResolver(), ((ProtoBuf.Property) messageLite).getName()));
        }
        h2 = t0.h(linkedHashSet, this.this$1.getNonDeclaredVariableNames());
        return h2;
    }
}