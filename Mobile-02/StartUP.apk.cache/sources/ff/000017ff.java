...
public final class ConsumerAmountPickerFragment$special$$inlined$viewModel$3 extends kotlin.jvm.internal.o implements kotlin.e0.c.a<f0> {
    final /* synthetic */ kotlin.e0.c.a $ownerProducer;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public ConsumerAmountPickerFragment$special$$inlined$viewModel$3(kotlin.e0.c.a aVar) {
        super(0);
