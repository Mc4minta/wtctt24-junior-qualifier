...
/* compiled from: ConsumerPaymentMethodsDAO.kt */
@Metadata(bv = {1, 0, 3}, d1 = {"\u00000\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\u0018\u0002\n\u0002\u0010 \n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0005\u0018\u00002\u00020\u0001B\u0013\u0012\n\u0010\u0010\u001a\u0006\u0012\u0002\b\u00030\u000f¢\u0006\u0004\b\u0012\u0010\u0013J\u001b\u0010\u0005\u001a\u000e\u0012\n\u0012\b\u0012\u0004\u0012\u00020\u00040\u00030\u0002H\u0002¢\u0006\u0004\b\u0005\u0010\u0006J\u0013\u0010\b\u001a\b\u0012\u0004\u0012\u00020\u00070\u0002¢\u0006\u0004\b\b\u0010\u0006J'\u0010\n\u001a\u000e\u0012\n\u0012\b\u0012\u0004\u0012\u00020\u00040\u00030\u00022\f\u0010\t\u001a\b\u0012\u0004\u0012\u00020\u00040\u0003¢\u0006\u0004\b\n\u0010\u000bJ\u0019\u0010\r\u001a\u000e\u0012\n\u0012\b\u0012\u0004\u0012\u00020\u00040\u00030\f¢\u0006\u0004\b\r\u0010\u000eR\u001a\u0010\u0010\u001a\u0006\u0012\u0002\b\u00030\u000f8\u0002@\u0002X\u0082\u0004¢\u0006\u0006\n\u0004\b\u0010\u0010\u0011¨\u0006\u0014"}, d2 = {"Lcom/coinbase/wallet/consumer/daos/ConsumerPaymentMethodsDAO;", "", "Lh/c/b0;", "", "Lcom/coinbase/wallet/consumer/models/ConsumerPaymentMethod;", "getPaymentMethods", "()Lh/c/b0;", "Lkotlin/x;", "deleteAll", "paymentMethods", "save", "(Ljava/util/List;)Lh/c/b0;", "Lh/c/s;", "observePaymentMethods", "()Lh/c/s;", "Lcom/coinbase/wallet/libraries/databases/db/Database;", "db", "Lcom/coinbase/wallet/libraries/databases/db/Database;", "<init>", "(Lcom/coinbase/wallet/libraries/databases/db/Database;)V", "consumer_productionRelease"}, k = 1, mv = {1, 5, 1})
/* loaded from: classes.dex */
public final class ConsumerPaymentMethodsDAO {
    private final Database<?> db;

    public ConsumerPaymentMethodsDAO(Database<?> db) {
        m.g(db, "db");
        this.db = db;
    }

    public static /* synthetic */ x a(ConsumerPaymentMethodsDAO consumerPaymentMethodsDAO, ConsumerPaymentMethod consumerPaymentMethod) {
        return m859observePaymentMethods$lambda3(consumerPaymentMethodsDAO, consumerPaymentMethod);
    }

    public static /* synthetic */ h0 b(ConsumerPaymentMethodsDAO consumerPaymentMethodsDAO, List list) {
        return m858deleteAll$lambda1(consumerPaymentMethodsDAO, list);
    }

    public static /* synthetic */ List c(Optional optional) {
        return m860save$lambda2(optional);
    }

    /* renamed from: deleteAll$lambda-1 */
    public static final h0 m858deleteAll$lambda1(ConsumerPaymentMethodsDAO this$0, List records) {
        int r;
        List g2;
        m.g(this$0, "this$0");
        m.g(records, "records");
        ...
        while (it.hasNext()) {
            final ConsumerPaymentMethod consumerPaymentMethod = (ConsumerPaymentMethod) it.next();
            final Storage<?> storage = this$0.db.getStorage();
            final DatabaseOperation databaseOperation = DatabaseOperation.WRITE;
            b0 observeOn = b0.create(new f0() { // from class: com.coinbase.wallet.consumer.daos.ConsumerPaymentMethodsDAO$deleteAll$lambda-1$lambda-0$$inlined$delete$1
                @Override // h.c.f0
                public final void subscribe(d0<Boolean> emitter) {
                    Lock readLock;
                    m.g(emitter, "emitter");
                    int i2 = ConsumerPaymentMethodsDAO$deleteAll$lambda1$lambda0$$inlined$delete$1$1$wm$Storage$perform$1$WhenMappings.$EnumSwitchMapping$0[DatabaseOperation.this.ordinal()];
                    boolean z = true;
                    if (i2 == 1) {
                    ...
                    DatabaseDaoInterface<?> databaseDaoInterface = storage.getModelDaos().get(ConsumerPaymentMethod.class);
                    ...
                    if (databaseDaoInterface2 == null) {
                        emitter.onError(new DatabaseException.MissingDao(ConsumerPaymentMethod.class));
                        return;
                    }
                    readLock.lock();
                    ...
                    try {
                        databaseDaoInterface2.delete(consumerPaymentMethod);
        ...
        b0 zip = b0.zip(arrayList, new n() { // from class: com.coinbase.wallet.consumer.daos.ConsumerPaymentMethodsDAO$deleteAll$lambda-1$$inlined$zipOrEmpty$1
            @Override // h.c.m0.n
    ...
    private final b0<List<ConsumerPaymentMethod>> getPaymentMethods() {
        ...
        b0<List<ConsumerPaymentMethod>> observeOn = b0.create(new f0() { // from class: com.coinbase.wallet.consumer.daos.ConsumerPaymentMethodsDAO$getPaymentMethods$$inlined$fetch$1
            @Override // h.c.f0
            public final void subscribe(d0<List<? extends T>> emitter) {
                Lock readLock;
                List<? extends T> fetch;
                m.g(emitter, "emitter");
                int i2 = ConsumerPaymentMethodsDAO$getPaymentMethods$$inlined$fetch$1$1$wm$Storage$perform$1$WhenMappings.$EnumSwitchMapping$0[DatabaseOperation.this.ordinal()];
                boolean z = true;
                if (i2 == 1) {
                    readLock = storage.getMultiReadSingleWriteLock().readLock();
                    m.f(readLock, "multiReadSingleWriteLock.readLock()");
    ...
    /* renamed from: observePaymentMethods$lambda-3 */
    public static final x m859observePaymentMethods$lambda3(ConsumerPaymentMethodsDAO this$0, ConsumerPaymentMethod it) {
        m.g(this$0, "this$0");
        m.g(it, "it");
    ...
    public static final List m860save$lambda2(Optional it) {
        m.g(it, "it");
    ...
    public final b0<kotlin.x> deleteAll() {
        ...
        final Storage<?> storage = database.getStorage();
        final DatabaseOperation databaseOperation = DatabaseOperation.READ;
        b0 observeOn = b0.create(new f0() { // from class: com.coinbase.wallet.consumer.daos.ConsumerPaymentMethodsDAO$deleteAll$$inlined$fetch$1
            @Override // h.c.f0
            public final void subscribe(d0<List<? extends T>> emitter) {
                Lock readLock;
                List<? extends T> fetch;
                m.g(emitter, "emitter");
                int i2 = ConsumerPaymentMethodsDAO$deleteAll$$inlined$fetch$1$1$wm$Storage$perform$1$WhenMappings.$EnumSwitchMapping$0[DatabaseOperation.this.ordinal()];
                boolean z = true;
                if (i2 == 1) {
                    readLock = storage.getMultiReadSingleWriteLock().readLock();
                    m.f(readLock, "multiReadSingleWriteLock.readLock()");
        ...
        m.f(observeOn, "@Suppress(\"UNCHECKED_CAST\")\n    inline fun <reified T, reified R> perform(\n        operation: DatabaseOperation,\n        crossinline work: (dao: DatabaseDaoInterface<T>) -> R\n    ): Single<R> = Single\n        .create<R> { emitter ->\n            val lock: Lock = when (operation) {\n                DatabaseOperation.READ -> multiReadSingleWriteLock.readLock()\n                DatabaseOperation.WRITE -> multiReadSingleWriteLock.writeLock()\n            }\n\n            val dao = modelDaos[T::class.java] as? DatabaseDaoInterface<T>\n                ?: return@create emitter.onError(DatabaseException.MissingDao(T::class.java))\n\n            lock.lock()\n\n            if (isDestroyed) {\n                lock.unlock()\n                return@create emitter.onError(DatabaseException.DatabaseDestroyed)\n            }\n\n            try {\n                val result = work(dao) as? R ?: throw IllegalArgumentException(\"Invalid result\")\n                emitter.onSuccess(result)\n            } catch (err: Throwable) {\n                emitter.onError(err)\n            } finally {\n                lock.unlock()\n            }\n        }\n        .subscribeOn(scheduler)\n        .observeOn(scheduler)");
        b0 flatMap = observeOn.flatMap(new n() { // from class: com.coinbase.wallet.consumer.daos.h
            @Override // h.c.m0.n
            public final Object apply(Object obj) {
                return ConsumerPaymentMethodsDAO.b(ConsumerPaymentMethodsDAO.this, (List) obj);
            }
        });
        m.f(flatMap, "db.fetch<ConsumerPaymentMethod>(query)\n            .flatMap { records -> records.map { db.delete(it) }.zipOrEmpty() }");
        return Single_CoreKt.asUnit(flatMap);
    }

    public final h.c.s<List<ConsumerPaymentMethod>> observePaymentMethods() {
        h.c.v0.b<?> bVar;
        h.c.s<?> hide;
        ...
        try {
            if (storage.isDestroyed()) {
                ...
                synchronized (storage) {
                    h.c.v0.b<?> bVar2 = storage.getObservers().get(ConsumerPaymentMethod.class);
                    bVar = bVar2 instanceof h.c.v0.b ? bVar2 : null;
                    if (bVar == null) {
                        bVar = h.c.v0.b.d();
                        storage.getObservers().put(ConsumerPaymentMethod.class, bVar);
                    }
                }
                hide = bVar.hide();
            }
            ...
            h.c.s<List<ConsumerPaymentMethod>> distinctUntilChanged = h.c.s.merge(getPaymentMethods().toObservable(), hide.throttleLast(500L, TimeUnit.MILLISECONDS).flatMap(new n() { // from class: com.coinbase.wallet.consumer.daos.g
                @Override // h.c.m0.n
                public final Object apply(Object obj) {
                    return ConsumerPaymentMethodsDAO.a(ConsumerPaymentMethodsDAO.this, (ConsumerPaymentMethod) obj);
                }
    ...
    public final b0<List<ConsumerPaymentMethod>> save(final List<ConsumerPaymentMethod> paymentMethods) {
        m.g(paymentMethods, "paymentMethods");
        final Database<?> database = this.db;
        final Storage<?> storage = database.getStorage();
        final DatabaseOperation databaseOperation = DatabaseOperation.WRITE;
        b0 observeOn = b0.create(new f0() { // from class: com.coinbase.wallet.consumer.daos.ConsumerPaymentMethodsDAO$save$$inlined$addOrUpdate$1
            @Override // h.c.f0
            public final void subscribe(d0<Optional<? extends List<? extends T>>> emitter) {
                Lock readLock;
                m.g(emitter, "emitter");
                int i2 = ConsumerPaymentMethodsDAO$save$$inlined$addOrUpdate$1$1$wm$Storage$perform$1$WhenMappings.$EnumSwitchMapping$0[DatabaseOperation.this.ordinal()];
                if (i2 == 1) {
                    readLock = storage.getMultiReadSingleWriteLock().readLock();
                    m.f(readLock, "multiReadSingleWriteLock.readLock()");
                } else if (i2 != 2) {
                ...
                try {
                    databaseDaoInterface2.addOrUpdate(paymentMethods);
                    Optional<? extends List<? extends T>> optional2 = OptionalKt.toOptional(paymentMethods);
        ...
        m.f(observeOn, "@Suppress(\"UNCHECKED_CAST\")\n    inline fun <reified T, reified R> perform(\n        operation: DatabaseOperation,\n        crossinline work: (dao: DatabaseDaoInterface<T>) -> R\n    ): Single<R> = Single\n        .create<R> { emitter ->\n            val lock: Lock = when (operation) {\n                DatabaseOperation.READ -> multiReadSingleWriteLock.readLock()\n                DatabaseOperation.WRITE -> multiReadSingleWriteLock.writeLock()\n            }\n\n            val dao = modelDaos[T::class.java] as? DatabaseDaoInterface<T>\n                ?: return@create emitter.onError(DatabaseException.MissingDao(T::class.java))\n\n            lock.lock()\n\n            if (isDestroyed) {\n                lock.unlock()\n                return@create emitter.onError(DatabaseException.DatabaseDestroyed)\n            }\n\n            try {\n                val result = work(dao) as? R ?: throw IllegalArgumentException(\"Invalid result\")\n                emitter.onSuccess(result)\n            } catch (err: Throwable) {\n                emitter.onError(err)\n            } finally {\n                lock.unlock()\n            }\n        }\n        .subscribeOn(scheduler)\n        .observeOn(scheduler)");
        b0 doAfterSuccess = observeOn.doAfterSuccess(new h.c.m0.f() { // from class: com.coinbase.wallet.consumer.daos.ConsumerPaymentMethodsDAO$save$$inlined$addOrUpdate$2
            public final void accept(Optional<? extends List<? extends T>> optional) {
                h.c.v0.b<?> bVar;
                List<DatabaseModelObject> list = paymentMethods;
                Database database2 = database;
                    ...
                    try {
                        ...
                        if (databaseModelObject2 != null) {
                            synchronized (storage2) {
                                h.c.v0.b<?> bVar2 = storage2.getObservers().get(ConsumerPaymentMethod.class);
                                bVar = bVar2 instanceof h.c.v0.b ? bVar2 : null;
                                if (bVar == null) {
                                    bVar = h.c.v0.b.d();
                                    storage2.getObservers().put(ConsumerPaymentMethod.class, bVar);
                                }
                            }
        ...
        b0<List<ConsumerPaymentMethod>> map = doAfterSuccess.map(new n() { // from class: com.coinbase.wallet.consumer.daos.i
            @Override // h.c.m0.n
            public final Object apply(Object obj) {
                return ConsumerPaymentMethodsDAO.c((Optional) obj);
            }
        });
        m.f(map, "db.addOrUpdate(models = paymentMethods)\n        .map {\n            it.toNullable()\n                ?: throw ConsumerException.UnableToSaveConsumerAccount(\"Couldn't save consumer paymentMethods\")\n        }");
        return map;
    }
}