...
@Metadata(bv = {1, 0, 3}, d1 = {"\u0000P\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0010\u000e\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0010\u0012\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0004\u0018\u00002\b\u0012\u0004\u0012\u00020\u00020\u0001B\u000f\u0012\u0006\u0010\u001c\u001a\u00020\u001b¢\u0006\u0004\b\u001d\u0010\u001eJ\u000f\u0010\u0004\u001a\u00020\u0003H\u0016¢\u0006\u0004\b\u0004\u0010\u0005J\u0017\u0010\b\u001a\u00020\u00022\u0006\u0010\u0007\u001a\u00020\u0006H\u0016¢\u0006\u0004\b\b\u0010\tJ!\u0010\u000e\u001a\u00020\r2\u0006\u0010\u000b\u001a\u00020\n2\b\u0010\f\u001a\u0004\u0018\u00010\u0002H\u0016¢\u0006\u0004\b\u000e\u0010\u000fR\u001c\u0010\u0011\u001a\b\u0012\u0004\u0012\u00020\u00100\u00018\u0002@\u0002X\u0082\u0004¢\u0006\u0006\n\u0004\b\u0011\u0010\u0012R\u001c\u0010\u0013\u001a\b\u0012\u0004\u0012\u00020\u00030\u00018\u0002@\u0002X\u0082\u0004¢\u0006\u0006\n\u0004\b\u0013\u0010\u0012R\u001c\u0010\u0015\u001a\b\u0012\u0004\u0012\u00020\u00140\u00018\u0002@\u0002X\u0082\u0004¢\u0006\u0006\n\u0004\b\u0015\u0010\u0012R\u0016\u0010\u0017\u001a\u00020\u00168\u0002@\u0002X\u0082\u0004¢\u0006\u0006\n\u0004\b\u0017\u0010\u0018R\u001f\u0010\u001a\u001a\b\u0012\u0004\u0012\u00020\u00190\u00018\u0002@\u0002X\u0082\u0004ø\u0001\u0000¢\u0006\u0006\n\u0004\b\u001a\u0010\u0012\u0082\u0002\u0004\n\u0002\b\u0019¨\u0006\u001f"}, d2 = {"Lcom/coinbase/walletengine/services/btclike/UTXOJsonAdapter;", "Lcom/squareup/moshi/JsonAdapter;", "Lcom/coinbase/walletengine/services/btclike/UTXO;", "", "toString", "()Ljava/lang/String;", "Lcom/squareup/moshi/JsonReader;", "reader", "fromJson", "(Lcom/squareup/moshi/JsonReader;)Lcom/coinbase/walletengine/services/btclike/UTXO;", "Lcom/squareup/moshi/JsonWriter;", "writer", "value_", "Lkotlin/x;", "toJson", "(Lcom/squareup/moshi/JsonWriter;Lcom/coinbase/walletengine/services/btclike/UTXO;)V", "Ljava/math/BigInteger;", "bigIntegerAdapter", "Lcom/squareup/moshi/JsonAdapter;", "stringAdapter", "", "byteArrayAdapter", "Lcom/squareup/moshi/JsonReader$Options;", "options", "Lcom/squareup/moshi/JsonReader$Options;", "Lkotlin/UInt;", "uIntAdapter", "Lcom/squareup/moshi/Moshi;", "moshi", "<init>", "(Lcom/squareup/moshi/Moshi;)V", "wallet-engine_release"}, k = 1, mv = {1, 5, 1})
...
public final class UTXOJsonAdapter extends JsonAdapter<UTXO> {
    ...
    public UTXOJsonAdapter(Moshi moshi) {
        ...
        m.f(adapter2, "moshi.adapter(UInt::class.java, emptySet(), \"index\")");
        ...
        m.f(adapter4, "moshi.adapter(ByteArray::class.java,\n      emptySet(), \"script\")");
    ...
    public UTXO fromJson(JsonReader reader) {
        ...
        while (reader.hasNext()) {
            ...
            if (selectName == -1) {
                ...
                if (str2 == null) {
                    ...
                    m.f(unexpectedNull2, "unexpectedNull(\"hash\", \"hash\",\n            reader)");
                ...
                if (bigInteger == null) {
                    ...
                    m.f(unexpectedNull4, "unexpectedNull(\"value__\",\n            \"value\", reader)");
                ...
                m.f(unexpectedNull5, "unexpectedNull(\"script\",\n            \"script\", reader)");
        ...
        if (str == null) {
            ...
            m.f(missingProperty2, "missingProperty(\"hash\", \"hash\", reader)");
            ...
            if (bigInteger == null) {
                ...
                m.f(missingProperty4, "missingProperty(\"script\", \"script\", reader)");
                throw missingProperty4;
            }
        } else {
            JsonDataException missingProperty5 = Util.missingProperty("index", "index", reader);
            m.f(missingProperty5, "missingProperty(\"index\", \"index\", reader)");
    ...
    public void toJson(JsonWriter writer, UTXO utxo) {
        ...
        writer.name("index");
        this.uIntAdapter.toJson(writer, (JsonWriter) UInt.h(utxo.m1997getIndexpVg5ArA()));
        writer.name("value");
