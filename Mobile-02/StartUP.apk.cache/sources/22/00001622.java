...
final class EventProperty_ConsumerKt$MaxTransfer$2 extends o implements a<EventProperty> {
    public static final EventProperty_ConsumerKt$MaxTransfer$2 INSTANCE = new EventProperty_ConsumerKt$MaxTransfer$2();

    EventProperty_ConsumerKt$MaxTransfer$2() {
        super(0);
    }
    ...
    public final EventProperty invoke() {
        return new EventProperty("max_transfer");
    }
}