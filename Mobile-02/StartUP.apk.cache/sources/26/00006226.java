...
public class DSAParametersGenerator {
    ...
    private DSAParameters generateParameters_FIPS186_3() {
        ...
        if (i11 >= 0 && (calculateGenerator_FIPS186_3_Verifiable = calculateGenerator_FIPS186_3_Verifiable(digest, subtract, bit, bArr, i11)) != null) {
            return new DSAParameters(subtract, bit, calculateGenerator_FIPS186_3_Verifiable, new DSAValidationParameters(bArr, i2, this.usageIndex));
        }
        return new DSAParameters(subtract, bit, calculateGenerator_FIPS186_3_Unverifiable(subtract, bit, this.random), new DSAValidationParameters(bArr, i2));
    }
