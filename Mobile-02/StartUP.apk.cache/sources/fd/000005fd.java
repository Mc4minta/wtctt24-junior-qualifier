...
public final class a {
    ...
    private static final boolean f3187b = n(System.getProperty("java.vm.version"));
    ...
    public static final class C0082a {
        ...
        /* renamed from: b  reason: collision with root package name */
        private final InterfaceC0083a f3188b;
        ...
        private static class b implements InterfaceC0083a {
            ...
            @Override // c.p.a.C0082a.InterfaceC0083a
        ...
        /* loaded from: classes.dex */
        private static class c implements InterfaceC0083a {
            private final Constructor<?> a;
        ...
        /* loaded from: classes.dex */
        private static class d implements InterfaceC0083a {
            private final Constructor<?> a;
        ...
        private C0082a() throws ClassNotFoundException, SecurityException, NoSuchMethodException {
            InterfaceC0083a dVar;
        ...
        private Object[] b(List<? extends File> list) throws IOException, SecurityException, IllegalArgumentException, InstantiationException, IllegalAccessException, InvocationTargetException {
            ...
            for (int i2 = 0; i2 < size; i2++) {
                ...
                objArr[i2] = this.f3188b.a(file, DexFile.loadDex(file.getPath(), c(file), 0));
            }
            return objArr;
        }
    ...
    public static final class c {
        static void a(ClassLoader classLoader, List<? extends File> list) throws IllegalArgumentException, IllegalAccessException, NoSuchFieldException, IOException {
            int size = list.size();
            Field g2 = a.g(classLoader, ClientCookie.PATH_ATTR);
