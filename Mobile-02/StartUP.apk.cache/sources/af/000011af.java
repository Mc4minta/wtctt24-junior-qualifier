...
final class EventProperty_ApplicationKt$SwapEnabled$2 extends o implements a<EventProperty> {
    public static final EventProperty_ApplicationKt$SwapEnabled$2 INSTANCE = new EventProperty_ApplicationKt$SwapEnabled$2();

    EventProperty_ApplicationKt$SwapEnabled$2() {
        super(0);
    }
    ...
    public final EventProperty invoke() {
        return new EventProperty("swap_enabled");
    }
}