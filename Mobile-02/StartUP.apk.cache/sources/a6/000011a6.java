...
final class EventProperty_ApplicationKt$NormalPrice$2 extends o implements a<EventProperty> {
    public static final EventProperty_ApplicationKt$NormalPrice$2 INSTANCE = new EventProperty_ApplicationKt$NormalPrice$2();

    EventProperty_ApplicationKt$NormalPrice$2() {
        super(0);
    }
    ...
    public final EventProperty invoke() {
        return new EventProperty("gas_price_normal");
    }
}