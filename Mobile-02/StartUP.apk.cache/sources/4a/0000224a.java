...
public final class SwapConfirmationViewModel$handleNotEnoughFundsError$1 extends kotlin.jvm.internal.o implements kotlin.e0.c.l<Throwable, kotlin.x> {
    final /* synthetic */ SwapConfirmationViewModel this$0;

    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public SwapConfirmationViewModel$handleNotEnoughFundsError$1(SwapConfirmationViewModel swapConfirmationViewModel) {
        super(1);
    ...
    public final void invoke2(Throwable it) {
        ...
        SwapConfirmationError.Error error = new SwapConfirmationError.Error(LocalizedStrings.INSTANCE.get(R.string.swap_confirmation_fee_calculation_failed));
