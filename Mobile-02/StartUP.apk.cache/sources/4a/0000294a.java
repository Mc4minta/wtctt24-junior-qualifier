...
public final class WalletsRepositoriesModule_Companion_ProvidesStellarWalletRepositoryFactory implements d<WalletManaging> {
    ...
    public WalletsRepositoriesModule_Companion_ProvidesStellarWalletRepositoryFactory(Provider<AddressDao> provider, Provider<WalletDao> provider2, Provider<CipherCoreInterface> provider3, Provider<StellarService> provider4) {
    ...
    public static WalletsRepositoriesModule_Companion_ProvidesStellarWalletRepositoryFactory create(Provider<AddressDao> provider, Provider<WalletDao> provider2, Provider<CipherCoreInterface> provider3, Provider<StellarService> provider4) {
        return new WalletsRepositoriesModule_Companion_ProvidesStellarWalletRepositoryFactory(provider, provider2, provider3, provider4);
    }
    ...
    public static WalletManaging providesStellarWalletRepository(AddressDao addressDao, WalletDao walletDao, CipherCoreInterface cipherCoreInterface, StellarService stellarService) {
        return (WalletManaging) h.f(WalletsRepositoriesModule.Companion.providesStellarWalletRepository(addressDao, walletDao, cipherCoreInterface, stellarService));
    }
