...
public class X509CRLEntryObject extends X509CRLEntry {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof X509CRLEntryObject) {
            return this.f17830c.equals(((X509CRLEntryObject) obj).f17830c);
        }
    ...
    public byte[] getEncoded() throws CRLException {
        try {
            return this.f17830c.getEncoded(ASN1Encoding.DER);
    ...
    public Date getRevocationDate() {
        return this.f17830c.getRevocationDate().getDate();
    }

    @Override // java.security.cert.X509CRLEntry
    public BigInteger getSerialNumber() {
        return this.f17830c.getUserCertificate().getValue();
    }

    @Override // java.security.cert.X509CRLEntry
    public boolean hasExtensions() {
        return this.f17830c.getExtensions() != null;
    }
