...
public final class AdjustableMinerFee1559PresetAdapter$MinerFeeCustomHolder$bind$4 extends o implements l<View, x> {
    final /* synthetic */ AdjustableMinerFee1559PresetAdapter.MinerFeeCustomHolder this$0;

    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public AdjustableMinerFee1559PresetAdapter$MinerFeeCustomHolder$bind$4(AdjustableMinerFee1559PresetAdapter.MinerFeeCustomHolder minerFeeCustomHolder) {
        super(1);
    ...
    public final void invoke2(View it) {
        EditText editText;
        m.g(it, "it");
        editText = this.this$0.gasLimitField;
