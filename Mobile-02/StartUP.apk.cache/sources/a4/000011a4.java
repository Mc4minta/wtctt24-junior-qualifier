...
final class EventProperty_ApplicationKt$NetworkName$2 extends o implements a<EventProperty> {
    public static final EventProperty_ApplicationKt$NetworkName$2 INSTANCE = new EventProperty_ApplicationKt$NetworkName$2();

    EventProperty_ApplicationKt$NetworkName$2() {
        super(0);
    }
    ...
    public final EventProperty invoke() {
        return new EventProperty("network_name");
    }
}