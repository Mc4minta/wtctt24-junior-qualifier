...
final class EventProperty_ApplicationKt$State$2 extends o implements a<EventProperty> {
    public static final EventProperty_ApplicationKt$State$2 INSTANCE = new EventProperty_ApplicationKt$State$2();

    EventProperty_ApplicationKt$State$2() {
        super(0);
    }
    ...
    public final EventProperty invoke() {
        return new EventProperty(ApiConstants.STATE);
    }
}