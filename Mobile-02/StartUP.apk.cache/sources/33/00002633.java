...
final class TxMetadataKey_StellarKt$memoText$2 extends o implements kotlin.e0.c.a<TxMetadataKey> {
    public static final TxMetadataKey_StellarKt$memoText$2 INSTANCE = new TxMetadataKey_StellarKt$memoText$2();

    TxMetadataKey_StellarKt$memoText$2() {
        super(0);
    }
    ...
    public final TxMetadataKey invoke() {
        return TxMetadataKey.Companion.create("memoText", String.class);
    }
}