...
final class CurrencyCode_EthereumKt$ETH$2 extends o implements kotlin.e0.c.a<CurrencyCode> {
    public static final CurrencyCode_EthereumKt$ETH$2 INSTANCE = new CurrencyCode_EthereumKt$ETH$2();

    CurrencyCode_EthereumKt$ETH$2() {
        super(0);
    }
