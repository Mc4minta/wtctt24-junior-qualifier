...
public final class ConsumerModule_ProvidesCoinbaseFactory implements d<Coinbase> {
    ...
    public ConsumerModule_ProvidesCoinbaseFactory(Provider<Application> provider, Provider<StoreInterface> provider2, Provider<ConsumerNetworkConfig> provider3, Provider<BuildConfigWrapper> provider4) {
    ...
    public static ConsumerModule_ProvidesCoinbaseFactory create(Provider<Application> provider, Provider<StoreInterface> provider2, Provider<ConsumerNetworkConfig> provider3, Provider<BuildConfigWrapper> provider4) {
        return new ConsumerModule_ProvidesCoinbaseFactory(provider, provider2, provider3, provider4);
    }
    ...
    public static Coinbase providesCoinbase(Application application, StoreInterface storeInterface, ConsumerNetworkConfig consumerNetworkConfig, BuildConfigWrapper buildConfigWrapper) {
        return (Coinbase) h.f(ConsumerModule.providesCoinbase(application, storeInterface, consumerNetworkConfig, buildConfigWrapper));
    }
