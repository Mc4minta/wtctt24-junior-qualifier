...
final class EventProperty_ApplicationKt$SwapToAssetAmount$2 extends o implements a<EventProperty> {
    public static final EventProperty_ApplicationKt$SwapToAssetAmount$2 INSTANCE = new EventProperty_ApplicationKt$SwapToAssetAmount$2();

    EventProperty_ApplicationKt$SwapToAssetAmount$2() {
        super(0);
    }
    ...
    public final EventProperty invoke() {
        return new EventProperty("to_asset_amount");
    }
}