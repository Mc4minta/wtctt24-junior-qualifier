...
public final class WalletsRepositoriesModule_Companion_ProvidesDOGEWalletRepositoryFactory implements d<WalletManaging> {
    ...
    public WalletsRepositoriesModule_Companion_ProvidesDOGEWalletRepositoryFactory(Provider<AddressDao> provider, Provider<WalletDao> provider2, Provider<StoreInterface> provider3, Provider<CipherCoreInterface> provider4, Provider<DOGEService> provider5, Provider<Tracing> provider6, Provider<BatchBalanceAPI> provider7) {
    ...
    public static WalletsRepositoriesModule_Companion_ProvidesDOGEWalletRepositoryFactory create(Provider<AddressDao> provider, Provider<WalletDao> provider2, Provider<StoreInterface> provider3, Provider<CipherCoreInterface> provider4, Provider<DOGEService> provider5, Provider<Tracing> provider6, Provider<BatchBalanceAPI> provider7) {
        return new WalletsRepositoriesModule_Companion_ProvidesDOGEWalletRepositoryFactory(provider, provider2, provider3, provider4, provider5, provider6, provider7);
    }
    ...
    public static WalletManaging providesDOGEWalletRepository(AddressDao addressDao, WalletDao walletDao, StoreInterface storeInterface, CipherCoreInterface cipherCoreInterface, DOGEService dOGEService, Tracing tracing, BatchBalanceAPI batchBalanceAPI) {
        return (WalletManaging) h.f(WalletsRepositoriesModule.Companion.providesDOGEWalletRepository(addressDao, walletDao, storeInterface, cipherCoreInterface, dOGEService, tracing, batchBalanceAPI));
    }
