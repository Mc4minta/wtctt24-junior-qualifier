...
public class ECGOST3410NamedCurves {
    ...
    static {
        ...
        ECDomainParameters eCDomainParameters = new ECDomainParameters(fp, fp.createPoint(new BigInteger(DiskLruCache.VERSION_1), new BigInteger("64033881142927202683649881450433473985931760268884941288852745803908878638612")), bigInteger2);
        ...
        ECDomainParameters eCDomainParameters2 = new ECDomainParameters(fp2, fp2.createPoint(new BigInteger(DiskLruCache.VERSION_1), new BigInteger("64033881142927202683649881450433473985931760268884941288852745803908878638612")), bigInteger7);
        ...
        ECDomainParameters eCDomainParameters3 = new ECDomainParameters(fp3, fp3.createPoint(new BigInteger(DiskLruCache.VERSION_1), new BigInteger("28792665814854611296992347458380284135028636778229113005756334730996303888124")), bigInteger9);
        ...
        ECDomainParameters eCDomainParameters4 = new ECDomainParameters(fp4, fp4.createPoint(new BigInteger(Strings.zero), new BigInteger("29818893917731240733471273240314769927240550812383695689146495261604565990247")), bigInteger11);
        ...
        ECDomainParameters eCDomainParameters5 = new ECDomainParameters(fp5, fp5.createPoint(new BigInteger(Strings.zero), new BigInteger("29818893917731240733471273240314769927240550812383695689146495261604565990247")), bigInteger13);
