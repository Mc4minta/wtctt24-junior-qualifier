...
final class EventProperty_WalletsKt$MinutesToConfirm$2 extends o implements a<EventProperty> {
    public static final EventProperty_WalletsKt$MinutesToConfirm$2 INSTANCE = new EventProperty_WalletsKt$MinutesToConfirm$2();

    EventProperty_WalletsKt$MinutesToConfirm$2() {
        super(0);
    }
    ...
    public final EventProperty invoke() {
        return new EventProperty("minutes_to_confirm");
    }
}