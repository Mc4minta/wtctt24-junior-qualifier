...
final class EventFeature_ApplicationKt$Send$2 extends o implements a<EventFeature> {
    public static final EventFeature_ApplicationKt$Send$2 INSTANCE = new EventFeature_ApplicationKt$Send$2();

    EventFeature_ApplicationKt$Send$2() {
        super(0);
    }
