...
public final class ListLoyaltyCardsResponse extends a {
    ...
    static {
        ProtoAdapter<ListLoyaltyCardsResponse> protoAdapter = new ProtoAdapter<ListLoyaltyCardsResponse>(c.LENGTH_DELIMITED, e0.b(ListLoyaltyCardsResponse.class), "type.googleapis.com/coinbase.public_api.authed.loyalty.ListLoyaltyCardsResponse") { // from class: com.coinbase.android.apiv3.generated.authed.loyalty.ListLoyaltyCardsResponse$Companion$ADAPTER$1
            /* JADX WARN: Can't rename method to resolve collision */
            @Override // com.squareup.wire.ProtoAdapter
            public ListLoyaltyCardsResponse decode(k reader) {
                ...
                while (true) {
                    int g2 = reader.g();
                    if (g2 == -1) {
                        return new ListLoyaltyCardsResponse(arrayList, pageDescription, loyaltyCardLocation2, reader.e(d2));
                    }
                    if (g2 == 1) {
            ...
            @Override // com.squareup.wire.ProtoAdapter
            public void encode(l writer, ListLoyaltyCardsResponse value) {
                m.h(writer, "writer");
                m.h(value, "value");
            ...
            @Override // com.squareup.wire.ProtoAdapter
            public int encodedSize(ListLoyaltyCardsResponse value) {
                m.h(value, "value");
            ...
            @Override // com.squareup.wire.ProtoAdapter
            public ListLoyaltyCardsResponse redact(ListLoyaltyCardsResponse value) {
                m.h(value, "value");
                List a = b.a(value.getCards(), LoyaltyCard.ADAPTER);
                PageDescription page_description = value.getPage_description();
                return ListLoyaltyCardsResponse.copy$default(value, a, page_description != null ? PageDescription.ADAPTER.redact(page_description) : null, null, i.a, 4, null);
            }
        };
    ...
    public /* synthetic */ ListLoyaltyCardsResponse(List list, PageDescription pageDescription, LoyaltyCardLocation loyaltyCardLocation, i iVar, int i2, DefaultConstructorMarker defaultConstructorMarker) {
    ...
    public static /* synthetic */ ListLoyaltyCardsResponse copy$default(ListLoyaltyCardsResponse listLoyaltyCardsResponse, List list, PageDescription pageDescription, LoyaltyCardLocation loyaltyCardLocation, i iVar, int i2, Object obj) {
        if ((i2 & 1) != 0) {
            list = listLoyaltyCardsResponse.cards;
        }
        if ((i2 & 2) != 0) {
            pageDescription = listLoyaltyCardsResponse.page_description;
        }
        if ((i2 & 4) != 0) {
            loyaltyCardLocation = listLoyaltyCardsResponse.card_location;
        }
        if ((i2 & 8) != 0) {
            iVar = listLoyaltyCardsResponse.unknownFields();
        }
        return listLoyaltyCardsResponse.copy(list, pageDescription, loyaltyCardLocation, iVar);
    }

    public final ListLoyaltyCardsResponse copy(List<LoyaltyCard> cards, PageDescription pageDescription, LoyaltyCardLocation card_location, i unknownFields) {
        m.h(cards, "cards");
        m.h(card_location, "card_location");
        m.h(unknownFields, "unknownFields");
        return new ListLoyaltyCardsResponse(cards, pageDescription, card_location, unknownFields);
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ListLoyaltyCardsResponse) {
            ListLoyaltyCardsResponse listLoyaltyCardsResponse = (ListLoyaltyCardsResponse) obj;
            return m.c(unknownFields(), listLoyaltyCardsResponse.unknownFields()) && m.c(this.cards, listLoyaltyCardsResponse.cards) && m.c(this.page_description, listLoyaltyCardsResponse.page_description) && this.card_location == listLoyaltyCardsResponse.card_location;
        }
        return false;
    }
    ...
    public String toString() {
        ...
        h0 = z.h0(arrayList, ", ", "ListLoyaltyCardsResponse{", "}", 0, null, null, 56, null);
        return h0;
    }
    ...
    public ListLoyaltyCardsResponse(List<LoyaltyCard> cards, PageDescription pageDescription, LoyaltyCardLocation card_location, i unknownFields) {
