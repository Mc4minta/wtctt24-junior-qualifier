...
final class TxMetadataKey_StellarKt$memoHash$2 extends o implements kotlin.e0.c.a<TxMetadataKey> {
    public static final TxMetadataKey_StellarKt$memoHash$2 INSTANCE = new TxMetadataKey_StellarKt$memoHash$2();

    TxMetadataKey_StellarKt$memoHash$2() {
        super(0);
    }
    ...
    public final TxMetadataKey invoke() {
        return TxMetadataKey.Companion.create("memoHash", String.class);
    }
}