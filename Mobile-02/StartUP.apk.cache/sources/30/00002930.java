...
public final class WalletsModule_Companion_ProvidesTxRepository$wallets_releaseFactory implements d<ITxRepository> {
    ...
    public WalletsModule_Companion_ProvidesTxRepository$wallets_releaseFactory(Provider<List<TxManaging>> provider, Provider<StoreInterface> provider2, Provider<List<NetworkSetting>> provider3, Provider<Tracing> provider4) {
    ...
    public static WalletsModule_Companion_ProvidesTxRepository$wallets_releaseFactory create(Provider<List<TxManaging>> provider, Provider<StoreInterface> provider2, Provider<List<NetworkSetting>> provider3, Provider<Tracing> provider4) {
        return new WalletsModule_Companion_ProvidesTxRepository$wallets_releaseFactory(provider, provider2, provider3, provider4);
    }
    ...
    public static ITxRepository providesTxRepository$wallets_release(List<TxManaging> list, StoreInterface storeInterface, List<NetworkSetting> list2, Tracing tracing) {
        return (ITxRepository) h.f(WalletsModule.Companion.providesTxRepository$wallets_release(list, storeInterface, list2, tracing));
    }
