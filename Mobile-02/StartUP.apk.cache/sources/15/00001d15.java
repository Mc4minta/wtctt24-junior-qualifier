...
public final class RPC$post$$inlined$post$default$1<T, R> implements n {
    final /* synthetic */ JsonAdapter $parameterizedAdapter;

    public RPC$post$$inlined$post$default$1(JsonAdapter jsonAdapter) {
    ...
    */
    public final com.coinbase.wallet.http.models.HTTPResponse<T> apply(okhttp3.Response r11) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.coinbase.wallet.featureflags.apis.RPC$post$$inlined$post$default$1.apply(okhttp3.Response):com.coinbase.wallet.http.models.HTTPResponse");
    }
}