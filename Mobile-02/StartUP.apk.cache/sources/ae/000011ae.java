...
final class EventProperty_ApplicationKt$SwapAggregatorID$2 extends o implements a<EventProperty> {
    public static final EventProperty_ApplicationKt$SwapAggregatorID$2 INSTANCE = new EventProperty_ApplicationKt$SwapAggregatorID$2();

    EventProperty_ApplicationKt$SwapAggregatorID$2() {
        super(0);
    }
    ...
    public final EventProperty invoke() {
        return new EventProperty("swap_aggregator_id");
    }
}