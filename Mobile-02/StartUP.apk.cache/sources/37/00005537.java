...
public class JavaPropertyDescriptor extends PropertyDescriptorImpl implements JavaCallableMemberDescriptor {
    ...
    private final o<CallableDescriptor.UserDataKey<?>, ?> singleUserData;
    ...
    public JavaCallableMemberDescriptor enhance(KotlinType kotlinType, List<ValueParameterData> list, KotlinType kotlinType2, o<CallableDescriptor.UserDataKey<?>, ?> oVar) {
        ...
        JavaPropertyDescriptor javaPropertyDescriptor = new JavaPropertyDescriptor(getContainingDeclaration(), getAnnotations(), getModality(), getVisibility(), isVar(), getName(), getSource(), original, getKind(), this.isStaticFinal, oVar);
    ...
    public <V> V getUserData(CallableDescriptor.UserDataKey<V> userDataKey) {
        o<CallableDescriptor.UserDataKey<?>, ?> oVar = this.singleUserData;
        if (oVar == null || !oVar.c().equals(userDataKey)) {
            return null;
        }
        return (V) this.singleUserData.d();
    }
