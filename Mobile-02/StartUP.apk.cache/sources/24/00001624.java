...
final class EventProperty_ConsumerKt$OnrampEnabled$2 extends o implements a<EventProperty> {
    public static final EventProperty_ConsumerKt$OnrampEnabled$2 INSTANCE = new EventProperty_ConsumerKt$OnrampEnabled$2();

    EventProperty_ConsumerKt$OnrampEnabled$2() {
        super(0);
    }
    ...
    public final EventProperty invoke() {
        return new EventProperty("onramp_enabled");
    }
}