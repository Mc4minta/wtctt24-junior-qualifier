...
public class X962NamedCurves {
    ...
    static X9ECParametersHolder c2pnb208w1 = new X9ECParametersHolder() { // from class: org.spongycastle.asn1.x9.X962NamedCurves.15
        ...
        protected X9ECParameters createParameters() {
            ...
            ECCurve.F2m f2m = new ECCurve.F2m(208, 1, 2, 83, new BigInteger(Strings.zero, 16), new BigInteger("00C8619ED45A62E6212E1160349E2BFA844439FAFC2A3FD1638F9E", 16), bigInteger, valueOf);
    ...
    static X9ECParametersHolder c2pnb304w1 = new X9ECParametersHolder() { // from class: org.spongycastle.asn1.x9.X962NamedCurves.20
        ...
        protected X9ECParameters createParameters() {
            ...
            ECCurve.F2m f2m = new ECCurve.F2m((int) HttpStatus.SC_NOT_MODIFIED, 1, 2, 11, new BigInteger("00FD0D693149A118F651E6DCE6802085377E5F882D1B510B44160074C1288078365A0396C8E681", 16), new BigInteger("00BDDB97E555A50A908E43B01C798EA5DAA6788F1EA2794EFCF57166B8C14039601E55827340BE", 16), bigInteger, valueOf);
    ...
    public static ASN1ObjectIdentifier getOID(String str) {
        return (ASN1ObjectIdentifier) objIds.get(org.spongycastle.util.Strings.toLowerCase(str));
    }
}