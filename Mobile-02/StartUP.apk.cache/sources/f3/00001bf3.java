...
public final class EthereumModule_ProvidesETCWalletRepository$ethereum_releaseFactory implements d<IETCWalletRepository> {
    ...
    public EthereumModule_ProvidesETCWalletRepository$ethereum_releaseFactory(Provider<AddressDao> provider, Provider<WalletDao> provider2, Provider<ERC20Dao> provider3, Provider<ERC20TokenAPI> provider4, Provider<StoreInterface> provider5, Provider<CipherCoreInterface> provider6, Provider<EthereumSignedTxDao> provider7) {
    ...
    public static EthereumModule_ProvidesETCWalletRepository$ethereum_releaseFactory create(Provider<AddressDao> provider, Provider<WalletDao> provider2, Provider<ERC20Dao> provider3, Provider<ERC20TokenAPI> provider4, Provider<StoreInterface> provider5, Provider<CipherCoreInterface> provider6, Provider<EthereumSignedTxDao> provider7) {
        return new EthereumModule_ProvidesETCWalletRepository$ethereum_releaseFactory(provider, provider2, provider3, provider4, provider5, provider6, provider7);
    }
    ...
    public static IETCWalletRepository providesETCWalletRepository$ethereum_release(AddressDao addressDao, WalletDao walletDao, ERC20Dao eRC20Dao, ERC20TokenAPI eRC20TokenAPI, StoreInterface storeInterface, CipherCoreInterface cipherCoreInterface, EthereumSignedTxDao ethereumSignedTxDao) {
        IETCWalletRepository providesETCWalletRepository$ethereum_release;
        providesETCWalletRepository$ethereum_release = EthereumModule.Companion.providesETCWalletRepository$ethereum_release(addressDao, walletDao, eRC20Dao, eRC20TokenAPI, storeInterface, cipherCoreInterface, ethereumSignedTxDao);
        return (IETCWalletRepository) h.f(providesETCWalletRepository$ethereum_release);
    }
