...
public final class SwitchEthereumChainViewModel$approve$2$1 extends kotlin.jvm.internal.o implements kotlin.e0.c.l<x, x> {
    final /* synthetic */ SwitchEthereumChainViewModel this$0;

    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public SwitchEthereumChainViewModel$approve$2$1(SwitchEthereumChainViewModel switchEthereumChainViewModel) {
        super(1);
    ...
    public final void invoke2(x xVar) {
        ...
        signatureRequestEventSubject.onNext(new SigningSessionEvent.SwitchEthereumChainApproved(this.this$0.getViewState().getUuid()));
    }
}