...
final class StoreKeys_UserKt$accessToken$2 extends o implements a<EncryptedSharedPrefsStoreKey<String>> {
    public static final StoreKeys_UserKt$accessToken$2 INSTANCE = new StoreKeys_UserKt$accessToken$2();

    StoreKeys_UserKt$accessToken$2() {
        super(0);
    }
