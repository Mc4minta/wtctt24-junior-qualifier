...
public final class LendModule_ProvidesLendRepository$lending_releaseFactory implements d<ILendRepository> {
    ...
    public LendModule_ProvidesLendRepository$lending_releaseFactory(Provider<WalletEngine> provider, Provider<s<WalletAddress>> provider2, Provider<LendTokenDAO> provider3, Provider<Tracing> provider4, Provider<LendAPI> provider5, Provider<StoreInterface> provider6) {
    ...
    public static LendModule_ProvidesLendRepository$lending_releaseFactory create(Provider<WalletEngine> provider, Provider<s<WalletAddress>> provider2, Provider<LendTokenDAO> provider3, Provider<Tracing> provider4, Provider<LendAPI> provider5, Provider<StoreInterface> provider6) {
        return new LendModule_ProvidesLendRepository$lending_releaseFactory(provider, provider2, provider3, provider4, provider5, provider6);
    }
    ...
    public static ILendRepository providesLendRepository$lending_release(WalletEngine walletEngine, s<WalletAddress> sVar, LendTokenDAO lendTokenDAO, Tracing tracing, LendAPI lendAPI, StoreInterface storeInterface) {
        ILendRepository providesLendRepository$lending_release;
        providesLendRepository$lending_release = LendModule.Companion.providesLendRepository$lending_release(walletEngine, sVar, lendTokenDAO, tracing, lendAPI, storeInterface);
        return (ILendRepository) h.f(providesLendRepository$lending_release);
    }
