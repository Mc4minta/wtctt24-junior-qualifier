...
final class EventProperty_ConsumerKt$AttemptNumber$2 extends o implements a<EventProperty> {
    public static final EventProperty_ConsumerKt$AttemptNumber$2 INSTANCE = new EventProperty_ConsumerKt$AttemptNumber$2();

    EventProperty_ConsumerKt$AttemptNumber$2() {
        super(0);
    }
    ...
    public final EventProperty invoke() {
        return new EventProperty("attempt_number");
    }
}