...
public final class SwapAmountPickerViewModel$preselectAsset$1$3 extends kotlin.jvm.internal.o implements kotlin.e0.c.l<SwapAmountPickerViewModel.AssetAndBalance, Comparable<?>> {
    final /* synthetic */ Map<ContractAddress, Integer> $selectionCountMap;

    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public SwapAmountPickerViewModel$preselectAsset$1$3(Map<ContractAddress, Integer> map) {
        super(1);
    ...
    public final Comparable<?> invoke(SwapAmountPickerViewModel.AssetAndBalance assetAndBalance) {
        if (this.$selectionCountMap.isEmpty()) {
            return assetAndBalance.getBalanceInFiat();
        }
        return 0;
    }
}