...
final class EventProperty_WalletsKt$ChainName$2 extends o implements a<EventProperty> {
    public static final EventProperty_WalletsKt$ChainName$2 INSTANCE = new EventProperty_WalletsKt$ChainName$2();

    EventProperty_WalletsKt$ChainName$2() {
        super(0);
    }
