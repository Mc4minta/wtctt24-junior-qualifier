...
public final class ListTransactionsRequest extends a {
    ...
    /* compiled from: ListTransactionsRequest.kt */
    @Metadata(bv = {1, 0, 3}, d1 = {"\u0000\u001c\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0005\b\u0086\u0003\u0018\u00002\u00020\u0001B\t\b\u0002¢\u0006\u0004\b\t\u0010\nR\u001c\u0010\u0004\u001a\b\u0012\u0004\u0012\u00020\u00030\u00028\u0006@\u0007X\u0087\u0004¢\u0006\u0006\n\u0004\b\u0004\u0010\u0005R\u001c\u0010\u0007\u001a\b\u0012\u0004\u0012\u00020\u00030\u00068\u0006@\u0007X\u0087\u0004¢\u0006\u0006\n\u0004\b\u0007\u0010\b¨\u0006\u000b"}, d2 = {"Lcom/coinbase/android/apiv3/generated/authed/card/ListTransactionsRequest$Companion;", "", "Lcom/squareup/wire/ProtoAdapter;", "Lcom/coinbase/android/apiv3/generated/authed/card/ListTransactionsRequest;", "ADAPTER", "Lcom/squareup/wire/ProtoAdapter;", "Landroid/os/Parcelable$Creator;", "CREATOR", "Landroid/os/Parcelable$Creator;", "<init>", "()V", "apiv3"}, k = 1, mv = {1, 4, 0})
    /* loaded from: classes.dex */
    ...
    static {
        ProtoAdapter<ListTransactionsRequest> protoAdapter = new ProtoAdapter<ListTransactionsRequest>(c.LENGTH_DELIMITED, e0.b(ListTransactionsRequest.class), "type.googleapis.com/coinbase.public_api.authed.card.ListTransactionsRequest") { // from class: com.coinbase.android.apiv3.generated.authed.card.ListTransactionsRequest$Companion$ADAPTER$1
            /* JADX WARN: Can't rename method to resolve collision */
            @Override // com.squareup.wire.ProtoAdapter
            public ListTransactionsRequest decode(k reader) {
                m.h(reader, "reader");
                long d2 = reader.d();
                ...
                while (true) {
                    int g2 = reader.g();
                    if (g2 == -1) {
                        return new ListTransactionsRequest(pageOptions, reader.e(d2));
                    }
                    if (g2 != 1) {
                        reader.m(g2);
                    } else {
            ...
            @Override // com.squareup.wire.ProtoAdapter
            public void encode(l writer, ListTransactionsRequest value) {
                m.h(writer, "writer");
                m.h(value, "value");
    ...
    public /* synthetic */ ListTransactionsRequest(PageOptions pageOptions, i iVar, int i2, DefaultConstructorMarker defaultConstructorMarker) {
        this((i2 & 1) != 0 ? null : pageOptions, (i2 & 2) != 0 ? i.a : iVar);
    }

    public static /* synthetic */ ListTransactionsRequest copy$default(ListTransactionsRequest listTransactionsRequest, PageOptions pageOptions, i iVar, int i2, Object obj) {
        if ((i2 & 1) != 0) {
            pageOptions = listTransactionsRequest.page_options;
        }
        if ((i2 & 2) != 0) {
            iVar = listTransactionsRequest.unknownFields();
        }
        return listTransactionsRequest.copy(pageOptions, iVar);
    }

    public final ListTransactionsRequest copy(PageOptions pageOptions, i unknownFields) {
        m.h(unknownFields, "unknownFields");
        return new ListTransactionsRequest(pageOptions, unknownFields);
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ListTransactionsRequest) {
            ...
            return m.c(unknownFields(), listTransactionsRequest.unknownFields()) && m.c(this.page_options, listTransactionsRequest.page_options);
        }
        return false;
    }
    ...
    public String toString() {
        ...
        h0 = z.h0(arrayList, ", ", "ListTransactionsRequest{", "}", 0, null, null, 56, null);
        return h0;
    }

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public ListTransactionsRequest(PageOptions pageOptions, i unknownFields) {
