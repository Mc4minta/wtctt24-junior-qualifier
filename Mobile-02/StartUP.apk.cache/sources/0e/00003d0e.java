...
public final class l {
    ...
    private static final boolean f9950b;

    static {
        String name = Charset.defaultCharset().name();
        a = name;
        f9950b = "SJIS".equalsIgnoreCase(name) || "EUC_JP".equalsIgnoreCase(name);
    }
    ...
    public static String a(byte[] bArr, Map<com.google.zxing.d, ?> map) {
        ...
        return (!z4 || (!z2 && (i7 + i8) + i9 <= 0)) ? (!z3 || (!f9950b && i10 < 3 && i2 < 3)) ? (z && z3) ? (!(i10 == 2 && i3 == 2) && i11 * 10 < length) ? "ISO8859_1" : "SJIS" : z ? "ISO8859_1" : z3 ? "SJIS" : z4 ? "UTF8" : a : "SJIS" : "UTF8";
    }
}