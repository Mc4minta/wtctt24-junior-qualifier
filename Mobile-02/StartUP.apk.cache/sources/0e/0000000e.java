...
public final class MediaMetadataCompat implements Parcelable {
    ...
    static final c.e.a<String, Integer> a;

    /* renamed from: b  reason: collision with root package name */
    private static final String[] f360b;

    /* renamed from: c  reason: collision with root package name */
    private static final String[] f361c;

    /* renamed from: d  reason: collision with root package name */
    private static final String[] f362d;
    ...
    static {
        ...
        f360b = new String[]{"android.media.metadata.TITLE", "android.media.metadata.ARTIST", "android.media.metadata.ALBUM", "android.media.metadata.ALBUM_ARTIST", "android.media.metadata.WRITER", "android.media.metadata.AUTHOR", "android.media.metadata.COMPOSER"};
        f361c = new String[]{"android.media.metadata.DISPLAY_ICON", "android.media.metadata.ART", "android.media.metadata.ALBUM_ART"};
        f362d = new String[]{"android.media.metadata.DISPLAY_ICON_URI", "android.media.metadata.ART_URI", "android.media.metadata.ALBUM_ART_URI"};
        CREATOR = new a();
    }
