...
public class v extends x0 {
    ...
    private float f3361b = 3.0f;

    /* renamed from: c  reason: collision with root package name */
    private int f3362c = 80;

    /* JADX WARN: Code restructure failed: missing block: B:10:0x0017, code lost:
        r0 = 3;
     */
    /* JADX WARN: Code restructure failed: missing block: B:17:0x0026, code lost:
        if ((c.h.k.v.y(r7) == 1) != false) goto L24;
     */
    /* JADX WARN: Code restructure failed: missing block: B:8:0x0013, code lost:
        if ((c.h.k.v.y(r7) == 1) != false) goto L7;
     */
    ...
    */
    private int h(android.view.View r7, int r8, int r9, int r10, int r11, int r12, int r13, int r14, int r15) {
        ...
        L59:
            return r3
        */
        throw new UnsupportedOperationException("Method not decompiled: c.s.v.h(android.view.View, int, int, int, int, int, int, int, int):int");
    }
    ...
    @Override // c.s.b0
    public long c(ViewGroup viewGroup, y yVar, e0 e0Var, e0 e0Var2) {
        int i2;
        int i3;
        int i4;
        e0 e0Var3 = e0Var;
        ...
        return Math.round((((float) (duration * i2)) / this.f3361b) * h2);
    }
