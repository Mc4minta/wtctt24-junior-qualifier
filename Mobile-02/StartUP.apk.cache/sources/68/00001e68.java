...
final class LendCoinPickerItem$fiatAmount$2 extends o implements a<String> {
    final /* synthetic */ LendCoinPickerItem this$0;

    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public LendCoinPickerItem$fiatAmount$2(LendCoinPickerItem lendCoinPickerItem) {
        super(0);
    ...
    public final String invoke() {
        ...
        int decimals = lendToken.getDecimals();
        Wallet wallet = this.this$0.getWallet();
        BigInteger balance = wallet != null ? wallet.getBalance() : null;
        BigInteger bigInteger = balance == null ? BigInteger.ZERO : balance;
        m.f(bigInteger, "wallet?.balance ?: BigInteger.ZERO");
        String formatToFiat$default = CurrencyFormatter.formatToFiat$default(currencyFormatter, currencyCode, rawValue, decimals, bigInteger, false, null, null, 112, null);
        return formatToFiat$default == null ? Strings_CoreKt.getEllipsis(Strings.INSTANCE) : formatToFiat$default;
    }
}