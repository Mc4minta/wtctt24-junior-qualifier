...
final class EventProperty_ApplicationKt$DappUrl$2 extends o implements a<EventProperty> {
    public static final EventProperty_ApplicationKt$DappUrl$2 INSTANCE = new EventProperty_ApplicationKt$DappUrl$2();

    EventProperty_ApplicationKt$DappUrl$2() {
        super(0);
    }
    ...
    public final EventProperty invoke() {
        return new EventProperty("dapp_url");
    }
}