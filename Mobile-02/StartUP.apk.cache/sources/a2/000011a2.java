...
final class EventProperty_ApplicationKt$IsNonceChanged$2 extends o implements a<EventProperty> {
    public static final EventProperty_ApplicationKt$IsNonceChanged$2 INSTANCE = new EventProperty_ApplicationKt$IsNonceChanged$2();

    EventProperty_ApplicationKt$IsNonceChanged$2() {
        super(0);
    }
    ...
    public final EventProperty invoke() {
        return new EventProperty("is_nonce_changed");
    }
}