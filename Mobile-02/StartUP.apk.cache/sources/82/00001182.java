...
final class EventFeature_ApplicationKt$DApps$2 extends o implements a<EventFeature> {
    public static final EventFeature_ApplicationKt$DApps$2 INSTANCE = new EventFeature_ApplicationKt$DApps$2();

    EventFeature_ApplicationKt$DApps$2() {
        super(0);
    }
