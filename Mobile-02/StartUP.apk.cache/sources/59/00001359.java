package com.coinbase.wallet.bitcoin.services;
...
import com.coinbase.wallet.bitcoin.extensions.BIP44CoinSelection_BitcoinKt;
import com.coinbase.wallet.bitcoin.extensions.BIP44UTXO_BitcoinKt;
import com.coinbase.wallet.bitcoin.extensions.CoinSelection_BitcoinKt;
...
import com.coinbase.walletengine.services.bitcoin.SignedTransaction;
import com.coinbase.walletengine.services.bitcoin.TransactionResult;
import com.coinbase.walletengine.services.bitcoin.TransactionStatus;
import com.coinbase.walletengine.services.bitcoin.UTXO;
import h.c.b0;
import h.c.h0;
import h.c.m0.n;
...
public final class BTCService extends BitcoinService implements BitcoinLikeWalletService {
    ...
    public BTCService(WalletEngine walletEngine) {
        super(walletEngine);
        m.g(walletEngine, "walletEngine");
    }

    /* renamed from: generateCoinSelection$lambda-5 */
    public static final h0 m765generateCoinSelection$lambda5(BTCService this$0, String toAddress, String changeAddress, BigInteger amount, BigInteger feeRate, boolean z, List it) {
        m.g(this$0, "this$0");
    ...
    public static final BIP44CoinSelection m766generateCoinSelection$lambda6(CoinSelection it) {
        m.g(it, "it");
        return CoinSelection_BitcoinKt.asBIP44CoinSelection(it);
    }

    /* renamed from: generateCoinSweep$lambda-2 */
    public static final h0 m767generateCoinSweep$lambda2(BTCService this$0, String toAddress, BigInteger feeRate, boolean z, List it) {
        m.g(this$0, "this$0");
        m.g(toAddress, "$toAddress");
        m.g(feeRate, "$feeRate");
        m.g(it, "it");
    ...
    public static final BIP44CoinSelection m768generateCoinSweep$lambda3(CoinSelection it) {
        m.g(it, "it");
        return CoinSelection_BitcoinKt.asBIP44CoinSelection(it);
    }

    /* renamed from: getTxStatus$lambda-9 */
    public static final TxState m769getTxStatus$lambda9(TransactionResult it) {
        m.g(it, "it");
    ...
    public static final List m770getUnspentTxs$lambda8(List utxos) {
        int r;
        m.g(utxos, "utxos");
        r = s.r(utxos, 10);
        ...
        while (it.hasNext()) {
            ...
            arrayList.add(new BIP44UTXO(utxo.getAddress(), utxo.getHash(), utxo.m1947getIndexpVg5ArA(), utxo.getValue(), utxo.getScript(), null));
        }
        return arrayList;
    }

    public static /* synthetic */ h0 n(BTCService bTCService, String str, BigInteger bigInteger, boolean z, List list) {
        return m767generateCoinSweep$lambda2(bTCService, str, bigInteger, z, list);
    }

    public static /* synthetic */ TxState o(TransactionResult transactionResult) {
        return m769getTxStatus$lambda9(transactionResult);
    }

    public static /* synthetic */ BIP44CoinSelection p(CoinSelection coinSelection) {
        return m768generateCoinSweep$lambda3(coinSelection);
    }

    public static /* synthetic */ List q(List list) {
        return m770getUnspentTxs$lambda8(list);
    }

    public static /* synthetic */ BIP44CoinSelection r(CoinSelection coinSelection) {
        return m766generateCoinSelection$lambda6(coinSelection);
    }

    public static /* synthetic */ BIP44SignedData s(SignedTransaction signedTransaction) {
        return m771signTx$lambda0(signedTransaction);
    }

    /* renamed from: signTx$lambda-0 */
    public static final BIP44SignedData m771signTx$lambda0(SignedTransaction it) {
        m.g(it, "it");
        return new BIP44SignedData(it.getHash(), it.getData());
    }

    public static /* synthetic */ h0 t(BTCService bTCService, String str, String str2, BigInteger bigInteger, BigInteger bigInteger2, boolean z, List list) {
        return m765generateCoinSelection$lambda5(bTCService, str, str2, bigInteger, bigInteger2, z, list);
    }
    ...
    public b0<String> mo760deriveAddressFromXpubKeyroUYKiI(String xpubKey, int i2, AddressType addressType, boolean z, boolean z2) {
        ...
        if (m.c(addressType, AddressKind_BitcoinKt.getBitcoinSegWit(companion))) {
            return m1937deriveSegwitAddressFromXpubKeyYuhug_o(xpubKey, i2, z, z2);
        }
        if (m.c(addressType, AddressKind_BitcoinKt.getBitcoinLegacy(companion))) {
            return m1936deriveLegacyAddressFromXpubKeyYuhug_o(xpubKey, i2, z, z2);
        }
    ...
    public b0<BIP44CoinSelection> generateCoinSelection(List<BIP44UTXO> utxos, final String toAddress, final String changeAddress, final BigInteger amount, final BigInteger feeRate, final boolean z) {
        ...
        for (BIP44UTXO bip44utxo : utxos) {
            arrayList.add(BIP44UTXO_BitcoinKt.asUTXO(bip44utxo));
        }
        b0<BIP44CoinSelection> map = b0.just(arrayList).flatMap(new n() { // from class: com.coinbase.wallet.bitcoin.services.g
            @Override // h.c.m0.n
            public final Object apply(Object obj) {
                return BTCService.t(BTCService.this, toAddress, changeAddress, amount, feeRate, z, (List) obj);
            }
        }).map(new n() { // from class: com.coinbase.wallet.bitcoin.services.e
            @Override // h.c.m0.n
            public final Object apply(Object obj) {
                return BTCService.r((CoinSelection) obj);
            }
        });
    ...
    public b0<BIP44CoinSelection> generateCoinSweep(List<BIP44UTXO> utxos, final String toAddress, final BigInteger feeRate, final boolean z) {
        ...
        b0<BIP44CoinSelection> map = b0.just(arrayList).flatMap(new n() { // from class: com.coinbase.wallet.bitcoin.services.a
            @Override // h.c.m0.n
            public final Object apply(Object obj) {
                return BTCService.n(BTCService.this, toAddress, feeRate, z, (List) obj);
            }
        }).map(new n() { // from class: com.coinbase.wallet.bitcoin.services.c
            @Override // h.c.m0.n
            public final Object apply(Object obj) {
                return BTCService.p((CoinSelection) obj);
            }
        });
    ...
    public b0<TxState> getTxStatus(String txHash, boolean z) {
        m.g(txHash, "txHash");
        b0 map = getTransactionResult(txHash, z).map(new n() { // from class: com.coinbase.wallet.bitcoin.services.b
            @Override // h.c.m0.n
            public final Object apply(Object obj) {
                return BTCService.o((TransactionResult) obj);
            }
        });
    ...
    public b0<List<BIP44UTXO>> getUnspentTxs(List<String> addresses, boolean z) {
        ...
        b0 map = getUTXOs(addresses, z).map(new n() { // from class: com.coinbase.wallet.bitcoin.services.d
            @Override // h.c.m0.n
            public final Object apply(Object obj) {
                return BTCService.q((List) obj);
            }
        });
    ...
    public b0<BIP44SignedData> signTx(Map<String, byte[]> privateKeys, BIP44CoinSelection coinSelection, boolean z) {
        ...
        b0 map = signTransaction(privateKeys, BIP44CoinSelection_BitcoinKt.asCoinSelection(coinSelection), z).map(new n() { // from class: com.coinbase.wallet.bitcoin.services.f
            @Override // h.c.m0.n
            public final Object apply(Object obj) {
                return BTCService.s((SignedTransaction) obj);
            }
        });
    ...
    public String xpubKeyDerivationPath(AddressType addressType, boolean z) {
        ...
        AddressType.Companion companion = AddressType.Companion;
        if (m.c(addressType, AddressKind_BitcoinKt.getBitcoinSegWit(companion))) {
            return z ? "m/84'/1'/0'" : "m/84'/0'/0'";
        } else if (m.c(addressType, AddressKind_BitcoinKt.getBitcoinLegacy(companion))) {
