...
final class LendProviderPickerFragment$onViewCreated$3 extends o implements l<View, x> {
    final /* synthetic */ LendProviderPickerFragment this$0;

    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public LendProviderPickerFragment$onViewCreated$3(LendProviderPickerFragment lendProviderPickerFragment) {
        super(1);
    ...
    public final void invoke2(View it) {
        m.g(it, "it");
        this.this$0.getViewModel().proceedToAmountPicker();
    }
}