...
public class MessageQueueThreadImpl implements MessageQueueThread {
    ...
    private static MessageQueueThreadImpl startNewBackgroundThread(String str, long j2, QueueThreadExceptionHandler queueThreadExceptionHandler) {
        ...
        new Thread(null, runnable, "mqt_" + str, j2).start();
    ...
    public void runOnQueue(Runnable runnable) {
        if (this.mIsFinished) {
            e.f.d.d.a.A("ReactNative", "Tried to enqueue runnable on already finished thread: '" + getName() + "... dropping Runnable.");
        }
