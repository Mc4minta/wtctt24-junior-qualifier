...
public final class SwapModule_ProvidesSwapRepositoryFactory implements d<ISwapRepository> {
    ...
    public SwapModule_ProvidesSwapRepositoryFactory(Provider<CipherCoreInterface> provider, Provider<AddressDao> provider2, Provider<MinerFeeAPI> provider3, Provider<ERC20ContractAPI> provider4, Provider<SwapAPI> provider5, Provider<SwapAssetStatsDAO> provider6, Provider<StoreInterface> provider7) {
    ...
    public static SwapModule_ProvidesSwapRepositoryFactory create(Provider<CipherCoreInterface> provider, Provider<AddressDao> provider2, Provider<MinerFeeAPI> provider3, Provider<ERC20ContractAPI> provider4, Provider<SwapAPI> provider5, Provider<SwapAssetStatsDAO> provider6, Provider<StoreInterface> provider7) {
        return new SwapModule_ProvidesSwapRepositoryFactory(provider, provider2, provider3, provider4, provider5, provider6, provider7);
    }
    ...
    public static ISwapRepository providesSwapRepository(CipherCoreInterface cipherCoreInterface, AddressDao addressDao, MinerFeeAPI minerFeeAPI, ERC20ContractAPI eRC20ContractAPI, SwapAPI swapAPI, SwapAssetStatsDAO swapAssetStatsDAO, StoreInterface storeInterface) {
        return (ISwapRepository) h.f(SwapModule.providesSwapRepository(cipherCoreInterface, addressDao, minerFeeAPI, eRC20ContractAPI, swapAPI, swapAssetStatsDAO, storeInterface));
    }
