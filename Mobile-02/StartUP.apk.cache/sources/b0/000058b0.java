...
public abstract class AbstractClassTypeConstructor extends AbstractTypeConstructor implements TypeConstructor {
    ...
    */
    ...
    public KotlinType defaultSupertypeIfEmpty() {
        if (KotlinBuiltIns.isSpecialClassWithNoSupertypes(mo2214getDeclarationDescriptor())) {
            return null;
        }
    ...
    public final boolean equals(Object obj) {
        ...
        if ((obj instanceof TypeConstructor) && obj.hashCode() == hashCode()) {
            ...
            ClassifierDescriptor mo2214getDeclarationDescriptor2 = typeConstructor.mo2214getDeclarationDescriptor();
            if (hasMeaningfulFqName(mo2214getDeclarationDescriptor) && ((mo2214getDeclarationDescriptor2 == null || hasMeaningfulFqName(mo2214getDeclarationDescriptor2)) && (mo2214getDeclarationDescriptor2 instanceof ClassDescriptor))) {
                return areFqNamesEqual(mo2214getDeclarationDescriptor, (ClassDescriptor) mo2214getDeclarationDescriptor2);
            }
            return false;
        }
        return false;
    ...
    protected Collection<KotlinType> getAdditionalNeighboursInSupertypeGraph(boolean z) {
        DeclarationDescriptor containingDeclaration = mo2214getDeclarationDescriptor().getContainingDeclaration();
        ...
        ClassDescriptor mo2205getCompanionObjectDescriptor = classDescriptor.mo2205getCompanionObjectDescriptor();
        if (z && mo2205getCompanionObjectDescriptor != null) {
            smartList.add(mo2205getCompanionObjectDescriptor.getDefaultType());
        }
        return smartList;
    }
    ...
    public KotlinBuiltIns getBuiltIns() {
        KotlinBuiltIns builtIns = DescriptorUtilsKt.getBuiltIns(mo2214getDeclarationDescriptor());
        if (builtIns == null) {
            $$$reportNull$$$0(1);
        }
        return builtIns;
    ...
    public abstract ClassDescriptor mo2214getDeclarationDescriptor();
    ...
    public final int hashCode() {
        ...
        ClassDescriptor mo2214getDeclarationDescriptor = mo2214getDeclarationDescriptor();
        if (hasMeaningfulFqName(mo2214getDeclarationDescriptor)) {
            identityHashCode = DescriptorUtils.getFqName(mo2214getDeclarationDescriptor).hashCode();
        } else {
