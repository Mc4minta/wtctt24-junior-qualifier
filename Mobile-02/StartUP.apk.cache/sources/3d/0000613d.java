    ...
    public X9Curve(X9FieldID x9FieldID, ASN1Sequence aSN1Sequence) {
        ...
        if (identifier.equals(X9ObjectIdentifiers.prime_field)) {
            ...
            if (aSN1ObjectIdentifier.equals(X9ObjectIdentifiers.tpBasis)) {
                i2 = ASN1Integer.getInstance(aSN1Sequence2.getObjectAt(2)).getValue().intValue();
                i3 = 0;
                intValue = 0;
            ...
            int i5 = i3;
            int i6 = intValue;
            this.curve = new ECCurve.F2m(intValue2, i4, i5, i6, new X9FieldElement(intValue2, i4, i5, i6, (ASN1OctetString) aSN1Sequence.getObjectAt(0)).getValue().toBigInteger(), new X9FieldElement(intValue2, i4, i5, i6, (ASN1OctetString) aSN1Sequence.getObjectAt(1)).getValue().toBigInteger());
        } else {
            throw new IllegalArgumentException("This type of ECCurve is not implemented");
        }
