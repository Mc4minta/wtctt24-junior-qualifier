...
final class EventProperty_ApplicationKt$ChainName$2 extends o implements a<EventProperty> {
    public static final EventProperty_ApplicationKt$ChainName$2 INSTANCE = new EventProperty_ApplicationKt$ChainName$2();

    EventProperty_ApplicationKt$ChainName$2() {
        super(0);
    }
    ...
    public final EventProperty invoke() {
        return new EventProperty("chain_name");
    }
}