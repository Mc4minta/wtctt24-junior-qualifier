...
public class SupportRequestManagerFragment extends Fragment {
    ...
    private void registerFragmentWithRoot(d dVar) {
        unregisterFragmentWithRoot();
        SupportRequestManagerFragment supportRequestManagerFragment = Glide.get(dVar).getRequestManagerRetriever().getSupportRequestManagerFragment(dVar);
