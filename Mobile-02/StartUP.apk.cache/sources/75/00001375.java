...
final class AddressKind_BitcoinCashKt$BitcoinCashLegacy$2 extends o implements a<AddressType> {
    public static final AddressKind_BitcoinCashKt$BitcoinCashLegacy$2 INSTANCE = new AddressKind_BitcoinCashKt$BitcoinCashLegacy$2();

    AddressKind_BitcoinCashKt$BitcoinCashLegacy$2() {
        super(0);
    }
    ...
    public final AddressType invoke() {
        return new AddressType("BitcoinCashLegacy");
    }
}