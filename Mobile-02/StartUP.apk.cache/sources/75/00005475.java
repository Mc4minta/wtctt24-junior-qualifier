...
public abstract class FunctionDescriptorImpl extends DeclarationDescriptorNonRootImpl implements FunctionDescriptor {
    ...
    private volatile a<Collection<FunctionDescriptor>> lazyOverriddenFunctionsTask;
    ...
    private void performOverriddenLazyCalculationIfNeeded() {
        a<Collection<FunctionDescriptor>> aVar = this.lazyOverriddenFunctionsTask;
        if (aVar != null) {
        ...
        if (zArr[0] || !copyConfiguration.justForTypeSubstitution) {
            ...
            if (copyConfiguration.copyOverrides && !getOriginal().getOverriddenDescriptors().isEmpty()) {
                if (copyConfiguration.substitution.isEmpty()) {
                    ...
                    createSubstitutedCopy.lazyOverriddenFunctionsTask = new a<Collection<FunctionDescriptor>>() { // from class: kotlin.reflect.jvm.internal.impl.descriptors.impl.FunctionDescriptorImpl.1
    ...
    public FunctionDescriptorImpl initialize(ReceiverParameterDescriptor receiverParameterDescriptor, ReceiverParameterDescriptor receiverParameterDescriptor2, List<? extends TypeParameterDescriptor> list, List<ValueParameterDescriptor> list2, KotlinType kotlinType, Modality modality, DescriptorVisibility descriptorVisibility) {
        ...
        I0 = z.I0(list);
        this.typeParameters = I0;
        I02 = z.I0(list2);
        this.unsubstitutedValueParameters = I02;
    ...
    public static List<ValueParameterDescriptor> getSubstitutedValueParameters(FunctionDescriptor functionDescriptor, List<ValueParameterDescriptor> list, TypeSubstitutor typeSubstitutor, boolean z, boolean z2, boolean[] zArr) {
        a<List<VariableDescriptor>> aVar;
        if (list == null) {
            $$$reportNull$$$0(28);
        }
        if (typeSubstitutor == null) {
        ...
        for (ValueParameterDescriptor valueParameterDescriptor : list) {
            ...
            if (valueParameterDescriptor instanceof ValueParameterDescriptorImpl.WithDestructuringDeclaration) {
                ...
                aVar = new a<List<VariableDescriptor>>() { // from class: kotlin.reflect.jvm.internal.impl.descriptors.impl.FunctionDescriptorImpl.2
                    @Override // kotlin.e0.c.a
