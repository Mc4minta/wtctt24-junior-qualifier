...
final class TxMetadataKey_LendKt$lendTokenID$2 extends o implements a<TxMetadataKey> {
    public static final TxMetadataKey_LendKt$lendTokenID$2 INSTANCE = new TxMetadataKey_LendKt$lendTokenID$2();

    TxMetadataKey_LendKt$lendTokenID$2() {
        super(0);
    }
    ...
    public final TxMetadataKey invoke() {
        return TxMetadataKey.Companion.create("lendTokenID", String.class);
    }
}