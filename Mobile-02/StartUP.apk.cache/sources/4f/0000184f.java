...
final class ConsumerOnboardingFragment$onViewCreated$4 extends kotlin.jvm.internal.o implements kotlin.e0.c.l<View, kotlin.x> {
    final /* synthetic */ ConsumerOnboardingFragment this$0;

    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public ConsumerOnboardingFragment$onViewCreated$4(ConsumerOnboardingFragment consumerOnboardingFragment) {
        super(1);
    ...
    public final void invoke2(View it) {
        ...
        onboardingViewModel.onLoginButtonClicked();
        loginClickedSubject = this.this$0.getLoginClickedSubject();
        loginClickedSubject.onNext(kotlin.x.a);
    }
}