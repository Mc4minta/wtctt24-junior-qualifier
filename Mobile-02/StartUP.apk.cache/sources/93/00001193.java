...
final class EventProperty_ApplicationKt$CoinName$2 extends o implements a<EventProperty> {
    public static final EventProperty_ApplicationKt$CoinName$2 INSTANCE = new EventProperty_ApplicationKt$CoinName$2();

    EventProperty_ApplicationKt$CoinName$2() {
        super(0);
    }
    ...
    public final EventProperty invoke() {
        return new EventProperty("coin_name");
    }
}