...
public final class AmountPickerFragment$setupSendAmountView$2 extends kotlin.jvm.internal.o implements kotlin.e0.c.l<String, kotlin.x> {
    final /* synthetic */ AmountPickerFragment this$0;

    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public AmountPickerFragment$setupSendAmountView$2(AmountPickerFragment amountPickerFragment) {
        super(1);
    ...
    public final void invoke2(String it) {
        ...
        amountPickerViewModel.updateSendAmount(it, Boolean.FALSE);
    }
}