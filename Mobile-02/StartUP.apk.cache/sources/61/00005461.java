...
public abstract class AbstractTypeParameterDescriptor extends DeclarationDescriptorNonRootImpl implements TypeParameterDescriptor {
    ...
    public class TypeParameterTypeConstructor extends AbstractTypeConstructor {
        ...
        public void reportSupertypeLoopError(KotlinType kotlinType) {
            ...
            this.this$0.mo2217reportSupertypeLoopError(kotlinType);
        }
    ...
    /* JADX INFO: Access modifiers changed from: protected */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public AbstractTypeParameterDescriptor(final StorageManager storageManager, DeclarationDescriptor declarationDescriptor, Annotations annotations, final Name name, Variance variance, boolean z, int i2, SourceElement sourceElement, final SupertypeLoopChecker supertypeLoopChecker) {
        ...
        this.reified = z;
        this.index = i2;
        this.typeConstructor = storageManager.createLazyValue(new a<TypeConstructor>() { // from class: kotlin.reflect.jvm.internal.impl.descriptors.impl.AbstractTypeParameterDescriptor.1
        ...
        this.defaultType = storageManager.createLazyValue(new a<SimpleType>() { // from class: kotlin.reflect.jvm.internal.impl.descriptors.impl.AbstractTypeParameterDescriptor.2
            @Override // kotlin.e0.c.a
            public SimpleType invoke() {
                return KotlinTypeFactory.simpleTypeWithNonTrivialMemberScope(Annotations.Companion.getEMPTY(), AbstractTypeParameterDescriptor.this.getTypeConstructor(), Collections.emptyList(), false, new LazyScopeAdapter(new a<MemberScope>() { // from class: kotlin.reflect.jvm.internal.impl.descriptors.impl.AbstractTypeParameterDescriptor.2.1
                    @Override // kotlin.e0.c.a
    ...
    public List<KotlinType> getUpperBounds() {
        List<KotlinType> mo2215getSupertypes = ((TypeParameterTypeConstructor) getTypeConstructor()).mo2215getSupertypes();
        if (mo2215getSupertypes == null) {
            $$$reportNull$$$0(8);
        }
    ...
    protected abstract void mo2217reportSupertypeLoopError(KotlinType kotlinType);
