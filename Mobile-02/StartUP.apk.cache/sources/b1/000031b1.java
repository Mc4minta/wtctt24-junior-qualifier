...
public final class x0 {
    ...
    private final Map<com.google.android.gms.tasks.h<?>, Boolean> f6146b = Collections.synchronizedMap(new WeakHashMap());
    ...
    private final void c(boolean z, Status status) {
        ...
        synchronized (this.f6146b) {
            hashMap2 = new HashMap(this.f6146b);
        }
    ...
    public final void b(BasePendingResult<? extends com.google.android.gms.common.api.i> basePendingResult, boolean z) {
    ...
    public final boolean d() {
        return (this.a.isEmpty() && this.f6146b.isEmpty()) ? false : true;
    }
