...
final class EventProperty_ApplicationKt$SwapFromAsset$2 extends o implements a<EventProperty> {
    public static final EventProperty_ApplicationKt$SwapFromAsset$2 INSTANCE = new EventProperty_ApplicationKt$SwapFromAsset$2();

    EventProperty_ApplicationKt$SwapFromAsset$2() {
        super(0);
    }
    ...
    public final EventProperty invoke() {
        return new EventProperty("from_asset");
    }
}