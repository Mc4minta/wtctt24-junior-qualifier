...
final class EventProperty_ApplicationKt$PresetName$2 extends o implements a<EventProperty> {
    public static final EventProperty_ApplicationKt$PresetName$2 INSTANCE = new EventProperty_ApplicationKt$PresetName$2();

    EventProperty_ApplicationKt$PresetName$2() {
        super(0);
    }
    ...
    public final EventProperty invoke() {
        return new EventProperty("preset_name");
    }
}