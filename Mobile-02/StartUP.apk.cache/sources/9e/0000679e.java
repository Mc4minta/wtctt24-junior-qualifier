...
public class X509CRLObject extends X509CRL {
    ...
    private CertificateList f17835c;
    ...
    private void doVerify(PublicKey publicKey, Signature signature) throws CRLException, NoSuchAlgorithmException, InvalidKeyException, SignatureException {
        if (this.f17835c.getSignatureAlgorithm().equals(this.f17835c.getTBSCertList().getSignature())) {
    ...
    private Set getExtensionOIDs(boolean z) {
        ...
        if (getVersion() != 2 || (extensions = this.f17835c.getTBSCertList().getExtensions()) == null) {
            return null;
        }
    ...
    private Set loadCRLEntries() {
        Extension extension;
        HashSet hashSet = new HashSet();
        Enumeration revokedCertificateEnumeration = this.f17835c.getRevokedCertificateEnumeration();
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof X509CRL) {
            if (obj instanceof X509CRLObject) {
                ...
                return this.f17835c.equals(x509CRLObject.f17835c);
            }
    ...
    public byte[] getEncoded() throws CRLException {
        try {
            return this.f17835c.getEncoded(ASN1Encoding.DER);
    ...
    public byte[] getExtensionValue(String str) {
        Extension extension;
        Extensions extensions = this.f17835c.getTBSCertList().getExtensions();
    ...
    public Principal getIssuerDN() {
        return new X509Principal(X500Name.getInstance(this.f17835c.getIssuer().toASN1Primitive()));
    }

    @Override // java.security.cert.X509CRL
    public X500Principal getIssuerX500Principal() {
        try {
            return new X500Principal(this.f17835c.getIssuer().getEncoded());
    ...
    public Date getNextUpdate() {
        if (this.f17835c.getNextUpdate() != null) {
            return this.f17835c.getNextUpdate().getDate();
        }
        return null;
    }
    ...
    public String getSigAlgOID() {
        return this.f17835c.getSignatureAlgorithm().getAlgorithm().getId();
    }
    ...
    public byte[] getSignature() {
        return this.f17835c.getSignature().getOctets();
    }

    @Override // java.security.cert.X509CRL
    public byte[] getTBSCertList() throws CRLException {
        try {
            return this.f17835c.getTBSCertList().getEncoded(ASN1Encoding.DER);
        } catch (IOException e2) {
            throw new CRLException(e2.toString());
        }
    }
    ...
    public Date getThisUpdate() {
        return this.f17835c.getThisUpdate().getDate();
    }

    @Override // java.security.cert.X509CRL
    public int getVersion() {
        return this.f17835c.getVersionNumber();
    }
    ...
    public boolean isRevoked(Certificate certificate) {
        ...
        if (certificate.getType().equals("X.509")) {
            Enumeration revokedCertificateEnumeration = this.f17835c.getRevokedCertificateEnumeration();
            X500Name issuer2 = this.f17835c.getIssuer();
