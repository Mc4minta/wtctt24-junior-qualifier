...
final class SwapAmountPickerFragment$setupListeners$1 extends o implements l<View, x> {
    final /* synthetic */ SwapAmountPickerFragment this$0;

    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public SwapAmountPickerFragment$setupListeners$1(SwapAmountPickerFragment swapAmountPickerFragment) {
        super(1);
    ...
    public final void invoke2(View it) {
        m.g(it, "it");
        Analytics.INSTANCE.log(AnalyticsEvent_ApplicationKt.getSwapAmountPickerClose(AnalyticsEvent.Companion));
