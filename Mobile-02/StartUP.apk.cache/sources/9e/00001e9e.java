...
public final class LendProviderPickerViewModel$lendWallet$2 extends kotlin.jvm.internal.o implements kotlin.e0.c.a<Wallet> {
    final /* synthetic */ LendProviderPickerViewModel this$0;

    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public LendProviderPickerViewModel$lendWallet$2(LendProviderPickerViewModel lendProviderPickerViewModel) {
        super(0);
    ...
    public final Wallet invoke() {
        return (Wallet) Bundle_CommonKt.requireParcelable(this.this$0.getArgs(), LendProviderPickerArgs.lendWalletKey);
    }
}