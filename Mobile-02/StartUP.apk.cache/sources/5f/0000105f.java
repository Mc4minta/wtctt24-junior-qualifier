...
/* compiled from: SignEthereumTransactionCallParamsJsonJsonAdapter.kt */
@Metadata(bv = {1, 0, 3}, d1 = {"\u0000L\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0010\u000e\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0010\b\n\u0002\b\u0002\n\u0002\u0010\u000b\n\u0002\b\u0004\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\b\u0000\u0018\u00002\b\u0012\u0004\u0012\u00020\u00020\u0001B\u000f\u0012\u0006\u0010\u001c\u001a\u00020\u001b¢\u0006\u0004\b\u001d\u0010\u001eJ\u000f\u0010\u0004\u001a\u00020\u0003H\u0016¢\u0006\u0004\b\u0004\u0010\u0005J\u0017\u0010\b\u001a\u00020\u00022\u0006\u0010\u0007\u001a\u00020\u0006H\u0016¢\u0006\u0004\b\b\u0010\tJ!\u0010\u000e\u001a\u00020\r2\u0006\u0010\u000b\u001a\u00020\n2\b\u0010\f\u001a\u0004\u0018\u00010\u0002H\u0016¢\u0006\u0004\b\u000e\u0010\u000fR\u001e\u0010\u0011\u001a\n\u0012\u0006\u0012\u0004\u0018\u00010\u00100\u00018\u0002@\u0002X\u0082\u0004¢\u0006\u0006\n\u0004\b\u0011\u0010\u0012R\u001c\u0010\u0014\u001a\b\u0012\u0004\u0012\u00020\u00130\u00018\u0002@\u0002X\u0082\u0004¢\u0006\u0006\n\u0004\b\u0014\u0010\u0012R\u001e\u0010\u0015\u001a\n\u0012\u0006\u0012\u0004\u0018\u00010\u00030\u00018\u0002@\u0002X\u0082\u0004¢\u0006\u0006\n\u0004\b\u0015\u0010\u0012R\u001c\u0010\u0016\u001a\b\u0012\u0004\u0012\u00020\u00100\u00018\u0002@\u0002X\u0082\u0004¢\u0006\u0006\n\u0004\b\u0016\u0010\u0012R\u001c\u0010\u0017\u001a\b\u0012\u0004\u0012\u00020\u00030\u00018\u0002@\u0002X\u0082\u0004¢\u0006\u0006\n\u0004\b\u0017\u0010\u0012R\u0016\u0010\u0019\u001a\u00020\u00188\u0002@\u0002X\u0082\u0004¢\u0006\u0006\n\u0004\b\u0019\u0010\u001a¨\u0006\u001f"}, d2 = {"Lcom/coinbase/cipherwebview/models/web3/json/SignEthereumTransactionCallParamsJsonJsonAdapter;", "Lcom/squareup/moshi/JsonAdapter;", "Lcom/coinbase/cipherwebview/models/web3/json/SignEthereumTransactionCallParamsJson;", "", "toString", "()Ljava/lang/String;", "Lcom/squareup/moshi/JsonReader;", "reader", "fromJson", "(Lcom/squareup/moshi/JsonReader;)Lcom/coinbase/cipherwebview/models/web3/json/SignEthereumTransactionCallParamsJson;", "Lcom/squareup/moshi/JsonWriter;", "writer", "value_", "Lkotlin/x;", "toJson", "(Lcom/squareup/moshi/JsonWriter;Lcom/coinbase/cipherwebview/models/web3/json/SignEthereumTransactionCallParamsJson;)V", "", "nullableIntAdapter", "Lcom/squareup/moshi/JsonAdapter;", "", "booleanAdapter", "nullableStringAdapter", "intAdapter", "stringAdapter", "Lcom/squareup/moshi/JsonReader$Options;", "options", "Lcom/squareup/moshi/JsonReader$Options;", "Lcom/squareup/moshi/Moshi;", "moshi", "<init>", "(Lcom/squareup/moshi/Moshi;)V", "cipher-webview_release"}, k = 1, mv = {1, 5, 1})
/* loaded from: classes.dex */
public final class SignEthereumTransactionCallParamsJsonJsonAdapter extends JsonAdapter<SignEthereumTransactionCallParamsJson> {
    ...
    public SignEthereumTransactionCallParamsJsonJsonAdapter(Moshi moshi) {
    ...
    public String toString() {
        ...
        sb.append("SignEthereumTransactionCallParamsJson");
        sb.append(')');
    ...
    public SignEthereumTransactionCallParamsJson fromJson(JsonReader reader) {
        m.g(reader, "reader");
        reader.beginObject();
        Integer num = null;
        Boolean bool = null;
        ...
        while (true) {
            ...
            if (reader.hasNext()) {
                ...
                if (str == null) {
                    ...
                    if (bool != null) {
                        return new SignEthereumTransactionCallParamsJson(str, str2, str3, str4, num2, str12, str11, str10, str9, intValue, bool.booleanValue());
                    }
    ...
    @Override // com.squareup.moshi.JsonAdapter
    public void toJson(JsonWriter writer, SignEthereumTransactionCallParamsJson signEthereumTransactionCallParamsJson) {
        m.g(writer, "writer");
        Objects.requireNonNull(signEthereumTransactionCallParamsJson, "value_ was null! Wrap in .nullSafe() to write nullable values.");
        writer.beginObject();
        writer.name("fromAddress");
        this.stringAdapter.toJson(writer, (JsonWriter) signEthereumTransactionCallParamsJson.getFromAddress());
        writer.name("toAddress");
        this.nullableStringAdapter.toJson(writer, (JsonWriter) signEthereumTransactionCallParamsJson.getToAddress());
        writer.name("weiValue");
        this.stringAdapter.toJson(writer, (JsonWriter) signEthereumTransactionCallParamsJson.getWeiValue());
        writer.name("data");
        this.stringAdapter.toJson(writer, (JsonWriter) signEthereumTransactionCallParamsJson.getData());
        writer.name(AdjustableMinerFeeArgs.NONCE);
        this.nullableIntAdapter.toJson(writer, (JsonWriter) signEthereumTransactionCallParamsJson.getNonce());
        writer.name("gasPriceInWei");
        this.nullableStringAdapter.toJson(writer, (JsonWriter) signEthereumTransactionCallParamsJson.getGasPriceInWei());
        writer.name("maxFeePerGas");
        this.nullableStringAdapter.toJson(writer, (JsonWriter) signEthereumTransactionCallParamsJson.getMaxFeePerGas());
        writer.name("maxPriorityFeePerGas");
        this.nullableStringAdapter.toJson(writer, (JsonWriter) signEthereumTransactionCallParamsJson.getMaxPriorityFeePerGas());
        writer.name("gasLimit");
        this.nullableStringAdapter.toJson(writer, (JsonWriter) signEthereumTransactionCallParamsJson.getGasLimit());
        writer.name(RouteActionKey.RouteActionKeys.CHAIN_ID);
        this.intAdapter.toJson(writer, (JsonWriter) Integer.valueOf(signEthereumTransactionCallParamsJson.getChainId()));
        writer.name("shouldSubmit");
        this.booleanAdapter.toJson(writer, (JsonWriter) Boolean.valueOf(signEthereumTransactionCallParamsJson.getShouldSubmit()));
        writer.endObject();
    }
}