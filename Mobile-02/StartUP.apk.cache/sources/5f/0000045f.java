...
public abstract class VersionedParcel {
    ...
    protected final c.e.a<String, Method> f2365b;

    /* renamed from: c  reason: collision with root package name */
    protected final c.e.a<String, Class> f2366c;
    ...
    private Class c(Class<? extends b> cls) throws ClassNotFoundException {
        Class cls2 = this.f2366c.get(cls.getName());
        if (cls2 == null) {
            Class<?> cls3 = Class.forName(String.format("%s.%sParcelizer", cls.getPackage().getName(), cls.getSimpleName()), false, cls.getClassLoader());
            this.f2366c.put(cls.getName(), cls3);
            return cls3;
        }
        return cls2;
    }
    ...
    private Method e(Class cls) throws IllegalAccessException, NoSuchMethodException, ClassNotFoundException {
        Method method = this.f2365b.get(cls.getName());
        if (method == null) {
            Class c2 = c(cls);
            System.currentTimeMillis();
            Method declaredMethod = c2.getDeclaredMethod("write", cls, VersionedParcel.class);
            this.f2365b.put(cls.getName(), declaredMethod);
            return declaredMethod;
        }
        return method;
    }
