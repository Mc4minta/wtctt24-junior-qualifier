...
public final class ParentRequestEthereumAccountsViewModel$approve$1 extends kotlin.jvm.internal.o implements kotlin.e0.c.l<Throwable, x> {
    final /* synthetic */ ParentRequestEthereumAccountsViewModel this$0;

    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public ParentRequestEthereumAccountsViewModel$approve$1(ParentRequestEthereumAccountsViewModel parentRequestEthereumAccountsViewModel) {
        super(1);
    ...
    public final void invoke2(Throwable it) {
        ...
        signatureRequestEventSubject.onNext(new SigningSessionEvent.Failure(this.this$0.getViewState().getUuid(), it));
    }
}