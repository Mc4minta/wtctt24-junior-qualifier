...
public final class WalletsRepositoriesModule_Companion_ProvidesXRPWalletRepositoryFactory implements d<WalletManaging> {
    ...
    public WalletsRepositoriesModule_Companion_ProvidesXRPWalletRepositoryFactory(Provider<AddressDao> provider, Provider<WalletDao> provider2, Provider<StoreInterface> provider3, Provider<CipherCoreInterface> provider4, Provider<XRPService> provider5, Provider<XRPSignedTxDAO> provider6) {
    ...
    public static WalletsRepositoriesModule_Companion_ProvidesXRPWalletRepositoryFactory create(Provider<AddressDao> provider, Provider<WalletDao> provider2, Provider<StoreInterface> provider3, Provider<CipherCoreInterface> provider4, Provider<XRPService> provider5, Provider<XRPSignedTxDAO> provider6) {
        return new WalletsRepositoriesModule_Companion_ProvidesXRPWalletRepositoryFactory(provider, provider2, provider3, provider4, provider5, provider6);
    }
    ...
    public static WalletManaging providesXRPWalletRepository(AddressDao addressDao, WalletDao walletDao, StoreInterface storeInterface, CipherCoreInterface cipherCoreInterface, XRPService xRPService, XRPSignedTxDAO xRPSignedTxDAO) {
        return (WalletManaging) h.f(WalletsRepositoriesModule.Companion.providesXRPWalletRepository(addressDao, walletDao, storeInterface, cipherCoreInterface, xRPService, xRPSignedTxDAO));
    }
