...
public final class TxManagingModule_Companion_ProvidesDOGETxManaging$wallets_releaseFactory implements d<TxManaging> {
    ...
    public TxManagingModule_Companion_ProvidesDOGETxManaging$wallets_releaseFactory(Provider<DOGEService> provider, Provider<AddressDao> provider2, Provider<WalletDao> provider3, Provider<BIP44SignedTxDao> provider4, Provider<CipherCoreInterface> provider5, Provider<StoreInterface> provider6, Provider<Tracing> provider7, Provider<BatchBalanceAPI> provider8) {
    ...
    public static TxManagingModule_Companion_ProvidesDOGETxManaging$wallets_releaseFactory create(Provider<DOGEService> provider, Provider<AddressDao> provider2, Provider<WalletDao> provider3, Provider<BIP44SignedTxDao> provider4, Provider<CipherCoreInterface> provider5, Provider<StoreInterface> provider6, Provider<Tracing> provider7, Provider<BatchBalanceAPI> provider8) {
        return new TxManagingModule_Companion_ProvidesDOGETxManaging$wallets_releaseFactory(provider, provider2, provider3, provider4, provider5, provider6, provider7, provider8);
    }
    ...
    public static TxManaging providesDOGETxManaging$wallets_release(DOGEService dOGEService, AddressDao addressDao, WalletDao walletDao, BIP44SignedTxDao bIP44SignedTxDao, CipherCoreInterface cipherCoreInterface, StoreInterface storeInterface, Tracing tracing, BatchBalanceAPI batchBalanceAPI) {
        return (TxManaging) h.f(TxManagingModule.Companion.providesDOGETxManaging$wallets_release(dOGEService, addressDao, walletDao, bIP44SignedTxDao, cipherCoreInterface, storeInterface, tracing, batchBalanceAPI));
    }
