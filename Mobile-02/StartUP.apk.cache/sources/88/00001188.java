...
final class EventFeature_ApplicationKt$Settings$2 extends o implements a<EventFeature> {
    public static final EventFeature_ApplicationKt$Settings$2 INSTANCE = new EventFeature_ApplicationKt$Settings$2();

    EventFeature_ApplicationKt$Settings$2() {
        super(0);
    }
    ...
    public final EventFeature invoke() {
        return new EventFeature("Settings");
    }
}