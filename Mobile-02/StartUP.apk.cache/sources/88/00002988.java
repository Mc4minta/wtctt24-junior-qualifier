...
final class EventProperty_WalletsKt$TxHash$2 extends o implements a<EventProperty> {
    public static final EventProperty_WalletsKt$TxHash$2 INSTANCE = new EventProperty_WalletsKt$TxHash$2();

    EventProperty_WalletsKt$TxHash$2() {
        super(0);
    }
    ...
    public final EventProperty invoke() {
        return new EventProperty("tx_hash");
    }
}