...
public class DecodePath<DataType, ResourceType, Transcode> {
    ...
    private final f<List<Throwable>> listPool;
    ...
    public DecodePath(Class<DataType> cls, Class<ResourceType> cls2, Class<Transcode> cls3, List<? extends ResourceDecoder<DataType, ResourceType>> list, ResourceTranscoder<ResourceType, Transcode> resourceTranscoder, f<List<Throwable>> fVar) {
        this.dataClass = cls;
        this.decoders = list;
