...
final class CurrencyCode_WalletsKt$WBTC$2 extends o implements a<CurrencyCode> {
    public static final CurrencyCode_WalletsKt$WBTC$2 INSTANCE = new CurrencyCode_WalletsKt$WBTC$2();

    CurrencyCode_WalletsKt$WBTC$2() {
        super(0);
    }
