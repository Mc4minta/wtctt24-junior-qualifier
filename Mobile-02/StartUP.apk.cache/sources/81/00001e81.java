...
final class LendAmountPickerViewModel$lendToken$2 extends kotlin.jvm.internal.o implements kotlin.e0.c.a<LendToken> {
    final /* synthetic */ LendAmountPickerViewModel this$0;

    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public LendAmountPickerViewModel$lendToken$2(LendAmountPickerViewModel lendAmountPickerViewModel) {
        super(0);
    ...
    public final LendToken invoke() {
        return (LendToken) Bundle_CommonKt.requireParcelable(this.this$0.getArgs(), LendAmountPickerArgs.lendTokenKey);
    }
}