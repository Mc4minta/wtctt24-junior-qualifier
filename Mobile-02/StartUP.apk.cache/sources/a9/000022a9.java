...
public final class SwapAmountPickerFragment$setupObservers$5 extends o implements l<SwapAsset, x> {
    final /* synthetic */ SwapAmountPickerFragment this$0;

    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public SwapAmountPickerFragment$setupObservers$5(SwapAmountPickerFragment swapAmountPickerFragment) {
        super(1);
    ...
    public final void invoke2(SwapAsset swapAsset) {
        ...
        viewModel.onSourceAssetSelected(swapAsset);
    }
}