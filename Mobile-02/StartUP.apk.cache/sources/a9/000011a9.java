...
final class EventProperty_ApplicationKt$RecipientType$2 extends o implements a<EventProperty> {
    public static final EventProperty_ApplicationKt$RecipientType$2 INSTANCE = new EventProperty_ApplicationKt$RecipientType$2();

    EventProperty_ApplicationKt$RecipientType$2() {
        super(0);
    }
    ...
    public final EventProperty invoke() {
        return new EventProperty("recipient_type");
    }
}