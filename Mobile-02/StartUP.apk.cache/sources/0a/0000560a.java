...
public final class BinaryClassAnnotationAndConstantLoaderImpl extends AbstractBinaryClassAnnotationAndConstantLoader<AnnotationDescriptor, ConstantValue<?>> {
    ...
    public KotlinJvmBinaryClass.AnnotationArgumentVisitor loadAnnotation(ClassId annotationClassId, SourceElement source, List<AnnotationDescriptor> result) {
        m.g(annotationClassId, "annotationClassId");
        m.g(source, "source");
        m.g(result, "result");
        return new BinaryClassAnnotationAndConstantLoaderImpl$loadAnnotation$1(resolveClass(annotationClassId), this, result, source);
    }
