...
final class NetworkSetting_BitcoinKt$BTC$2 extends o implements a<NetworkSetting> {
    public static final NetworkSetting_BitcoinKt$BTC$2 INSTANCE = new NetworkSetting_BitcoinKt$BTC$2();

    NetworkSetting_BitcoinKt$BTC$2() {
        super(0);
    }
    ...
    public final NetworkSetting invoke() {
        return NetworkSetting.Companion.forTestnetBasedBlockchain(Blockchain_BitcoinKt.getBITCOIN(Blockchain.Companion));
    }
}