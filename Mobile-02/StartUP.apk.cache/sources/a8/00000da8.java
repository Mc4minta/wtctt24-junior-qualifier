...
public final class UpdateStepResponse extends a {
    ...
    /* compiled from: UpdateStepResponse.kt */
    @Metadata(bv = {1, 0, 3}, d1 = {"\u0000\u001c\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0005\b\u0086\u0003\u0018\u00002\u00020\u0001B\t\b\u0002¢\u0006\u0004\b\t\u0010\nR\u001c\u0010\u0004\u001a\b\u0012\u0004\u0012\u00020\u00030\u00028\u0006@\u0007X\u0087\u0004¢\u0006\u0006\n\u0004\b\u0004\u0010\u0005R\u001c\u0010\u0007\u001a\b\u0012\u0004\u0012\u00020\u00030\u00068\u0006@\u0007X\u0087\u0004¢\u0006\u0006\n\u0004\b\u0007\u0010\b¨\u0006\u000b"}, d2 = {"Lcom/coinbase/android/apiv3/generated/authed/new_user_experience/UpdateStepResponse$Companion;", "", "Lcom/squareup/wire/ProtoAdapter;", "Lcom/coinbase/android/apiv3/generated/authed/new_user_experience/UpdateStepResponse;", "ADAPTER", "Lcom/squareup/wire/ProtoAdapter;", "Landroid/os/Parcelable$Creator;", "CREATOR", "Landroid/os/Parcelable$Creator;", "<init>", "()V", "apiv3"}, k = 1, mv = {1, 4, 0})
    /* loaded from: classes.dex */
    ...
    static {
        ProtoAdapter<UpdateStepResponse> protoAdapter = new ProtoAdapter<UpdateStepResponse>(c.LENGTH_DELIMITED, e0.b(UpdateStepResponse.class), "type.googleapis.com/coinbase.public_api.authed.new_user_experience.UpdateStepResponse") { // from class: com.coinbase.android.apiv3.generated.authed.new_user_experience.UpdateStepResponse$Companion$ADAPTER$1
            /* JADX WARN: Can't rename method to resolve collision */
            @Override // com.squareup.wire.ProtoAdapter
            public UpdateStepResponse decode(k reader) {
                m.h(reader, "reader");
                Step step = Step.NONE;
                long d2 = reader.d();
                Step step2 = step;
                ...
                while (true) {
                    int g2 = reader.g();
                    if (g2 == -1) {
                        return new UpdateStepResponse(step2, step3, simplifiedBuyMetadata, incentivesMetadata, simplifiedBuyReferralMetadata, reader.e(d2));
                    }
                    if (g2 == 1) {
                        try {
            ...
            @Override // com.squareup.wire.ProtoAdapter
            public void encode(l writer, UpdateStepResponse value) {
                m.h(writer, "writer");
                m.h(value, "value");
            ...
            @Override // com.squareup.wire.ProtoAdapter
            public int encodedSize(UpdateStepResponse value) {
                m.h(value, "value");
                Step next_pre_proofing_step = value.getNext_pre_proofing_step();
                Step step = Step.NONE;
                if (next_pre_proofing_step == step) {
            ...
            @Override // com.squareup.wire.ProtoAdapter
            public UpdateStepResponse redact(UpdateStepResponse value) {
                m.h(value, "value");
                ...
                return UpdateStepResponse.copy$default(value, null, null, redact, redact2, simplified_buy_referral_metadata != null ? SimplifiedBuyReferralMetadata.ADAPTER.redact(simplified_buy_referral_metadata) : null, i.a, 3, null);
            }
        };
    ...
    public /* synthetic */ UpdateStepResponse(Step step, Step step2, SimplifiedBuyMetadata simplifiedBuyMetadata, IncentivesMetadata incentivesMetadata, SimplifiedBuyReferralMetadata simplifiedBuyReferralMetadata, i iVar, int i2, DefaultConstructorMarker defaultConstructorMarker) {
    ...
    public static /* synthetic */ UpdateStepResponse copy$default(UpdateStepResponse updateStepResponse, Step step, Step step2, SimplifiedBuyMetadata simplifiedBuyMetadata, IncentivesMetadata incentivesMetadata, SimplifiedBuyReferralMetadata simplifiedBuyReferralMetadata, i iVar, int i2, Object obj) {
        if ((i2 & 1) != 0) {
            step = updateStepResponse.next_pre_proofing_step;
        }
        if ((i2 & 2) != 0) {
            step2 = updateStepResponse.next_post_proofing_step;
        }
        Step step3 = step2;
        if ((i2 & 4) != 0) {
            simplifiedBuyMetadata = updateStepResponse.simplified_buy_metadata;
        }
        SimplifiedBuyMetadata simplifiedBuyMetadata2 = simplifiedBuyMetadata;
        if ((i2 & 8) != 0) {
            incentivesMetadata = updateStepResponse.incentives_metadata;
        }
        IncentivesMetadata incentivesMetadata2 = incentivesMetadata;
        if ((i2 & 16) != 0) {
            simplifiedBuyReferralMetadata = updateStepResponse.simplified_buy_referral_metadata;
        }
        SimplifiedBuyReferralMetadata simplifiedBuyReferralMetadata2 = simplifiedBuyReferralMetadata;
        if ((i2 & 32) != 0) {
            iVar = updateStepResponse.unknownFields();
        }
        return updateStepResponse.copy(step, step3, simplifiedBuyMetadata2, incentivesMetadata2, simplifiedBuyReferralMetadata2, iVar);
    }

    public final UpdateStepResponse copy(Step next_pre_proofing_step, Step next_post_proofing_step, SimplifiedBuyMetadata simplifiedBuyMetadata, IncentivesMetadata incentivesMetadata, SimplifiedBuyReferralMetadata simplifiedBuyReferralMetadata, i unknownFields) {
        m.h(next_pre_proofing_step, "next_pre_proofing_step");
        m.h(next_post_proofing_step, "next_post_proofing_step");
        m.h(unknownFields, "unknownFields");
        return new UpdateStepResponse(next_pre_proofing_step, next_post_proofing_step, simplifiedBuyMetadata, incentivesMetadata, simplifiedBuyReferralMetadata, unknownFields);
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof UpdateStepResponse) {
            UpdateStepResponse updateStepResponse = (UpdateStepResponse) obj;
            return m.c(unknownFields(), updateStepResponse.unknownFields()) && this.next_pre_proofing_step == updateStepResponse.next_pre_proofing_step && this.next_post_proofing_step == updateStepResponse.next_post_proofing_step && m.c(this.simplified_buy_metadata, updateStepResponse.simplified_buy_metadata) && m.c(this.incentives_metadata, updateStepResponse.incentives_metadata) && m.c(this.simplified_buy_referral_metadata, updateStepResponse.simplified_buy_referral_metadata);
        }
        return false;
    }
    ...
    public String toString() {
        ...
        h0 = z.h0(arrayList, ", ", "UpdateStepResponse{", "}", 0, null, null, 56, null);
        return h0;
    }
    ...
    public UpdateStepResponse(Step next_pre_proofing_step, Step next_post_proofing_step, SimplifiedBuyMetadata simplifiedBuyMetadata, IncentivesMetadata incentivesMetadata, SimplifiedBuyReferralMetadata simplifiedBuyReferralMetadata, i unknownFields) {
