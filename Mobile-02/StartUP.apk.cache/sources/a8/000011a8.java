...
final class EventProperty_ApplicationKt$QueryLength$2 extends o implements a<EventProperty> {
    public static final EventProperty_ApplicationKt$QueryLength$2 INSTANCE = new EventProperty_ApplicationKt$QueryLength$2();

    EventProperty_ApplicationKt$QueryLength$2() {
        super(0);
    }
    ...
    public final EventProperty invoke() {
        return new EventProperty("query_length");
    }
}