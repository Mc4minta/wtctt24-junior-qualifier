...
final class LendDashboardFragment$onViewCreated$9 extends o implements l<View, x> {
    final /* synthetic */ LendDashboardFragment this$0;

    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public LendDashboardFragment$onViewCreated$9(LendDashboardFragment lendDashboardFragment) {
        super(1);
    ...
    public final void invoke2(View it) {
        ...
        if (lendDashboardViewModel != null) {
            lendDashboardViewModel.dismissView();
        } else {
            m.w("viewModel");
            throw null;
        }
