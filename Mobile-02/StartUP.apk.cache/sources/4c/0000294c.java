...
public final class WalletsRepositoriesModule_ProvideExchangeRateRepository$wallets_releaseFactory implements d<IExchangeRateRepository> {
    ...
    public WalletsRepositoriesModule_ProvideExchangeRateRepository$wallets_releaseFactory(Provider<IFiatCurrencyRepository> provider, Provider<ExchangeRateAPI> provider2, Provider<CompoundFinanceRepository> provider3, Provider<FiatExchangeRateDAO> provider4, Provider<IWalletRepository> provider5, Provider<Tracing> provider6) {
    ...
    public static WalletsRepositoriesModule_ProvideExchangeRateRepository$wallets_releaseFactory create(Provider<IFiatCurrencyRepository> provider, Provider<ExchangeRateAPI> provider2, Provider<CompoundFinanceRepository> provider3, Provider<FiatExchangeRateDAO> provider4, Provider<IWalletRepository> provider5, Provider<Tracing> provider6) {
        return new WalletsRepositoriesModule_ProvideExchangeRateRepository$wallets_releaseFactory(provider, provider2, provider3, provider4, provider5, provider6);
    }
    ...
    public static IExchangeRateRepository provideExchangeRateRepository$wallets_release(IFiatCurrencyRepository iFiatCurrencyRepository, ExchangeRateAPI exchangeRateAPI, CompoundFinanceRepository compoundFinanceRepository, FiatExchangeRateDAO fiatExchangeRateDAO, IWalletRepository iWalletRepository, Tracing tracing) {
        IExchangeRateRepository provideExchangeRateRepository$wallets_release;
        provideExchangeRateRepository$wallets_release = WalletsRepositoriesModule.Companion.provideExchangeRateRepository$wallets_release(iFiatCurrencyRepository, exchangeRateAPI, compoundFinanceRepository, fiatExchangeRateDAO, iWalletRepository, tracing);
        return (IExchangeRateRepository) h.f(provideExchangeRateRepository$wallets_release);
    }
