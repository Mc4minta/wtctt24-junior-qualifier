...
public final class FqNameUnsafe {
    ...
    private static final l<String, Name> STRING_TO_NAME = new l<String, Name>() { // from class: kotlin.reflect.jvm.internal.impl.name.FqNameUnsafe.1
    ...
    public List<Name> pathSegments() {
        List<Name> emptyList = isRoot() ? Collections.emptyList() : j.P(SPLIT_BY_DOTS.split(this.fqName), STRING_TO_NAME);
        if (emptyList == null) {
            $$$reportNull$$$0(14);
        }
        return emptyList;
