...
public class e extends b {
    ...
    public double c(double d2, int i2) {
        ...
        int i3 = 0;
        if (d2 <= dArr[0]) {
            return this.f2685b[0][i2];
        }
        int i4 = length - 1;
        if (d2 >= dArr[i4]) {
            return this.f2685b[i4][i2];
        }
        while (i3 < i4) {
            double[] dArr2 = this.a;
            if (d2 == dArr2[i3]) {
                return this.f2685b[i3][i2];
            }
            int i5 = i3 + 1;
            if (d2 < dArr2[i5]) {
                double d3 = dArr2[i5] - dArr2[i3];
                double d4 = (d2 - dArr2[i3]) / d3;
                double[][] dArr3 = this.f2685b;
                double d5 = dArr3[i3][i2];
                double d6 = dArr3[i5][i2];
                double[][] dArr4 = this.f2686c;
                return j(d3, d4, d5, d6, dArr4[i3][i2], dArr4[i5][i2]);
            }
            i3 = i5;
        }
        return 0.0d;
    ...
    public void d(double d2, double[] dArr) {
        ...
        int i2 = 0;
        int length2 = this.f2685b[0].length;
        if (d2 <= dArr2[0]) {
            for (int i3 = 0; i3 < length2; i3++) {
                dArr[i3] = this.f2685b[0][i3];
            }
            return;
        }
        int i4 = length - 1;
        ...
        while (i5 < i4) {
            ...
            if (d2 < dArr3[i7]) {
                ...
                while (i2 < length2) {
                    double[][] dArr4 = this.f2685b;
                    double d5 = dArr4[i5][i2];
                    double d6 = dArr4[i7][i2];
                    double[][] dArr5 = this.f2686c;
                    dArr[i2] = j(d3, d4, d5, d6, dArr5[i5][i2], dArr5[i7][i2]);
                    i2++;
                }
                return;
            }
    ...
    public void e(double d2, float[] fArr) {
        ...
        if (d2 <= dArr[0]) {
            for (int i3 = 0; i3 < length2; i3++) {
                fArr[i3] = (float) this.f2685b[0][i3];
            }
            return;
        }
        int i4 = length - 1;
        if (d2 >= dArr[i4]) {
            while (i2 < length2) {
                fArr[i2] = (float) this.f2685b[i4][i2];
                i2++;
            }
            return;
        }
        ...
        while (i5 < i4) {
            if (d2 == this.a[i5]) {
                for (int i6 = 0; i6 < length2; i6++) {
                    fArr[i6] = (float) this.f2685b[i5][i6];
                }
            }
            double[] dArr2 = this.a;
            int i7 = i5 + 1;
            if (d2 < dArr2[i7]) {
                ...
                while (i2 < length2) {
                    ...
                    double[][] dArr4 = this.f2686c;
                    fArr[i2] = (float) j(d3, d4, d5, d6, dArr4[i5][i2], dArr4[i7][i2]);
                    i2++;
                }
                return;
            }
    ...
    public double f(double d2, int i2) {
        ...
        while (i3 < length - 1) {
            ...
            if (d3 <= dArr2[i5]) {
                ...
                double d6 = dArr3[i5][i2];
                double[][] dArr4 = this.f2686c;
                return i(d4, (d3 - dArr2[i3]) / d4, d5, d6, dArr4[i3][i2], dArr4[i5][i2]) / d4;
            }
            i3 = i5;
        }
        return 0.0d;
        ...
        while (i3 < length - 1) {
            ...
            if (d3 <= dArr3[i4]) {
                ...
                for (int i5 = 0; i5 < length2; i5++) {
                    ...
                    double[][] dArr5 = this.f2686c;
                    dArr[i5] = i(d4, d5, d6, d7, dArr5[i3][i5], dArr5[i4][i5]) / d4;
                }
                return;
            }
            i3 = i4;
