...
public class RFC4519Style extends AbstractX500NameStyle {
    ...
    public static final ASN1ObjectIdentifier f17774c;
    ...
    public static final ASN1ObjectIdentifier f17775l;
    ...
    static {
        ...
        hashtable.put(intern2, Constants.URL_CAMPAIGN);
        hashtable.put(intern3, "cn");
        hashtable.put(intern4, "dc");
        hashtable.put(intern5, ApiConstants.DESCRIPTION);
        ...
        hashtable.put(intern18, ApiConstants.NAME);
        ...
        hashtable2.put(Constants.URL_CAMPAIGN, intern2);
        hashtable2.put("cn", intern3);
        hashtable2.put("dc", intern4);
        hashtable2.put(ApiConstants.DESCRIPTION, intern5);
        ...
        hashtable2.put(ApiConstants.NAME, intern18);
    ...
    public ASN1Encodable encodeStringValue(ASN1ObjectIdentifier aSN1ObjectIdentifier, String str) {
        ...
        if (!aSN1ObjectIdentifier.equals(f17774c) && !aSN1ObjectIdentifier.equals(serialNumber) && !aSN1ObjectIdentifier.equals(dnQualifier) && !aSN1ObjectIdentifier.equals(telephoneNumber)) {
