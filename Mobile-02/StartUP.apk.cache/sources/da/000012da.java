...
final class TxMetadataKey_BIP44WalletsKt$inputCount$2 extends o implements a<TxMetadataKey> {
    public static final TxMetadataKey_BIP44WalletsKt$inputCount$2 INSTANCE = new TxMetadataKey_BIP44WalletsKt$inputCount$2();

    TxMetadataKey_BIP44WalletsKt$inputCount$2() {
        super(0);
    }
    ...
    public final TxMetadataKey invoke() {
        return TxMetadataKey.Companion.create("inputCount", UInt.class);
    }
}