...
class X509CertificateObject extends X509Certificate implements PKCS12BagAttributeCarrier {
    ...
    private void checkSignature(PublicKey publicKey, Signature signature) throws CertificateException, NoSuchAlgorithmException, SignatureException, InvalidKeyException {
        if (isAlgIdEqual(this.f17832c.getSignatureAlgorithm(), this.f17832c.getTBSCertificate().getSignature())) {
            X509SignatureUtil.setSignatureParameters(signature, this.f17832c.getSignatureAlgorithm().getParameters());
    ...
    private byte[] getExtensionBytes(String str) {
        Extension extension;
        Extensions extensions = this.f17832c.getTBSCertificate().getExtensions();
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof X509CertificateObject) {
            ...
            return this.f17832c.equals(x509CertificateObject.f17832c);
        }
    ...
    public int getBasicConstraints() {
        ...
        return this.basicConstraints.getPathLenConstraint() == null ? RCTCameraModule.RCT_CAMERA_ORIENTATION_AUTO : this.basicConstraints.getPathLenConstraint().intValue();
    }
    ...
    public byte[] getEncoded() throws CertificateEncodingException {
        try {
            return this.f17832c.getEncoded(ASN1Encoding.DER);
    ...
    public Principal getIssuerDN() {
        try {
            return new X509Principal(X500Name.getInstance(this.f17832c.getIssuer().getEncoded()));
    ...
    public boolean[] getIssuerUniqueID() {
        DERBitString issuerUniqueId = this.f17832c.getTBSCertificate().getIssuerUniqueId();
    ...
    public X500Principal getIssuerX500Principal() {
        try {
            ...
            new ASN1OutputStream(byteArrayOutputStream).writeObject(this.f17832c.getIssuer());
    ...
    public Date getNotAfter() {
        return this.f17832c.getEndDate().getDate();
    }

    @Override // java.security.cert.X509Certificate
    public Date getNotBefore() {
        return this.f17832c.getStartDate().getDate();
    }

    @Override // java.security.cert.Certificate
    public PublicKey getPublicKey() {
        try {
            return BouncyCastleProvider.getPublicKey(this.f17832c.getSubjectPublicKeyInfo());
        } catch (IOException unused) {
            return null;
        }
    }
    ...
    public BigInteger getSerialNumber() {
        return this.f17832c.getSerialNumber().getValue();
    }

    @Override // java.security.cert.X509Certificate
    public String getSigAlgName() {
        return X509SignatureUtil.getSignatureName(this.f17832c.getSignatureAlgorithm());
    }

    @Override // java.security.cert.X509Certificate
    public String getSigAlgOID() {
        return this.f17832c.getSignatureAlgorithm().getAlgorithm().getId();
    }

    @Override // java.security.cert.X509Certificate
    public byte[] getSigAlgParams() {
        if (this.f17832c.getSignatureAlgorithm().getParameters() != null) {
            try {
                return this.f17832c.getSignatureAlgorithm().getParameters().toASN1Primitive().getEncoded(ASN1Encoding.DER);
            } catch (IOException unused) {
            }
        }
        return null;
    ...
    public byte[] getSignature() {
        return this.f17832c.getSignature().getOctets();
    }
    ...
    public Principal getSubjectDN() {
        return new X509Principal(X500Name.getInstance(this.f17832c.getSubject().toASN1Primitive()));
    }

    @Override // java.security.cert.X509Certificate
    public boolean[] getSubjectUniqueID() {
        DERBitString subjectUniqueId = this.f17832c.getTBSCertificate().getSubjectUniqueId();
    ...
    public X500Principal getSubjectX500Principal() {
        try {
            ByteArrayOutputStream byteArrayOutputStream = new ByteArrayOutputStream();
            new ASN1OutputStream(byteArrayOutputStream).writeObject(this.f17832c.getSubject());
            return new X500Principal(byteArrayOutputStream.toByteArray());
        } catch (IOException unused) {
            throw new IllegalStateException("can't encode issuer DN");
        }
    ...
    public byte[] getTBSCertificate() throws CertificateEncodingException {
        try {
            return this.f17832c.getTBSCertificate().getEncoded(ASN1Encoding.DER);
        } catch (IOException e2) {
            throw new CertificateEncodingException(e2.toString());
        }
    }
    ...
    public int getVersion() {
        return this.f17832c.getVersionNumber();
    }

    @Override // java.security.cert.X509Extension
    public boolean hasUnsupportedCriticalExtension() {
        Extensions extensions;
        if (getVersion() != 3 || (extensions = this.f17832c.getTBSCertificate().getExtensions()) == null) {
            return false;
        }
        Enumeration oids = extensions.oids();
        while (oids.hasMoreElements()) {
    ...
    public final void verify(PublicKey publicKey) throws CertificateException, NoSuchAlgorithmException, InvalidKeyException, NoSuchProviderException, SignatureException {
        Signature signature;
        String signatureName = X509SignatureUtil.getSignatureName(this.f17832c.getSignatureAlgorithm());
        try {
    ...
    public void checkValidity(Date date) throws CertificateExpiredException, CertificateNotYetValidException {
        if (date.getTime() <= getNotAfter().getTime()) {
            ...
            throw new CertificateNotYetValidException("certificate not valid till " + this.f17832c.getStartDate().getTime());
        }
        throw new CertificateExpiredException("certificate expired on " + this.f17832c.getEndDate().getTime());
    }
