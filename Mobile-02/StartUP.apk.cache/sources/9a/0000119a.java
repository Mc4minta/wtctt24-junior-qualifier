...
final class EventProperty_ApplicationKt$DomainSource$2 extends o implements a<EventProperty> {
    public static final EventProperty_ApplicationKt$DomainSource$2 INSTANCE = new EventProperty_ApplicationKt$DomainSource$2();

    EventProperty_ApplicationKt$DomainSource$2() {
        super(0);
    }
    ...
    public final EventProperty invoke() {
        return new EventProperty("domain_source");
    }
}