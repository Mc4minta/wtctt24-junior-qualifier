...
final class CurrencyCode_WalletsKt$CETH$2 extends o implements a<CurrencyCode> {
    public static final CurrencyCode_WalletsKt$CETH$2 INSTANCE = new CurrencyCode_WalletsKt$CETH$2();

    CurrencyCode_WalletsKt$CETH$2() {
        super(0);
    }
