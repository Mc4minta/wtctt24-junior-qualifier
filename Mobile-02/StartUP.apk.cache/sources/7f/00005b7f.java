...
public final class BasicCertificateChainCleaner extends CertificateChainCleaner {
        ...
        for (int i2 = 0; i2 < 9; i2++) {
            ...
            if (obj != null) {
                ...
                if (findByIssuerAndSignature != null) {
                    if (arrayList.size() > 1 || (!m.c(x509Certificate, findByIssuerAndSignature))) {
    ...
    public boolean equals(Object obj) {
        ...
        return (obj instanceof BasicCertificateChainCleaner) && m.c(((BasicCertificateChainCleaner) obj).trustRootIndex, this.trustRootIndex);
    }
