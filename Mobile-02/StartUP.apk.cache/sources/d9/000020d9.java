...
final class AdjustableMinerFee1559PresetAdapter$MinerFeeCustomHolder$bind$5 extends o implements l<View, x> {
    final /* synthetic */ l<AdjustableMinerFee1559ViewInfoState, x> $onItemClickListener;
    final /* synthetic */ AdjustableMinerFee1559CustomViewInfoState $presetInfo;

    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    /* JADX WARN: Multi-variable type inference failed */
    public AdjustableMinerFee1559PresetAdapter$MinerFeeCustomHolder$bind$5(l<? super AdjustableMinerFee1559ViewInfoState, x> lVar, AdjustableMinerFee1559CustomViewInfoState adjustableMinerFee1559CustomViewInfoState) {
        super(1);
        this.$onItemClickListener = lVar;
        this.$presetInfo = adjustableMinerFee1559CustomViewInfoState;
    }
