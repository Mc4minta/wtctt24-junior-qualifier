...
final class AdjustableMinerFeePresetAdapter$MinerFeeCustomHolder$bind$2 extends o implements l<View, x> {
    final /* synthetic */ l<AdjustableMinerFeeViewInfoState, x> $onItemClickListener;
    final /* synthetic */ AdjustableMinerFeeCustomViewInfoState $presetInfo;

    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    /* JADX WARN: Multi-variable type inference failed */
    public AdjustableMinerFeePresetAdapter$MinerFeeCustomHolder$bind$2(l<? super AdjustableMinerFeeViewInfoState, x> lVar, AdjustableMinerFeeCustomViewInfoState adjustableMinerFeeCustomViewInfoState) {
        super(1);
        this.$onItemClickListener = lVar;
        this.$presetInfo = adjustableMinerFeeCustomViewInfoState;
    }
