...
public class BasicScheme extends RFC2617Scheme {
    ...
    public Header authenticate(Credentials credentials, HttpRequest httpRequest, HttpContext httpContext) throws AuthenticationException {
        ...
        byte[] g2 = new a(0).g(EncodingUtils.getBytes(sb.toString(), getCredentialsCharset(httpRequest)));
    ...
    public static Header authenticate(Credentials credentials, String str, boolean z) {
        ...
        sb.append(":");
        sb.append(credentials.getPassword() == null ? "null" : credentials.getPassword());
        byte[] q = a.q(EncodingUtils.getBytes(sb.toString(), str), false);
        CharArrayBuffer charArrayBuffer = new CharArrayBuffer(32);
        if (z) {
            charArrayBuffer.append("Proxy-Authorization");
        } else {
        ...
        charArrayBuffer.append(": Basic ");
        charArrayBuffer.append(q, 0, q.length);
        return new BufferedHeader(charArrayBuffer);
    }
}