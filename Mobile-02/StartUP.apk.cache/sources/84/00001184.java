...
final class EventFeature_ApplicationKt$Lend$2 extends o implements a<EventFeature> {
    public static final EventFeature_ApplicationKt$Lend$2 INSTANCE = new EventFeature_ApplicationKt$Lend$2();

    EventFeature_ApplicationKt$Lend$2() {
        super(0);
    }
