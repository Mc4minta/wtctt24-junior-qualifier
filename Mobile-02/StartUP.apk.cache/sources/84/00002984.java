...
final class EventProperty_WalletsKt$ChainId$2 extends o implements a<EventProperty> {
    public static final EventProperty_WalletsKt$ChainId$2 INSTANCE = new EventProperty_WalletsKt$ChainId$2();

    EventProperty_WalletsKt$ChainId$2() {
        super(0);
    }
