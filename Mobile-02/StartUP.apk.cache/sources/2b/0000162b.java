...
final class StoreKeys_ConsumerConnectKt$consumerScope$2 extends o implements a<EncryptedSharedPrefsStoreKey<String>> {
    public static final StoreKeys_ConsumerConnectKt$consumerScope$2 INSTANCE = new StoreKeys_ConsumerConnectKt$consumerScope$2();

    StoreKeys_ConsumerConnectKt$consumerScope$2() {
        super(0);
    }
    ...
    public final EncryptedSharedPrefsStoreKey<String> invoke() {
        return new EncryptedSharedPrefsStoreKey<>("consumerScope", null, String.class, 2, null);
    }
}