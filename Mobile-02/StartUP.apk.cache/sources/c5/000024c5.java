...
final class AddressKind_LitecoinKt$LiteCoinSegWit$2 extends o implements a<AddressType> {
    public static final AddressKind_LitecoinKt$LiteCoinSegWit$2 INSTANCE = new AddressKind_LitecoinKt$LiteCoinSegWit$2();

    AddressKind_LitecoinKt$LiteCoinSegWit$2() {
        super(0);
    }
    ...
    public final AddressType invoke() {
        return new AddressType("LiteCoinSegWit");
    }
}