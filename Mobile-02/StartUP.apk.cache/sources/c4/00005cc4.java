...
public class SSLConnectionSocketFactory implements LayeredConnectionSocketFactory {
    ...
    private void verifyHostname(SSLSocket sSLSocket, String str) throws IOException {
        try {
            ...
            if (session != null) {
                if (this.log.d()) {
                    this.log.a("Secure session established");
                    a aVar = this.log;
                    aVar.a(" negotiated protocol: " + session.getProtocol());
                    a aVar2 = this.log;
                    aVar2.a(" negotiated cipher suite: " + session.getCipherSuite());
                    try {
                        X509Certificate x509Certificate = (X509Certificate) session.getPeerCertificates()[0];
                        X500Principal subjectX500Principal = x509Certificate.getSubjectX500Principal();
                        a aVar3 = this.log;
                        aVar3.a(" peer principal: " + subjectX500Principal.toString());
                        ...
                        if (subjectAlternativeNames != null) {
                            ...
                            a aVar4 = this.log;
                            aVar4.a(" peer alternative names: " + arrayList);
                        }
                        X500Principal issuerX500Principal = x509Certificate.getIssuerX500Principal();
                        a aVar5 = this.log;
                        aVar5.a(" issuer principal: " + issuerX500Principal.toString());
                        ...
                        if (issuerAlternativeNames != null) {
                            ...
                            a aVar6 = this.log;
                            aVar6.a(" issuer alternative names: " + arrayList2);
                        }
    ...
    public Socket connectSocket(int i2, Socket socket, HttpHost httpHost, InetSocketAddress inetSocketAddress, InetSocketAddress inetSocketAddress2, HttpContext httpContext) throws IOException {
        ...
        if (this.log.d()) {
            a aVar = this.log;
            aVar.a("Connecting socket to " + inetSocketAddress + " with timeout " + i2);
        }
        socket.connect(inetSocketAddress, i2);
        if (socket instanceof SSLSocket) {
            SSLSocket sSLSocket = (SSLSocket) socket;
            this.log.a("Starting handshake");
            sSLSocket.startHandshake();
    ...
    public Socket createLayeredSocket(Socket socket, String str, int i2, HttpContext httpContext) throws IOException {
        ...
        if (this.log.d()) {
            this.log.a("Enabled protocols: " + Arrays.asList(sSLSocket.getEnabledProtocols()));
            this.log.a("Enabled cipher suites:" + Arrays.asList(sSLSocket.getEnabledCipherSuites()));
        }
