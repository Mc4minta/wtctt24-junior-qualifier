...
/* compiled from: EthereumSignedTxDao.kt */
@Metadata(bv = {1, 0, 3}, d1 = {"\u0000H\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010 \n\u0002\b\u0002\n\u0002\u0010\u000e\n\u0002\b\u0006\n\u0002\u0010\b\n\u0002\b\u0007\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0005\u0018\u00002\u00020\u0001B\u0013\u0012\n\u0010 \u001a\u0006\u0012\u0002\b\u00030\u001f¢\u0006\u0004\b\"\u0010#J#\u0010\u0006\u001a\u000e\u0012\n\u0012\b\u0012\u0004\u0012\u00020\u00020\u00050\u00042\u0006\u0010\u0003\u001a\u00020\u0002H\u0007¢\u0006\u0004\b\u0006\u0010\u0007J!\u0010\u000b\u001a\u000e\u0012\n\u0012\b\u0012\u0004\u0012\u00020\u00020\n0\u00042\u0006\u0010\t\u001a\u00020\b¢\u0006\u0004\b\u000b\u0010\fJ)\u0010\u000f\u001a\u000e\u0012\n\u0012\b\u0012\u0004\u0012\u00020\u00020\n0\u00042\u0006\u0010\u000e\u001a\u00020\r2\u0006\u0010\t\u001a\u00020\b¢\u0006\u0004\b\u000f\u0010\u0010J1\u0010\u0012\u001a\u000e\u0012\n\u0012\b\u0012\u0004\u0012\u00020\u00020\n0\u00042\u0006\u0010\u000e\u001a\u00020\r2\u0006\u0010\u0011\u001a\u00020\r2\u0006\u0010\t\u001a\u00020\b¢\u0006\u0004\b\u0012\u0010\u0013J1\u0010\u0018\u001a\u000e\u0012\n\u0012\b\u0012\u0004\u0012\u00020\u00020\n0\u00042\u0006\u0010\u0015\u001a\u00020\u00142\u0006\u0010\u0016\u001a\u00020\u00142\u0006\u0010\u0017\u001a\u00020\r¢\u0006\u0004\b\u0018\u0010\u0019J!\u0010\u001b\u001a\u000e\u0012\n\u0012\b\u0012\u0004\u0012\u00020\u00020\u00050\u00042\u0006\u0010\u001a\u001a\u00020\u0002¢\u0006\u0004\b\u001b\u0010\u0007J\u0015\u0010\u001d\u001a\b\u0012\u0004\u0012\u00020\u00020\u001cH\u0007¢\u0006\u0004\b\u001d\u0010\u001eR\u001a\u0010 \u001a\u0006\u0012\u0002\b\u00030\u001f8\u0002@\u0002X\u0082\u0004¢\u0006\u0006\n\u0004\b \u0010!¨\u0006$"}, d2 = {"Lcom/coinbase/wallet/ethereum/daos/EthereumSignedTxDao;", "", "Lcom/coinbase/wallet/ethereum/models/EthereumSignedTx;", "tx", "Lh/c/b0;", "Lcom/coinbase/wallet/core/util/Optional;", "save", "(Lcom/coinbase/wallet/ethereum/models/EthereumSignedTx;)Lh/c/b0;", "Lcom/coinbase/ciphercore/ethereum/EthereumChain;", "chain", "", "getUnminedSignedTxs", "(Lcom/coinbase/ciphercore/ethereum/EthereumChain;)Lh/c/b0;", "", "address", "getUnminedEtherTxs", "(Ljava/lang/String;Lcom/coinbase/ciphercore/ethereum/EthereumChain;)Lh/c/b0;", RouteActionKey.RouteActionKeys.CONTRACT_ADDRESS, "getUnminedERC20Txs", "(Ljava/lang/String;Ljava/lang/String;Lcom/coinbase/ciphercore/ethereum/EthereumChain;)Lh/c/b0;", "", AdjustableMinerFeeArgs.NONCE, RouteActionKey.RouteActionKeys.CHAIN_ID, "fromAddress", "getUnminedSignedTxsAfterNonce", "(IILjava/lang/String;)Lh/c/b0;", "signedTransaction", "insertSignedTransaction", "Lh/c/s;", "observeSignedTx", "()Lh/c/s;", "Lcom/coinbase/wallet/libraries/databases/db/Database;", "database", "Lcom/coinbase/wallet/libraries/databases/db/Database;", "<init>", "(Lcom/coinbase/wallet/libraries/databases/db/Database;)V", "ethereum_release"}, k = 1, mv = {1, 5, 1})
/* loaded from: classes.dex */
public final class EthereumSignedTxDao {
    private final Database<?> database;

    public EthereumSignedTxDao(Database<?> database) {
        m.g(database, "database");
        this.database = database;
    }

    public final b0<List<EthereumSignedTx>> getUnminedERC20Txs(String address, String contractAddress, EthereumChain chain) {
        m.g(address, "address");
        m.g(contractAddress, "contractAddress");
        m.g(chain, "chain");
        final Database<?> database = this.database;
        final Object[] objArr = {Integer.valueOf(TxState.PENDING.getRawValue()), Integer.valueOf(chain.getChainId()), contractAddress, address};
        final Storage<?> storage = database.getStorage();
        final DatabaseOperation databaseOperation = DatabaseOperation.READ;
        b0<List<EthereumSignedTx>> observeOn = b0.create(new f0() { // from class: com.coinbase.wallet.ethereum.daos.EthereumSignedTxDao$getUnminedERC20Txs$$inlined$fetch$1
            @Override // h.c.f0
            public final void subscribe(d0<List<? extends T>> emitter) {
                Lock readLock;
                List<? extends T> fetch;
                m.g(emitter, "emitter");
                int i2 = EthereumSignedTxDao$getUnminedERC20Txs$$inlined$fetch$1$1$wm$Storage$perform$1$WhenMappings.$EnumSwitchMapping$0[DatabaseOperation.this.ordinal()];
                boolean z = true;
                if (i2 == 1) {
                ...
                DatabaseDaoInterface<?> databaseDaoInterface = storage.getModelDaos().get(EthereumSignedTx.class);
                ...
                if (databaseDaoInterface2 == null) {
                    emitter.onError(new DatabaseException.MissingDao(EthereumSignedTx.class));
                    return;
                }
                readLock.lock();
    ...
    public final b0<List<EthereumSignedTx>> getUnminedEtherTxs(String address, EthereumChain chain) {
        m.g(address, "address");
        m.g(chain, "chain");
        final Database<?> database = this.database;
        final Object[] objArr = {Integer.valueOf(TxState.PENDING.getRawValue()), Integer.valueOf(chain.getChainId()), address};
        final Storage<?> storage = database.getStorage();
        final DatabaseOperation databaseOperation = DatabaseOperation.READ;
        b0<List<EthereumSignedTx>> observeOn = b0.create(new f0() { // from class: com.coinbase.wallet.ethereum.daos.EthereumSignedTxDao$getUnminedEtherTxs$$inlined$fetch$1
            @Override // h.c.f0
            public final void subscribe(d0<List<? extends T>> emitter) {
                Lock readLock;
                List<? extends T> fetch;
                m.g(emitter, "emitter");
                int i2 = EthereumSignedTxDao$getUnminedEtherTxs$$inlined$fetch$1$1$wm$Storage$perform$1$WhenMappings.$EnumSwitchMapping$0[DatabaseOperation.this.ordinal()];
                boolean z = true;
                if (i2 == 1) {
                    readLock = storage.getMultiReadSingleWriteLock().readLock();
                    m.f(readLock, "multiReadSingleWriteLock.readLock()");
    ...
    public final b0<List<EthereumSignedTx>> getUnminedSignedTxs(EthereumChain chain) {
        m.g(chain, "chain");
        final Database<?> database = this.database;
        final Object[] objArr = {Integer.valueOf(TxState.PENDING.getRawValue()), Integer.valueOf(chain.getChainId())};
        final Storage<?> storage = database.getStorage();
        final DatabaseOperation databaseOperation = DatabaseOperation.READ;
        b0<List<EthereumSignedTx>> observeOn = b0.create(new f0() { // from class: com.coinbase.wallet.ethereum.daos.EthereumSignedTxDao$getUnminedSignedTxs$$inlined$fetch$1
            @Override // h.c.f0
            public final void subscribe(d0<List<? extends T>> emitter) {
                Lock readLock;
                List<? extends T> fetch;
                m.g(emitter, "emitter");
                int i2 = EthereumSignedTxDao$getUnminedSignedTxs$$inlined$fetch$1$1$wm$Storage$perform$1$WhenMappings.$EnumSwitchMapping$0[DatabaseOperation.this.ordinal()];
                boolean z = true;
                if (i2 == 1) {
                    readLock = storage.getMultiReadSingleWriteLock().readLock();
                    m.f(readLock, "multiReadSingleWriteLock.readLock()");
    ...
    public final b0<List<EthereumSignedTx>> getUnminedSignedTxsAfterNonce(int i2, int i3, String fromAddress) {
        m.g(fromAddress, "fromAddress");
        final Database<?> database = this.database;
        final Object[] objArr = {Integer.valueOf(i3), fromAddress, Integer.valueOf(i2), Integer.valueOf(TxState.PENDING.getRawValue())};
        final Storage<?> storage = database.getStorage();
        final DatabaseOperation databaseOperation = DatabaseOperation.READ;
        b0<List<EthereumSignedTx>> observeOn = b0.create(new f0() { // from class: com.coinbase.wallet.ethereum.daos.EthereumSignedTxDao$getUnminedSignedTxsAfterNonce$$inlined$fetch$1
            @Override // h.c.f0
            public final void subscribe(d0<List<? extends T>> emitter) {
                Lock readLock;
                List<? extends T> fetch;
                m.g(emitter, "emitter");
                int i4 = EthereumSignedTxDao$getUnminedSignedTxsAfterNonce$$inlined$fetch$1$1$wm$Storage$perform$1$WhenMappings.$EnumSwitchMapping$0[DatabaseOperation.this.ordinal()];
                boolean z = true;
                if (i4 == 1) {
                    readLock = storage.getMultiReadSingleWriteLock().readLock();
                    m.f(readLock, "multiReadSingleWriteLock.readLock()");
    ...
    public final b0<Optional<EthereumSignedTx>> insertSignedTransaction(EthereumSignedTx signedTransaction) {
        final List b2;
        m.g(signedTransaction, "signedTransaction");
        final Database<?> database = this.database;
        b2 = q.b(signedTransaction);
        final Storage<?> storage = database.getStorage();
        final DatabaseOperation databaseOperation = DatabaseOperation.WRITE;
        b0 observeOn = b0.create(new f0() { // from class: com.coinbase.wallet.ethereum.daos.EthereumSignedTxDao$insertSignedTransaction$$inlined$add$1
            @Override // h.c.f0
            public final void subscribe(d0<Optional<? extends List<? extends T>>> emitter) {
                Lock readLock;
                m.g(emitter, "emitter");
                int i2 = EthereumSignedTxDao$insertSignedTransaction$$inlined$add$1$1$wm$Storage$perform$1$WhenMappings.$EnumSwitchMapping$0[DatabaseOperation.this.ordinal()];
                if (i2 == 1) {
                    readLock = storage.getMultiReadSingleWriteLock().readLock();
                    m.f(readLock, "multiReadSingleWriteLock.readLock()");
                } else if (i2 != 2) {
        ...
        m.f(observeOn, "@Suppress(\"UNCHECKED_CAST\")\n    inline fun <reified T, reified R> perform(\n        operation: DatabaseOperation,\n        crossinline work: (dao: DatabaseDaoInterface<T>) -> R\n    ): Single<R> = Single\n        .create<R> { emitter ->\n            val lock: Lock = when (operation) {\n                DatabaseOperation.READ -> multiReadSingleWriteLock.readLock()\n                DatabaseOperation.WRITE -> multiReadSingleWriteLock.writeLock()\n            }\n\n            val dao = modelDaos[T::class.java] as? DatabaseDaoInterface<T>\n                ?: return@create emitter.onError(DatabaseException.MissingDao(T::class.java))\n\n            lock.lock()\n\n            if (isDestroyed) {\n                lock.unlock()\n                return@create emitter.onError(DatabaseException.DatabaseDestroyed)\n            }\n\n            try {\n                val result = work(dao) as? R ?: throw IllegalArgumentException(\"Invalid result\")\n                emitter.onSuccess(result)\n            } catch (err: Throwable) {\n                emitter.onError(err)\n            } finally {\n                lock.unlock()\n            }\n        }\n        .subscribeOn(scheduler)\n        .observeOn(scheduler)");
        b0 doAfterSuccess = observeOn.doAfterSuccess(new f() { // from class: com.coinbase.wallet.ethereum.daos.EthereumSignedTxDao$insertSignedTransaction$$inlined$add$2
                    ...
                    try {
                        ...
                        if (databaseModelObject2 != null) {
                            synchronized (storage2) {
                                b<?> bVar2 = storage2.getObservers().get(EthereumSignedTx.class);
                                bVar = bVar2 instanceof b ? bVar2 : null;
                                if (bVar == null) {
                                    bVar = b.d();
                                    storage2.getObservers().put(EthereumSignedTx.class, bVar);
                                }
                            }
        ...
        b0<Optional<EthereumSignedTx>> map = doAfterSuccess.map(new n() { // from class: com.coinbase.wallet.ethereum.daos.EthereumSignedTxDao$insertSignedTransaction$$inlined$add$3
    ...
    public final s<EthereumSignedTx> observeSignedTx() {
        b<?> bVar;
        s sVar;
        ...
        try {
            if (storage.isDestroyed()) {
                ...
                synchronized (storage) {
                    b<?> bVar2 = storage.getObservers().get(EthereumSignedTx.class);
                    bVar = bVar2 instanceof b ? bVar2 : null;
                    if (bVar == null) {
                        bVar = b.d();
                        storage.getObservers().put(EthereumSignedTx.class, bVar);
                    }
                }
                sVar = bVar.hide();
            }
    ...
    public final b0<Optional<EthereumSignedTx>> save(EthereumSignedTx tx) {
        final List b2;
        m.g(tx, "tx");
        final Database<?> database = this.database;
        b2 = q.b(tx);
        final Storage<?> storage = database.getStorage();
        final DatabaseOperation databaseOperation = DatabaseOperation.WRITE;
        b0 observeOn = b0.create(new f0() { // from class: com.coinbase.wallet.ethereum.daos.EthereumSignedTxDao$save$$inlined$addOrUpdate$1
            @Override // h.c.f0
            public final void subscribe(d0<Optional<? extends List<? extends T>>> emitter) {
                Lock readLock;
                m.g(emitter, "emitter");
                int i2 = EthereumSignedTxDao$save$$inlined$addOrUpdate$1$1$wm$Storage$perform$1$WhenMappings.$EnumSwitchMapping$0[DatabaseOperation.this.ordinal()];
                if (i2 == 1) {
                    readLock = storage.getMultiReadSingleWriteLock().readLock();
                    m.f(readLock, "multiReadSingleWriteLock.readLock()");
                } else if (i2 != 2) {
        ...
        m.f(observeOn, "@Suppress(\"UNCHECKED_CAST\")\n    inline fun <reified T, reified R> perform(\n        operation: DatabaseOperation,\n        crossinline work: (dao: DatabaseDaoInterface<T>) -> R\n    ): Single<R> = Single\n        .create<R> { emitter ->\n            val lock: Lock = when (operation) {\n                DatabaseOperation.READ -> multiReadSingleWriteLock.readLock()\n                DatabaseOperation.WRITE -> multiReadSingleWriteLock.writeLock()\n            }\n\n            val dao = modelDaos[T::class.java] as? DatabaseDaoInterface<T>\n                ?: return@create emitter.onError(DatabaseException.MissingDao(T::class.java))\n\n            lock.lock()\n\n            if (isDestroyed) {\n                lock.unlock()\n                return@create emitter.onError(DatabaseException.DatabaseDestroyed)\n            }\n\n            try {\n                val result = work(dao) as? R ?: throw IllegalArgumentException(\"Invalid result\")\n                emitter.onSuccess(result)\n            } catch (err: Throwable) {\n                emitter.onError(err)\n            } finally {\n                lock.unlock()\n            }\n        }\n        .subscribeOn(scheduler)\n        .observeOn(scheduler)");
        b0 doAfterSuccess = observeOn.doAfterSuccess(new f() { // from class: com.coinbase.wallet.ethereum.daos.EthereumSignedTxDao$save$$inlined$addOrUpdate$2
            public final void accept(Optional<? extends List<? extends T>> optional) {
                b<?> bVar;
                List<DatabaseModelObject> list = b2;
                Database database2 = database;
        ...
        b0<Optional<EthereumSignedTx>> map = doAfterSuccess.map(new n() { // from class: com.coinbase.wallet.ethereum.daos.EthereumSignedTxDao$save$$inlined$addOrUpdate$3
            public final Optional<T> apply(Optional<? extends List<? extends T>> it) {
                m.g(it, "it");
                List<? extends T> value = it.getValue();
                return OptionalKt.toOptional(value == null ? null : (DatabaseModelObject) p.a0(value));
