...
final class EventProperty_ConsumerKt$SendSelected$2 extends o implements a<EventProperty> {
    public static final EventProperty_ConsumerKt$SendSelected$2 INSTANCE = new EventProperty_ConsumerKt$SendSelected$2();

    EventProperty_ConsumerKt$SendSelected$2() {
        super(0);
    }
    ...
    public final EventProperty invoke() {
        return new EventProperty("send_selected");
    }
}