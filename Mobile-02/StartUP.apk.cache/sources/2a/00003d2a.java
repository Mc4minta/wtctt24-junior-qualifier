...
final class g {
    ...
    private synchronized void b() {
        if (this.a.isEmpty()) {
            ...
            a(new int[]{HttpStatus.SC_MULTIPLE_CHOICES, 379}, "FR");
            a(new int[]{380}, "BG");
            a(new int[]{383}, "SI");
            a(new int[]{385}, "HR");
            a(new int[]{387}, "BA");
            a(new int[]{HttpStatus.SC_BAD_REQUEST, 440}, "DE");
            ...
            a(new int[]{HttpStatus.SC_INTERNAL_SERVER_ERROR, 509}, "GB");
            a(new int[]{520}, "GR");
            a(new int[]{528}, "LB");
            a(new int[]{529}, "CY");
            a(new int[]{531}, "MK");
