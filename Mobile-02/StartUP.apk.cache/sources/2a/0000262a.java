...
final class CurrencyCode_StellarKt$XLM$2 extends o implements kotlin.e0.c.a<CurrencyCode> {
    public static final CurrencyCode_StellarKt$XLM$2 INSTANCE = new CurrencyCode_StellarKt$XLM$2();

    CurrencyCode_StellarKt$XLM$2() {
        super(0);
    }
