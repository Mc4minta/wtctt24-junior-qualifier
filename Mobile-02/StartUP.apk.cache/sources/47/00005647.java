...
public final class ProtoBuf {
    ...
    public static final class Annotation extends GeneratedMessageLite implements AnnotationOrBuilder {
            ...
            public static final class Value extends GeneratedMessageLite implements ValueOrBuilder {
                ...
                public int getSerializedSize() {
                    ...
                    for (int i3 = 0; i3 < this.arrayElement_.size(); i3++) {
                        computeEnumSize += CodedOutputStream.computeMessageSize(9, this.arrayElement_.get(i3));
                    }
        ...
        public int getSerializedSize() {
            ...
            for (int i3 = 0; i3 < this.argument_.size(); i3++) {
                computeInt32Size += CodedOutputStream.computeMessageSize(2, this.argument_.get(i3));
            }
            int size = computeInt32Size + this.unknownFields.size();
            this.memoizedSerializedSize = size;
            return size;
    ...
    public static final class Class extends GeneratedMessageLite.ExtendableMessage<Class> implements ClassOrBuilder {
        ...
        public static final class Builder extends GeneratedMessageLite.ExtendableBuilder<Class, Builder> implements ClassOrBuilder {
            ...
            public Builder mergeTypeTable(TypeTable typeTable) {
                if ((this.bitField0_ & PKIFailureInfo.certRevoked) == 8192 && this.typeTable_ != TypeTable.getDefaultInstance()) {
        ...
        public void writeTo(CodedOutputStream codedOutputStream) throws IOException {
            ...
            for (int i4 = 0; i4 < this.supertype_.size(); i4++) {
                codedOutputStream.writeMessage(6, this.supertype_.get(i4));
            }
            ...
            for (int i5 = 0; i5 < this.nestedClassName_.size(); i5++) {
                codedOutputStream.writeInt32NoTag(this.nestedClassName_.get(i5).intValue());
            }
            for (int i6 = 0; i6 < this.constructor_.size(); i6++) {
                codedOutputStream.writeMessage(8, this.constructor_.get(i6));
            }
            for (int i7 = 0; i7 < this.function_.size(); i7++) {
                codedOutputStream.writeMessage(9, this.function_.get(i7));
            }
            for (int i8 = 0; i8 < this.property_.size(); i8++) {
                codedOutputStream.writeMessage(10, this.property_.get(i8));
            }
            for (int i9 = 0; i9 < this.typeAlias_.size(); i9++) {
                codedOutputStream.writeMessage(11, this.typeAlias_.get(i9));
            }
            for (int i10 = 0; i10 < this.enumEntry_.size(); i10++) {
                codedOutputStream.writeMessage(13, this.enumEntry_.get(i10));
            }
            ...
            for (int i11 = 0; i11 < this.sealedSubclassFqName_.size(); i11++) {
                codedOutputStream.writeInt32NoTag(this.sealedSubclassFqName_.get(i11).intValue());
            }
            if ((this.bitField0_ & 8) == 8) {
    ...
    public static final class Constructor extends GeneratedMessageLite.ExtendableMessage<Constructor> implements ConstructorOrBuilder {
        ...
        public int getSerializedSize() {
            ...
            for (int i3 = 0; i3 < this.valueParameter_.size(); i3++) {
                computeInt32Size += CodedOutputStream.computeMessageSize(2, this.valueParameter_.get(i3));
            }
            int i4 = 0;
    ...
    public static final class Contract extends GeneratedMessageLite implements ContractOrBuilder {
        ...
        public int getSerializedSize() {
            ...
            for (int i4 = 0; i4 < this.effect_.size(); i4++) {
                i3 += CodedOutputStream.computeMessageSize(1, this.effect_.get(i4));
            }
    ...
    public static final class Expression extends GeneratedMessageLite implements ExpressionOrBuilder {
        ...
        public int getSerializedSize() {
            ...
            for (int i3 = 0; i3 < this.andArgument_.size(); i3++) {
                computeInt32Size += CodedOutputStream.computeMessageSize(6, this.andArgument_.get(i3));
            }
            for (int i4 = 0; i4 < this.orArgument_.size(); i4++) {
                computeInt32Size += CodedOutputStream.computeMessageSize(7, this.orArgument_.get(i4));
            }
            int size = computeInt32Size + this.unknownFields.size();
            this.memoizedSerializedSize = size;
            return size;
    ...
    public static final class Function extends GeneratedMessageLite.ExtendableMessage<Function> implements FunctionOrBuilder {
        ...
        public static final class Builder extends GeneratedMessageLite.ExtendableBuilder<Function, Builder> implements FunctionOrBuilder {
            ...
            public Builder mergeContract(Contract contract) {
                if ((this.bitField0_ & PKIFailureInfo.wrongIntegrity) == 2048 && this.contract_ != Contract.getDefaultInstance()) {
    ...
    public static final class PackageFragment extends GeneratedMessageLite.ExtendableMessage<PackageFragment> implements PackageFragmentOrBuilder {
        ...
        public int getSerializedSize() {
            ...
            for (int i3 = 0; i3 < this.class__.size(); i3++) {
                computeMessageSize += CodedOutputStream.computeMessageSize(4, this.class__.get(i3));
            }
    ...
    public static final class QualifiedNameTable extends GeneratedMessageLite implements QualifiedNameTableOrBuilder {
        ...
        public int getSerializedSize() {
            ...
            for (int i4 = 0; i4 < this.qualifiedName_.size(); i4++) {
                i3 += CodedOutputStream.computeMessageSize(1, this.qualifiedName_.get(i4));
            }
            int size = i3 + this.unknownFields.size();
            this.memoizedSerializedSize = size;
            return size;
    ...
    public static final class StringTable extends GeneratedMessageLite implements StringTableOrBuilder {
        ...
        public int getSerializedSize() {
            ...
            for (int i4 = 0; i4 < this.string_.size(); i4++) {
                i3 += CodedOutputStream.computeBytesSizeNoTag(this.string_.getByteString(i4));
            }
    ...
    public static final class Type extends GeneratedMessageLite.ExtendableMessage<Type> implements TypeOrBuilder {
        ...
        public static final class Builder extends GeneratedMessageLite.ExtendableBuilder<Type, Builder> implements TypeOrBuilder {
            ...
            public Builder mergeAbbreviatedType(Type type) {
                if ((this.bitField0_ & PKIFailureInfo.wrongIntegrity) == 2048 && this.abbreviatedType_ != Type.getDefaultInstance()) {
    ...
    public static final class TypeAlias extends GeneratedMessageLite.ExtendableMessage<TypeAlias> implements TypeAliasOrBuilder {
        ...
        public int getSerializedSize() {
            ...
            for (int i3 = 0; i3 < this.typeParameter_.size(); i3++) {
                computeInt32Size += CodedOutputStream.computeMessageSize(3, this.typeParameter_.get(i3));
            }
            if ((this.bitField0_ & 4) == 4) {
            ...
            for (int i4 = 0; i4 < this.annotation_.size(); i4++) {
                computeInt32Size += CodedOutputStream.computeMessageSize(8, this.annotation_.get(i4));
            }
            int i5 = 0;
            for (int i6 = 0; i6 < this.versionRequirement_.size(); i6++) {
                i5 += CodedOutputStream.computeInt32SizeNoTag(this.versionRequirement_.get(i6).intValue());
            }
            int size = computeInt32Size + i5 + (getVersionRequirementList().size() * 2) + extensionsSerializedSize() + this.unknownFields.size();
            this.memoizedSerializedSize = size;
            return size;
        }
    ...
    public static final class TypeParameter extends GeneratedMessageLite.ExtendableMessage<TypeParameter> implements TypeParameterOrBuilder {
        ...
        public void writeTo(CodedOutputStream codedOutputStream) throws IOException {
            ...
            newExtensionWriter.writeUntil(RNCWebViewManager.COMMAND_CLEAR_FORM_DATA, codedOutputStream);
            codedOutputStream.writeRawBytes(this.unknownFields);
        }
    ...
    public static final class TypeTable extends GeneratedMessageLite implements TypeTableOrBuilder {
        ...
        public int getSerializedSize() {
            ...
            for (int i4 = 0; i4 < this.type_.size(); i4++) {
                i3 += CodedOutputStream.computeMessageSize(1, this.type_.get(i4));
            }
            if ((this.bitField0_ & 1) == 1) {
                i3 += CodedOutputStream.computeInt32Size(2, this.firstNullable_);
            }
            int size = i3 + this.unknownFields.size();
            this.memoizedSerializedSize = size;
            return size;
    ...
    public static final class VersionRequirementTable extends GeneratedMessageLite implements VersionRequirementTableOrBuilder {
        ...
        public int getSerializedSize() {
            ...
            for (int i4 = 0; i4 < this.requirement_.size(); i4++) {
                i3 += CodedOutputStream.computeMessageSize(1, this.requirement_.get(i4));
            }
            int size = i3 + this.unknownFields.size();
            this.memoizedSerializedSize = size;
            return size;
