...
final class TxMetadataKey_EthereumKt$txSource$2 extends o implements kotlin.e0.c.a<TxMetadataKey> {
    public static final TxMetadataKey_EthereumKt$txSource$2 INSTANCE = new TxMetadataKey_EthereumKt$txSource$2();

    TxMetadataKey_EthereumKt$txSource$2() {
        super(0);
    }
    ...
    public final TxMetadataKey invoke() {
        return TxMetadataKey.Companion.create("txSource", String.class);
    }
}