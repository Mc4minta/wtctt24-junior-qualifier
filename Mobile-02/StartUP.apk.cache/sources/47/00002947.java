...
public final class WalletsRepositoriesModule_Companion_ProvidesBTCWalletRepositoryFactory implements d<WalletManaging> {
    ...
    public WalletsRepositoriesModule_Companion_ProvidesBTCWalletRepositoryFactory(Provider<AddressDao> provider, Provider<WalletDao> provider2, Provider<StoreInterface> provider3, Provider<CipherCoreInterface> provider4, Provider<BTCService> provider5, Provider<Tracing> provider6, Provider<BatchBalanceAPI> provider7) {
    ...
    public static WalletsRepositoriesModule_Companion_ProvidesBTCWalletRepositoryFactory create(Provider<AddressDao> provider, Provider<WalletDao> provider2, Provider<StoreInterface> provider3, Provider<CipherCoreInterface> provider4, Provider<BTCService> provider5, Provider<Tracing> provider6, Provider<BatchBalanceAPI> provider7) {
        return new WalletsRepositoriesModule_Companion_ProvidesBTCWalletRepositoryFactory(provider, provider2, provider3, provider4, provider5, provider6, provider7);
    }
    ...
    public static WalletManaging providesBTCWalletRepository(AddressDao addressDao, WalletDao walletDao, StoreInterface storeInterface, CipherCoreInterface cipherCoreInterface, BTCService bTCService, Tracing tracing, BatchBalanceAPI batchBalanceAPI) {
        return (WalletManaging) h.f(WalletsRepositoriesModule.Companion.providesBTCWalletRepository(addressDao, walletDao, storeInterface, cipherCoreInterface, bTCService, tracing, batchBalanceAPI));
    }
