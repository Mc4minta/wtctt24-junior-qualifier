...
public final class EthereumModule_Companion_ProvidesETHWalletRepository$ethereum_releaseFactory implements d<IETHWalletRepository> {
    ...
    public EthereumModule_Companion_ProvidesETHWalletRepository$ethereum_releaseFactory(Provider<AddressDao> provider, Provider<WalletDao> provider2, Provider<ERC20Dao> provider3, Provider<ERC20TokenAPI> provider4, Provider<StoreInterface> provider5, Provider<CipherCoreInterface> provider6, Provider<EthereumSignedTxDao> provider7) {
    ...
    public static EthereumModule_Companion_ProvidesETHWalletRepository$ethereum_releaseFactory create(Provider<AddressDao> provider, Provider<WalletDao> provider2, Provider<ERC20Dao> provider3, Provider<ERC20TokenAPI> provider4, Provider<StoreInterface> provider5, Provider<CipherCoreInterface> provider6, Provider<EthereumSignedTxDao> provider7) {
        return new EthereumModule_Companion_ProvidesETHWalletRepository$ethereum_releaseFactory(provider, provider2, provider3, provider4, provider5, provider6, provider7);
    }
    ...
    public static IETHWalletRepository providesETHWalletRepository$ethereum_release(AddressDao addressDao, WalletDao walletDao, ERC20Dao eRC20Dao, ERC20TokenAPI eRC20TokenAPI, StoreInterface storeInterface, CipherCoreInterface cipherCoreInterface, EthereumSignedTxDao ethereumSignedTxDao) {
        return (IETHWalletRepository) h.f(EthereumModule.Companion.providesETHWalletRepository$ethereum_release(addressDao, walletDao, eRC20Dao, eRC20TokenAPI, storeInterface, cipherCoreInterface, ethereumSignedTxDao));
    }
