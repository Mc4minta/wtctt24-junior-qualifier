...
public class DefaultClientConnection extends SocketHttpClientConnection implements OperatedClientConnection, ManagedHttpClientConnection, HttpContext {
    ...
    private final a headerLog = h.o("org.apache.http.headers");
    private final a wireLog = h.o("org.apache.http.wire");
    ...
    public SessionInputBuffer createSessionInputBuffer(Socket socket, int i2, HttpParams httpParams) throws IOException {
        ...
        return this.wireLog.d() ? new LoggingSessionInputBuffer(createSessionInputBuffer, new Wire(this.wireLog), HttpProtocolParams.getHttpElementCharset(httpParams)) : createSessionInputBuffer;
    }
    ...
    public SessionOutputBuffer createSessionOutputBuffer(Socket socket, int i2, HttpParams httpParams) throws IOException {
        ...
        return this.wireLog.d() ? new LoggingSessionOutputBuffer(createSessionOutputBuffer, new Wire(this.wireLog), HttpProtocolParams.getHttpElementCharset(httpParams)) : createSessionOutputBuffer;
    }
    ...
    public HttpResponse receiveResponseHeader() throws HttpException, IOException {
        ...
        if (this.log.d()) {
            this.log.a("Receiving response: " + receiveResponseHeader.getStatusLine());
        }
        if (this.headerLog.d()) {
            this.headerLog.a("<< " + receiveResponseHeader.getStatusLine().toString());
            for (Header header : receiveResponseHeader.getAllHeaders()) {
                this.headerLog.a("<< " + header.toString());
            }
        }
    ...
    public void sendRequestHeader(HttpRequest httpRequest) throws HttpException, IOException {
        Header[] allHeaders;
        if (this.log.d()) {
            this.log.a("Sending request: " + httpRequest.getRequestLine());
        }
        super.sendRequestHeader(httpRequest);
        if (this.headerLog.d()) {
            this.headerLog.a(">> " + httpRequest.getRequestLine().toString());
    ...
    public void shutdown() throws IOException {
        ...
        try {
            ...
            if (this.log.d()) {
                a aVar = this.log;
                aVar.a("Connection " + this + " shut down");
            }
            ...
            this.log.b("I/O error shutting down connection", e2);
        }
    }
