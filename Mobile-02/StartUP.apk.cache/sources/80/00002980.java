...
final class CurrencyCode_WalletsKt$CWBTC$2 extends o implements a<CurrencyCode> {
    public static final CurrencyCode_WalletsKt$CWBTC$2 INSTANCE = new CurrencyCode_WalletsKt$CWBTC$2();

    CurrencyCode_WalletsKt$CWBTC$2() {
        super(0);
    }
