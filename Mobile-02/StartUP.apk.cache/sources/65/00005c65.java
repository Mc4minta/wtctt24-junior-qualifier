            ...
            try {
                for (Cookie cookie : cookieSpec.parse(nextHeader, cookieOrigin)) {
                    try {
                        ...
                        if (this.log.d()) {
                            a aVar = this.log;
                            aVar.a("Cookie accepted [" + formatCooke(cookie) + "]");
                        }
                    } catch (MalformedCookieException e2) {
                        if (this.log.c()) {
                            a aVar2 = this.log;
                            aVar2.j("Cookie rejected [" + formatCooke(cookie) + "] " + e2.getMessage());
                        }
                    }
                }
                ...
                if (this.log.c()) {
                    a aVar3 = this.log;
                    aVar3.j("Invalid cookie header: \"" + nextHeader + "\". " + e3.getMessage());
                }
            }
        }
    }
