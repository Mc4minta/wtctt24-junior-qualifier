...
public class JavaClassConstructorDescriptor extends ClassConstructorDescriptorImpl implements JavaCallableMemberDescriptor {
    ...
    public /* bridge */ /* synthetic */ JavaCallableMemberDescriptor enhance(KotlinType kotlinType, List list, KotlinType kotlinType2, o oVar) {
        return enhance(kotlinType, (List<ValueParameterData>) list, kotlinType2, (o<CallableDescriptor.UserDataKey<?>, ?>) oVar);
    }
    ...
    @Override // kotlin.reflect.jvm.internal.impl.load.java.descriptors.JavaCallableMemberDescriptor
    public JavaClassConstructorDescriptor enhance(KotlinType kotlinType, List<ValueParameterData> list, KotlinType kotlinType2, o<CallableDescriptor.UserDataKey<?>, ?> oVar) {
        if (list == null) {
            $$$reportNull$$$0(16);
        }
        if (kotlinType2 == null) {
        ...
        if (oVar != null) {
            createSubstitutedCopy.putInUserDataMap(oVar.c(), oVar.d());
        }
