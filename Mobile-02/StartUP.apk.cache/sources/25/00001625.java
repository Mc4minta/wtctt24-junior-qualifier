...
final class EventProperty_ConsumerKt$PaymentMethodType$2 extends o implements a<EventProperty> {
    public static final EventProperty_ConsumerKt$PaymentMethodType$2 INSTANCE = new EventProperty_ConsumerKt$PaymentMethodType$2();

    EventProperty_ConsumerKt$PaymentMethodType$2() {
        super(0);
    }
    ...
    public final EventProperty invoke() {
        return new EventProperty(ConsumerAddCardArgs.PAYMENT_METHOD_TYPE);
    }
}