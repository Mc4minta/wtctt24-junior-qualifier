...
final class AddressKind_StellarKt$Stellar$2 extends o implements kotlin.e0.c.a<AddressType> {
    public static final AddressKind_StellarKt$Stellar$2 INSTANCE = new AddressKind_StellarKt$Stellar$2();

    AddressKind_StellarKt$Stellar$2() {
        super(0);
    }
    ...
    public final AddressType invoke() {
        return new AddressType("Stellar");
    }
}