...
final class AddressKind_EthereumKt$EthereumClassic$2 extends o implements kotlin.e0.c.a<AddressType> {
    public static final AddressKind_EthereumKt$EthereumClassic$2 INSTANCE = new AddressKind_EthereumKt$EthereumClassic$2();

    AddressKind_EthereumKt$EthereumClassic$2() {
        super(0);
    }
    ...
    public final AddressType invoke() {
        return new AddressType("EthereumClassic");
    }
}