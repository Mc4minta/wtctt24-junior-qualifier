...
@Metadata(bv = {1, 0, 3}, d1 = {"\u0000D\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0010\u000e\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0010\u0012\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\u0018\u00002\b\u0012\u0004\u0012\u00020\u00020\u0001B\u000f\u0012\u0006\u0010\u0018\u001a\u00020\u0017¢\u0006\u0004\b\u0019\u0010\u001aJ\u000f\u0010\u0004\u001a\u00020\u0003H\u0016¢\u0006\u0004\b\u0004\u0010\u0005J\u0017\u0010\b\u001a\u00020\u00022\u0006\u0010\u0007\u001a\u00020\u0006H\u0016¢\u0006\u0004\b\b\u0010\tJ!\u0010\u000e\u001a\u00020\r2\u0006\u0010\u000b\u001a\u00020\n2\b\u0010\f\u001a\u0004\u0018\u00010\u0002H\u0016¢\u0006\u0004\b\u000e\u0010\u000fR\u001c\u0010\u0011\u001a\b\u0012\u0004\u0012\u00020\u00100\u00018\u0002@\u0002X\u0082\u0004¢\u0006\u0006\n\u0004\b\u0011\u0010\u0012R\u001c\u0010\u0013\u001a\b\u0012\u0004\u0012\u00020\u00030\u00018\u0002@\u0002X\u0082\u0004¢\u0006\u0006\n\u0004\b\u0013\u0010\u0012R\u0016\u0010\u0015\u001a\u00020\u00148\u0002@\u0002X\u0082\u0004¢\u0006\u0006\n\u0004\b\u0015\u0010\u0016¨\u0006\u001b"}, d2 = {"Lcom/coinbase/walletengine/services/example/MetaDataJsonAdapter;", "Lcom/squareup/moshi/JsonAdapter;", "Lcom/coinbase/walletengine/services/example/MetaData;", "", "toString", "()Ljava/lang/String;", "Lcom/squareup/moshi/JsonReader;", "reader", "fromJson", "(Lcom/squareup/moshi/JsonReader;)Lcom/coinbase/walletengine/services/example/MetaData;", "Lcom/squareup/moshi/JsonWriter;", "writer", "value_", "Lkotlin/x;", "toJson", "(Lcom/squareup/moshi/JsonWriter;Lcom/coinbase/walletengine/services/example/MetaData;)V", "", "byteArrayAdapter", "Lcom/squareup/moshi/JsonAdapter;", "stringAdapter", "Lcom/squareup/moshi/JsonReader$Options;", "options", "Lcom/squareup/moshi/JsonReader$Options;", "Lcom/squareup/moshi/Moshi;", "moshi", "<init>", "(Lcom/squareup/moshi/Moshi;)V", "wallet-engine_release"}, k = 1, mv = {1, 5, 1})
...
public final class MetaDataJsonAdapter extends JsonAdapter<MetaData> {
    ...
    public MetaDataJsonAdapter(Moshi moshi) {
        ...
        kotlin.jvm.internal.m.f(of, "of(\"type\", \"data\")");
        this.options = of;
        b2 = s0.b();
        ...
        kotlin.jvm.internal.m.f(adapter2, "moshi.adapter(ByteArray::class.java,\n      emptySet(), \"data\")");
    ...
    public MetaData fromJson(JsonReader reader) {
        ...
        while (reader.hasNext()) {
            ...
            if (selectName == -1) {
                ...
                if (str == null) {
                    ...
                    kotlin.jvm.internal.m.f(unexpectedNull, "unexpectedNull(\"type\", \"type\",\n            reader)");
        ...
        if (str == null) {
            ...
            kotlin.jvm.internal.m.f(missingProperty, "missingProperty(\"type\", \"type\", reader)");
            throw missingProperty;
        } else if (bArr != null) {
            return new MetaData(str, bArr);
        } else {
    ...
    @Override // com.squareup.moshi.JsonAdapter
    public void toJson(JsonWriter writer, MetaData metaData) {
        kotlin.jvm.internal.m.g(writer, "writer");
        Objects.requireNonNull(metaData, "value_ was null! Wrap in .nullSafe() to write nullable values.");
        writer.beginObject();
        writer.name("type");
        this.stringAdapter.toJson(writer, (JsonWriter) metaData.getType());
        writer.name("data");
        this.byteArrayAdapter.toJson(writer, (JsonWriter) metaData.getData());
        writer.endObject();
    }
}