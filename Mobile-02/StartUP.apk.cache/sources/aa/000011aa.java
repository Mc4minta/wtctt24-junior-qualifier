...
final class EventProperty_ApplicationKt$SendAmount$2 extends o implements a<EventProperty> {
    public static final EventProperty_ApplicationKt$SendAmount$2 INSTANCE = new EventProperty_ApplicationKt$SendAmount$2();

    EventProperty_ApplicationKt$SendAmount$2() {
        super(0);
    }
    ...
    public final EventProperty invoke() {
        return new EventProperty("send_amount");
    }
}