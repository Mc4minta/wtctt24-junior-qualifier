...
final class EventProperty_ApplicationKt$SwapToAsset$2 extends o implements a<EventProperty> {
    public static final EventProperty_ApplicationKt$SwapToAsset$2 INSTANCE = new EventProperty_ApplicationKt$SwapToAsset$2();

    EventProperty_ApplicationKt$SwapToAsset$2() {
        super(0);
    }
    ...
    public final EventProperty invoke() {
        return new EventProperty("to_asset");
    }
}