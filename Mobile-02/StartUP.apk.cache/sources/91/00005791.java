...
public class DescriptorUtils {
    ...
    public static ClassDescriptor getClassDescriptorForTypeConstructor(TypeConstructor typeConstructor) {
        ...
        ClassDescriptor classDescriptor = (ClassDescriptor) typeConstructor.mo2214getDeclarationDescriptor();
    ...
    public static ModuleDescriptor getContainingModuleOrNull(KotlinType kotlinType) {
        ...
        return getContainingModuleOrNull(mo2214getDeclarationDescriptor);
    }
    ...
    public static ClassDescriptor getSuperClassDescriptor(ClassDescriptor classDescriptor) {
        ...
        for (KotlinType kotlinType : classDescriptor.getTypeConstructor().mo2215getSupertypes()) {
    ...
    private static boolean isSameClass(KotlinType kotlinType, DeclarationDescriptor declarationDescriptor) {
        ...
        ClassifierDescriptor mo2214getDeclarationDescriptor = kotlinType.getConstructor().mo2214getDeclarationDescriptor();
        if (mo2214getDeclarationDescriptor != null) {
            DeclarationDescriptor original = mo2214getDeclarationDescriptor.getOriginal();
    ...
    public static boolean isSubtypeOfClass(KotlinType kotlinType, DeclarationDescriptor declarationDescriptor) {
        ...
        for (KotlinType kotlinType2 : kotlinType.getConstructor().mo2215getSupertypes()) {
