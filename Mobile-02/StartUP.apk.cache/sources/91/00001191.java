...
final class EventProperty_ApplicationKt$ChainId$2 extends o implements a<EventProperty> {
    public static final EventProperty_ApplicationKt$ChainId$2 INSTANCE = new EventProperty_ApplicationKt$ChainId$2();

    EventProperty_ApplicationKt$ChainId$2() {
        super(0);
    }
    ...
    public final EventProperty invoke() {
        return new EventProperty("chain_id");
    }
}