...
public final class b {
    ...
    public b a(b bVar) {
        if (this.a.equals(bVar.a)) {
            ...
            int[] iArr = this.f9810b;
            int[] iArr2 = bVar.f9810b;
    ...
    public int c(int i2) {
        ...
        for (int i6 = 1; i6 < length; i6++) {
            i5 = a.a(this.a.j(i2, i5), this.f9810b[i6]);
        }
        return i5;
    }
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public int f() {
        return this.f9810b.length - 1;
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    public boolean g() {
        return this.f9810b[0] == 0;
    }
    ...
    public b h(int i2) {
        ...
        int length = this.f9810b.length;
        int[] iArr = new int[length];
        for (int i3 = 0; i3 < length; i3++) {
            iArr[i3] = this.a.j(this.f9810b[i3], i2);
        }
    ...
    public b j(int i2, int i3) {
        if (i2 >= 0) {
            ...
            for (int i4 = 0; i4 < length; i4++) {
                iArr[i4] = this.a.j(this.f9810b[i4], i3);
            }
            return new b(this.a, iArr);
        }
        throw new IllegalArgumentException();
