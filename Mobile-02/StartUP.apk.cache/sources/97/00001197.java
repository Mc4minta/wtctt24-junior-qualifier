...
final class EventProperty_ApplicationKt$DappName$2 extends o implements a<EventProperty> {
    public static final EventProperty_ApplicationKt$DappName$2 INSTANCE = new EventProperty_ApplicationKt$DappName$2();

    EventProperty_ApplicationKt$DappName$2() {
        super(0);
    }
    ...
    public final EventProperty invoke() {
        return new EventProperty("dapp_name");
    }
}