...
public class X9ECParameters extends ASN1Object implements X9ObjectIdentifiers {
    ...
    private X9ECPoint f17781g;

    /* renamed from: h  reason: collision with root package name */
    private BigInteger f17782h;
    ...
    private X9ECParameters(ASN1Sequence aSN1Sequence) {
        if ((aSN1Sequence.getObjectAt(0) instanceof ASN1Integer) && ((ASN1Integer) aSN1Sequence.getObjectAt(0)).getValue().equals(ONE)) {
            ...
            if (objectAt instanceof X9ECPoint) {
                this.f17781g = (X9ECPoint) objectAt;
            } else {
                this.f17781g = new X9ECPoint(this.curve, (ASN1OctetString) objectAt);
            }
            this.n = ((ASN1Integer) aSN1Sequence.getObjectAt(4)).getValue();
            this.seed = x9Curve.getSeed();
            if (aSN1Sequence.size() == 6) {
                this.f17782h = ((ASN1Integer) aSN1Sequence.getObjectAt(5)).getValue();
                return;
            }
            return;
        }
    ...
    public ASN1Primitive toASN1Primitive() {
        ...
        aSN1EncodableVector.add(this.f17781g);
        aSN1EncodableVector.add(new ASN1Integer(this.n));
        BigInteger bigInteger = this.f17782h;
        if (bigInteger != null) {
    ...
    public X9ECParameters(ECCurve eCCurve, X9ECPoint x9ECPoint, BigInteger bigInteger, BigInteger bigInteger2, byte[] bArr) {
        this.curve = eCCurve;
        this.f17781g = x9ECPoint;
        this.n = bigInteger;
        this.f17782h = bigInteger2;
        this.seed = bArr;
