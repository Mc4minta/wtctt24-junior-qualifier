        ...
        if (scaleFactor > 0.0f) {
            ...
            if (sampleSizeRounding != null) {
                ...
                if (Log.isLoggable(TAG, 2)) {
                    Log.v(TAG, "Calculate scaling, source: [" + i3 + "x" + i4 + "], target: [" + i5 + "x" + i6 + "], power of two scaled: [" + floor + "x" + i9 + "], exact scale factor: " + scaleFactor + ", power of 2 sample size: " + i7 + ", adjusted scale factor: " + scaleFactor2 + ", target density: " + options.inTargetDensity + ", density: " + options.inDensity);
                    return;
                }
                return;
            }
