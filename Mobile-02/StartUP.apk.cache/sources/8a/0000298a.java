...
final class EventProperty_WalletsKt$WasMax$2 extends o implements a<EventProperty> {
    public static final EventProperty_WalletsKt$WasMax$2 INSTANCE = new EventProperty_WalletsKt$WasMax$2();

    EventProperty_WalletsKt$WasMax$2() {
        super(0);
    }
    ...
    public final EventProperty invoke() {
        return new EventProperty("was_max");
    }
}