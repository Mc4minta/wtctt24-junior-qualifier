...
final class LendDashboardFragment$onViewCreated$11 extends o implements l<View, x> {
    final /* synthetic */ LendDashboardFragment this$0;

    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public LendDashboardFragment$onViewCreated$11(LendDashboardFragment lendDashboardFragment) {
        super(1);
    ...
    public final void invoke2(View it) {
        ...
        if (lendDashboardViewModel != null) {
            lendDashboardViewModel.proceedToSupply();
