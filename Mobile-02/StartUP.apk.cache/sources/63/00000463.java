...
public class ViewPager extends ViewGroup {
    ...
    static class a implements Comparator<f> {
        ...
        public int compare(f fVar, f fVar2) {
            return fVar.f2376b - fVar2.f2376b;
        }
    }
    ...
    public class d implements q {
        ...
        public d0 a(View view, d0 d0Var) {
            ...
            for (int i2 = 0; i2 < childCount; i2++) {
                d0 g2 = v.g(ViewPager.this.getChildAt(i2), Z);
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    /* loaded from: classes.dex */
    public class h extends c.h.k.a {
        h() {
        }
        ...
        public void g(View view, c.h.k.e0.d dVar) {
            super.g(view, dVar);
            dVar.T(ViewPager.class.getName());
            dVar.m0(n());
    ...
    public static class m extends c.j.a.a {
        ...
        public String toString() {
            return "FragmentPager.SavedState{" + Integer.toHexString(System.identityHashCode(this)) + " position=" + this.f2386c + "}";
        }
        ...
        public void writeToParcel(Parcel parcel, int i2) {
            ...
            parcel.writeParcelable(this.f2387d, i2);
        }
        ...
        m(Parcel parcel, ClassLoader classLoader) {
            ...
            this.f2387d = parcel.readParcelable(classLoader);
            this.f2388e = classLoader;
        }
    }
    ...
    public static class o implements Comparator<View> {
        ...
        public int compare(View view, View view2) {
            ...
            return gVar.f2383e - gVar2.f2383e;
        }
    }
    ...
    private void calculatePageOffsets(f fVar, int i2, f fVar2) {
        ...
        if (fVar2 != null) {
            ...
            int i6 = fVar.f2376b;
            if (i5 < i6) {
                float f3 = fVar2.f2379e + fVar2.f2378d + f2;
                int i7 = i5 + 1;
                int i8 = 0;
                while (i7 <= fVar.f2376b && i8 < this.mItems.size()) {
                    f fVar5 = this.mItems.get(i8);
                    while (true) {
                        fVar4 = fVar5;
                        if (i7 <= fVar4.f2376b || i8 >= this.mItems.size() - 1) {
                            break;
                        }
                        i8++;
                        fVar5 = this.mItems.get(i8);
                    }
                    while (i7 < fVar4.f2376b) {
                ...
                float f4 = fVar2.f2379e;
                while (true) {
                    i5--;
                    if (i5 < fVar.f2376b || size < 0) {
                        break;
                    }
                    f fVar6 = this.mItems.get(size);
                    while (true) {
                        fVar3 = fVar6;
                        if (i5 >= fVar3.f2376b || size <= 0) {
                            break;
                        }
                        size--;
                        fVar6 = this.mItems.get(size);
                    }
                    while (i5 > fVar3.f2376b) {
        ...
        float f5 = fVar.f2379e;
        int i9 = fVar.f2376b;
        int i10 = i9 - 1;
        this.mFirstOffset = i9 == 0 ? f5 : -3.4028235E38f;
        int i11 = count - 1;
        this.mLastOffset = i9 == i11 ? (fVar.f2378d + f5) - 1.0f : Float.MAX_VALUE;
        int i12 = i2 - 1;
        while (i12 >= 0) {
        ...
        float f6 = fVar.f2379e + fVar.f2378d + f2;
        int i13 = fVar.f2376b + 1;
        int i14 = i2 + 1;
        while (i14 < size2) {
            ...
            if (i3 == i11) {
                this.mLastOffset = (fVar8.f2378d + f6) - 1.0f;
            }
            fVar8.f2379e = f6;
            f6 += fVar8.f2378d + f2;
            i14++;
    ...
    private void completeScroll(boolean z) {
        ...
        if (z2) {
            if (z) {
                v.c0(this, this.mEndScrollRunnable);
            } else {
    ...
    private int determineTargetPage(int i2, float f2, int i3, int i4) {
        ...
        if (this.mItems.size() > 0) {
            ...
            return Math.max(this.mItems.get(0).f2376b, Math.min(i2, arrayList.get(arrayList.size() - 1).f2376b));
        }
        return i2;
    }
    ...
    private f infoForCurrentScrollPosition() {
        ...
        while (i3 < this.mItems.size()) {
            ...
            if (!z && fVar2.f2376b != (i2 = i4 + 1)) {
                fVar2 = this.mTempItem;
                fVar2.f2379e = f2 + f4 + f3;
                fVar2.f2376b = i2;
                fVar2.f2378d = this.mAdapter.getPageWidth(i2);
                i3--;
            }
            f2 = fVar2.f2379e;
            float f5 = fVar2.f2378d + f2 + f3;
            if (!z && scrollX < f2) {
                return fVar;
            }
    ...
    private boolean pageScrolled(int i2) {
        ...
        int i5 = infoForCurrentScrollPosition.f2376b;
        float f3 = ((i2 / f2) - infoForCurrentScrollPosition.f2379e) / (infoForCurrentScrollPosition.f2378d + (i3 / f2));
        this.mCalledSuper = false;
    ...
    private boolean performDrag(float f2) {
        ...
        if (fVar.f2376b != 0) {
            f4 = fVar.f2379e * clientWidth;
            z = false;
        } else {
            z = true;
        }
        if (fVar2.f2376b != this.mAdapter.getCount() - 1) {
            f5 = fVar2.f2379e * clientWidth;
            z2 = false;
        } else {
            z2 = true;
        }
    ...
    private void recomputeScrollPosition(int i2, int i3, int i4, int i5) {
        ...
        int min = (int) ((infoForPosition != null ? Math.min(infoForPosition.f2379e, this.mLastOffset) : 0.0f) * ((i2 - getPaddingLeft()) - getPaddingRight()));
        if (min != getScrollX()) {
    ...
    private void scrollToItem(int i2, boolean z, int i3, boolean z2) {
        ...
        int clientWidth = infoForPosition != null ? (int) (getClientWidth() * Math.max(this.mFirstOffset, Math.min(infoForPosition.f2379e, this.mLastOffset))) : 0;
        if (z) {
    ...
    public void addFocusables(ArrayList<View> arrayList, int i2, int i3) {
        ...
        if (descendantFocusability != 393216) {
            for (int i4 = 0; i4 < getChildCount(); i4++) {
                ...
                if (childAt.getVisibility() == 0 && (infoForChild = infoForChild(childAt)) != null && infoForChild.f2376b == this.mCurItem) {
    ...
    f addNewItem(int i2, int i3) {
        ...
        fVar.f2378d = this.mAdapter.getPageWidth(i2);
    ...
    */
        ...
        while (i3 < this.mItems.size()) {
            ...
            if (itemPosition != -1) {
                if (itemPosition == -2) {
                    ...
                    this.mAdapter.destroyItem((ViewGroup) this, fVar.f2376b, fVar.a);
    ...
    public boolean dispatchPopulateAccessibilityEvent(AccessibilityEvent accessibilityEvent) {
        ...
        for (int i2 = 0; i2 < childCount; i2++) {
            View childAt = getChildAt(i2);
            if (childAt.getVisibility() == 0 && (infoForChild = infoForChild(childAt)) != null && infoForChild.f2376b == this.mCurItem && childAt.dispatchPopulateAccessibilityEvent(accessibilityEvent)) {
                return true;
            }
        }
        return false;
    ...
    public void endFakeDrag() {
        if (this.mFakeDragging) {
            if (this.mAdapter != null) {
                ...
                int scrollX = getScrollX();
                f infoForCurrentScrollPosition = infoForCurrentScrollPosition();
                setCurrentItemInternal(determineTargetPage(infoForCurrentScrollPosition.f2376b, ((scrollX / clientWidth) - infoForCurrentScrollPosition.f2379e) / infoForCurrentScrollPosition.f2378d, xVelocity, (int) (this.mLastMotionX - this.mInitialMotionX)), true, true, xVelocity);
            }
            endDrag();
    ...
    public void fakeDragBy(float f2) {
        ...
        if (this.mFakeDragging) {
            ...
            if (fVar.f2376b != 0) {
                f3 = fVar.f2379e * clientWidth;
            }
            if (fVar2.f2376b != this.mAdapter.getCount() - 1) {
                f4 = fVar2.f2379e * clientWidth;
            }
            if (scrollX < f3) {
                scrollX = f3;
            } else if (scrollX > f4) {
    ...
    protected int getChildDrawingOrder(int i2, int i3) {
        ...
        return ((g) this.mDrawingOrderedChildren.get(i3).getLayoutParams()).f2384f;
    }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        int i4 = fVar.f2376b;
        int i5 = this.mItems.get(size - 1).f2376b;
        while (i4 < i5) {
            while (true) {
                i2 = fVar.f2376b;
                if (i4 <= i2 || i3 >= size) {
            ...
            if (i4 == i2) {
                float f6 = fVar.f2379e;
                float f7 = fVar.f2378d;
                f2 = (f6 + f7) * width2;
                f5 = f6 + f7 + f4;
            } else {
    ...
    protected void onMeasure(int i2, int i3) {
        ...
        for (int i13 = 0; i13 < childCount2; i13++) {
            ...
            if (childAt2.getVisibility() != 8 && ((gVar = (g) childAt2.getLayoutParams()) == null || !gVar.a)) {
                childAt2.measure(View.MeasureSpec.makeMeasureSpec((int) (paddingLeft * gVar.f2381c), 1073741824), this.mChildHeightMeasureSpec);
            }
        }
    }
    ...
    */
    ...
    protected boolean onRequestFocusInDescendants(int i2, Rect rect) {
        ...
        while (i3 != i5) {
            ...
            if (childAt.getVisibility() == 0 && (infoForChild = infoForChild(childAt)) != null && infoForChild.f2376b == this.mCurItem && childAt.requestFocus(i2, rect)) {
                return true;
            }
            i3 += i4;
        }
    ...
    public void onRestoreInstanceState(Parcelable parcelable) {
        ...
        if (aVar != null) {
            aVar.restoreState(mVar.f2387d, mVar.f2388e);
            setCurrentItemInternal(mVar.f2386c, false, true);
            return;
        }
        this.mRestoredCurItem = mVar.f2386c;
        this.mRestoredAdapterState = mVar.f2387d;
        this.mRestoredClassLoader = mVar.f2388e;
    }

    @Override // android.view.View
    public Parcelable onSaveInstanceState() {
        m mVar = new m(super.onSaveInstanceState());
        mVar.f2386c = this.mCurItem;
        androidx.viewpager.widget.a aVar = this.mAdapter;
        if (aVar != null) {
            mVar.f2387d = aVar.saveState();
        }
        return mVar;
    }
    ...
    public boolean onTouchEvent(MotionEvent motionEvent) {
        ...
        if (action == 0) {
            ...
            setCurrentItemInternal(determineTargetPage(infoForCurrentScrollPosition.f2376b, ((scrollX / f3) - infoForCurrentScrollPosition.f2379e) / (infoForCurrentScrollPosition.f2378d + (this.mPageMargin / f3)), xVelocity, (int) (motionEvent.getX(motionEvent.findPointerIndex(this.mActivePointerId)) - this.mInitialMotionX)), true, true, xVelocity);
            z = resetTouch();
        }
        if (z) {
            v.b0(this);
    ...
    public static class g extends ViewGroup.LayoutParams {
        ...
        public g(Context context, AttributeSet attributeSet) {
            ...
            this.f2380b = obtainStyledAttributes.getInteger(0, 48);
        ...
        if (aVar != null && aVar.getCount() > 0) {
            ...
            if (i2 > i5 + i4 || i2 < i5 - i4) {
                for (int i6 = 0; i6 < this.mItems.size(); i6++) {
                    this.mItems.get(i6).f2377c = true;
                }
            }
