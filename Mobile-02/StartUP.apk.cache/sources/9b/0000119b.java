...
final class EventProperty_ApplicationKt$ErrorMessage$2 extends o implements a<EventProperty> {
    public static final EventProperty_ApplicationKt$ErrorMessage$2 INSTANCE = new EventProperty_ApplicationKt$ErrorMessage$2();

    EventProperty_ApplicationKt$ErrorMessage$2() {
        super(0);
    }
    ...
    public final EventProperty invoke() {
        return new EventProperty("error_message");
    }
}