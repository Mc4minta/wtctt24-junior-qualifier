...
public class j {
    ...
    private static final c.e.g<String, Constructor<? extends View>> sConstructorMap = new c.e.g<>();
    ...
    public static class a implements View.OnClickListener {
        ...
        private Method f478c;

        /* renamed from: d  reason: collision with root package name */
        private Context f479d;
        ...
        private void a(Context context) {
            ...
            while (context != null) {
                try {
                    if (!context.isRestricted() && (method = context.getClass().getMethod(this.f477b, View.class)) != null) {
                        this.f478c = method;
                        this.f479d = context;
                        return;
                    }
            ...
            throw new IllegalStateException("Could not find method " + this.f477b + "(View) in a parent or ancestor Context for android:onClick attribute defined on view " + this.a.getClass() + str);
        }
        ...
        public void onClick(View view) {
            ...
            try {
                this.f478c.invoke(this.f479d, view);
    ...
    private void checkOnClickListener(View view, AttributeSet attributeSet) {
        ...
        if (context instanceof ContextWrapper) {
            if (Build.VERSION.SDK_INT < 15 || v.M(view)) {
    ...
    private View createViewByPrefix(Context context, String str, String str2) throws ClassNotFoundException, InflateException {
        String str3;
        c.e.g<String, Constructor<? extends View>> gVar = sConstructorMap;
    ...
    private static Context themifyContext(Context context, AttributeSet attributeSet, boolean z, boolean z2) {
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, c.a.j.S3, 0, 0);
        int resourceId = z ? obtainStyledAttributes.getResourceId(c.a.j.T3, 0) : 0;
        if (z2 && resourceId == 0 && (resourceId = obtainStyledAttributes.getResourceId(c.a.j.U3, 0)) != 0) {
    ...
    protected androidx.appcompat.widget.j createImageButton(Context context, AttributeSet attributeSet) {
    ...
    protected androidx.appcompat.widget.l createMultiAutoCompleteTextView(Context context, AttributeSet attributeSet) {
        return new androidx.appcompat.widget.l(context, attributeSet);
    }

    protected androidx.appcompat.widget.o createRadioButton(Context context, AttributeSet attributeSet) {
    ...
    protected w createToggleButton(Context context, AttributeSet attributeSet) {
