...
final class EventProperty_ApplicationKt$CurrencyCode$2 extends o implements a<EventProperty> {
    public static final EventProperty_ApplicationKt$CurrencyCode$2 INSTANCE = new EventProperty_ApplicationKt$CurrencyCode$2();

    EventProperty_ApplicationKt$CurrencyCode$2() {
        super(0);
    }
    ...
    public final EventProperty invoke() {
        return new EventProperty(ApiConstants.CURRENCY_CODE);
    }
}