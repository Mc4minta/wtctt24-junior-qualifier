...
public final class TxManagingModule_ProvidesXRPTxManaging$wallets_releaseFactory implements d<TxManaging> {
    ...
    public TxManagingModule_ProvidesXRPTxManaging$wallets_releaseFactory(Provider<CipherCoreInterface> provider, Provider<XRPSignedTxDAO> provider2, Provider<XRPService> provider3, Provider<AddressDao> provider4, Provider<WalletDao> provider5, Provider<StoreInterface> provider6) {
    ...
    public static TxManagingModule_ProvidesXRPTxManaging$wallets_releaseFactory create(Provider<CipherCoreInterface> provider, Provider<XRPSignedTxDAO> provider2, Provider<XRPService> provider3, Provider<AddressDao> provider4, Provider<WalletDao> provider5, Provider<StoreInterface> provider6) {
        return new TxManagingModule_ProvidesXRPTxManaging$wallets_releaseFactory(provider, provider2, provider3, provider4, provider5, provider6);
    }
    ...
    public static TxManaging providesXRPTxManaging$wallets_release(CipherCoreInterface cipherCoreInterface, XRPSignedTxDAO xRPSignedTxDAO, XRPService xRPService, AddressDao addressDao, WalletDao walletDao, StoreInterface storeInterface) {
        TxManaging providesXRPTxManaging$wallets_release;
        providesXRPTxManaging$wallets_release = TxManagingModule.Companion.providesXRPTxManaging$wallets_release(cipherCoreInterface, xRPSignedTxDAO, xRPService, addressDao, walletDao, storeInterface);
        return (TxManaging) h.f(providesXRPTxManaging$wallets_release);
    }
