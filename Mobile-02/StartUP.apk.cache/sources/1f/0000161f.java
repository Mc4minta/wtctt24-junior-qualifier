...
final class EventProperty_ConsumerKt$BalanceIncreased$2 extends o implements a<EventProperty> {
    public static final EventProperty_ConsumerKt$BalanceIncreased$2 INSTANCE = new EventProperty_ConsumerKt$BalanceIncreased$2();

    EventProperty_ConsumerKt$BalanceIncreased$2() {
        super(0);
    }
    ...
    public final EventProperty invoke() {
        return new EventProperty("balance_increased");
    }
}