...
public final class OkHttpsURLConnection extends DelegatingHttpsURLConnection {
    ...
    public /* bridge */ /* synthetic */ long getHeaderFieldDate(String str, long j2) {
        return super.getHeaderFieldDate(str, j2);
    }

    @Override // okhttp3.internal.huc.DelegatingHttpsURLConnection, java.net.URLConnection
    public /* bridge */ /* synthetic */ int getHeaderFieldInt(String str, int i2) {
        return super.getHeaderFieldInt(str, i2);
    }
    ...
    @Override // okhttp3.internal.huc.DelegatingHttpsURLConnection, java.net.URLConnection
    @IgnoreJRERequirement
    public /* bridge */ /* synthetic */ long getHeaderFieldLong(String str, long j2) {
        return super.getHeaderFieldLong(str, j2);
    }
    ...
    @Override // okhttp3.internal.huc.DelegatingHttpsURLConnection, java.net.HttpURLConnection
    @IgnoreJRERequirement
    public /* bridge */ /* synthetic */ void setFixedLengthStreamingMode(long j2) {
        super.setFixedLengthStreamingMode(j2);
    }
