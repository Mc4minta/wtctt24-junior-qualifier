...
public final class SwapAmountPickerViewModel$handleFiatInput$1 extends kotlin.jvm.internal.o implements kotlin.e0.c.l<Throwable, kotlin.x> {
    final /* synthetic */ SwapAsset $source;
    final /* synthetic */ SwapAmountPickerViewModel this$0;

    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public SwapAmountPickerViewModel$handleFiatInput$1(SwapAmountPickerViewModel swapAmountPickerViewModel, SwapAsset swapAsset) {
        super(1);
    ...
    public final void invoke2(Throwable it) {
        ...
        String o = kotlin.jvm.internal.m.o("conversion failed: fiat to ", this.$source.getCurrencyCode().getCode());
        ...
        analytics.log(AnalyticsEvent_ApplicationKt.swapAmountPickerGenericError(companion, o, code, str));
    }
}