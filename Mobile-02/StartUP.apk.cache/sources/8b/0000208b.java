...
public final class AmountPickerFragment$setupOnClickListeners$2 extends kotlin.jvm.internal.o implements kotlin.e0.c.l<View, kotlin.x> {
    final /* synthetic */ AmountPickerFragment this$0;

    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public AmountPickerFragment$setupOnClickListeners$2(AmountPickerFragment amountPickerFragment) {
        super(1);
    ...
    public final void invoke2(View it) {
        ...
        Analytics.INSTANCE.log(AnalyticsEvent_ApplicationKt.sendCoinAmountMaxSelected(AnalyticsEvent.Companion));
        amountPickerViewModel = this.this$0.viewModel;
        if (amountPickerViewModel != null) {
            amountPickerViewModel.updateMaxSendAmount();
        } else {
