...
public final class DeserializedTypeAliasDescriptor extends AbstractTypeAliasDescriptor implements DeserializedMemberDescriptor {
    ...
    */
    ...
    public ClassDescriptor getClassDescriptor() {
        ...
        ClassifierDescriptor mo2214getDeclarationDescriptor = getExpandedType().getConstructor().mo2214getDeclarationDescriptor();
    ...
    public TypeAliasDescriptor substitute(TypeSubstitutor substitutor) {
        ...
        m.f(safeSubstitute, "substitutor.safeSubstitute(underlyingType, Variance.INVARIANT)");
        ...
        m.f(safeSubstitute2, "substitutor.safeSubstitute(expandedType, Variance.INVARIANT)");
