...
final class EventFeature_ApplicationKt$WalletLink$2 extends o implements a<EventFeature> {
    public static final EventFeature_ApplicationKt$WalletLink$2 INSTANCE = new EventFeature_ApplicationKt$WalletLink$2();

    EventFeature_ApplicationKt$WalletLink$2() {
        super(0);
    }
    ...
    public final EventFeature invoke() {
        return new EventFeature("WalletLink");
    }
}