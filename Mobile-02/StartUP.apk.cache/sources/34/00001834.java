...
public final class ConsumerFragment$setupOnClickListeners$2 extends kotlin.jvm.internal.o implements kotlin.e0.c.l<View, kotlin.x> {
    final /* synthetic */ ConsumerFragment this$0;

    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public ConsumerFragment$setupOnClickListeners$2(ConsumerFragment consumerFragment) {
        super(1);
    ...
    public final void invoke2(View it) {
        ...
        analytics.log(AnalyticsEvent_ConsumerKt.consumerAccountsSettingsTapped(companion, accountsViewModel.getOnrampEnabled()));
