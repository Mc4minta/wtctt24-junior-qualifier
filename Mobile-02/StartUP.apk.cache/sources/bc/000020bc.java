...
public final class SendDestinationPickerFragment$setupQrScanner$2 extends kotlin.jvm.internal.o implements kotlin.e0.c.l<Throwable, kotlin.x> {
    final /* synthetic */ SendDestinationPickerFragment this$0;

    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public SendDestinationPickerFragment$setupQrScanner$2(SendDestinationPickerFragment sendDestinationPickerFragment) {
        super(1);
    ...
    public final void invoke2(Throwable it) {
        ...
        jVar = this.this$0.qrScannerViewModel;
        if (jVar == null) {
        ...
        if (sendDestinationPickerViewModel != null) {
            jVar.g(sendDestinationPickerViewModel.getQrScanningErrorText());
        } else {
