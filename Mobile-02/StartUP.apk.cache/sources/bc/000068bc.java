...
public class NTRUSigningParameters implements Cloneable {
    ...
    public int hashCode() {
        ...
        int i4 = ((((((((((((i3 * 31) + ((int) (doubleToLongBits2 ^ (doubleToLongBits2 >>> 32)))) * 31) + this.bitsF) * 31) + this.f17863d) * 31) + this.d1) * 31) + this.d2) * 31) + this.d3) * 31;
        Digest digest = this.hashAlg;
        ...
        return (((((i5 * 31) + ((int) (doubleToLongBits4 ^ (doubleToLongBits4 >>> 32)))) * 31) + this.q) * 31) + this.signFailTolerance;
    }
    ...
    public void writeTo(OutputStream outputStream) throws IOException {
        ...
        dataOutputStream.writeInt(this.f17863d);
    ...
    public NTRUSigningParameters clone() {
        return new NTRUSigningParameters(this.N, this.q, this.f17863d, this.B, this.beta, this.normBound, this.hashAlg);
    }
    ...
    public NTRUSigningParameters(InputStream inputStream) throws IOException {
        ...
        this.f17863d = dataInputStream.readInt();
