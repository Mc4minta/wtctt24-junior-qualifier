...
final class ConfirmationFragment$onViewCreated$1 extends kotlin.jvm.internal.o implements kotlin.e0.c.l<SendConfirmationResult, kotlin.x> {
    ...
    public /* bridge */ /* synthetic */ kotlin.x invoke(SendConfirmationResult sendConfirmationResult) {
    ...
    public final void invoke2(SendConfirmationResult it) {
        ...
        confirmationFragment.handleConfirmationResult(it);
    }
}