...
final class EventProperty_ApplicationKt$FlowName$2 extends o implements a<EventProperty> {
    public static final EventProperty_ApplicationKt$FlowName$2 INSTANCE = new EventProperty_ApplicationKt$FlowName$2();

    EventProperty_ApplicationKt$FlowName$2() {
        super(0);
    }
    ...
    public final EventProperty invoke() {
        return new EventProperty(AdjustableMinerFeeArgs.FLOW_NAME);
    }
}