...
@Metadata(bv = {1, 0, 3}, d1 = {"\u0000T\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0010\u000e\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0010 \n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\u0018\u00002\b\u0012\u0004\u0012\u00020\u00020\u0001B\u000f\u0012\u0006\u0010\u001c\u001a\u00020\u001b¢\u0006\u0004\b\u001d\u0010\u001eJ\u000f\u0010\u0004\u001a\u00020\u0003H\u0016¢\u0006\u0004\b\u0004\u0010\u0005J\u0017\u0010\b\u001a\u00020\u00022\u0006\u0010\u0007\u001a\u00020\u0006H\u0016¢\u0006\u0004\b\b\u0010\tJ!\u0010\u000e\u001a\u00020\r2\u0006\u0010\u000b\u001a\u00020\n2\b\u0010\f\u001a\u0004\u0018\u00010\u0002H\u0016¢\u0006\u0004\b\u000e\u0010\u000fR\u001c\u0010\u0011\u001a\b\u0012\u0004\u0012\u00020\u00100\u00018\u0002@\u0002X\u0082\u0004¢\u0006\u0006\n\u0004\b\u0011\u0010\u0012R\"\u0010\u0015\u001a\u000e\u0012\n\u0012\b\u0012\u0004\u0012\u00020\u00140\u00130\u00018\u0002@\u0002X\u0082\u0004¢\u0006\u0006\n\u0004\b\u0015\u0010\u0012R\"\u0010\u0017\u001a\u000e\u0012\n\u0012\b\u0012\u0004\u0012\u00020\u00160\u00130\u00018\u0002@\u0002X\u0082\u0004¢\u0006\u0006\n\u0004\b\u0017\u0010\u0012R\u0016\u0010\u0019\u001a\u00020\u00188\u0002@\u0002X\u0082\u0004¢\u0006\u0006\n\u0004\b\u0019\u0010\u001a¨\u0006\u001f"}, d2 = {"Lcom/coinbase/walletengine/services/bitcoincash/CoinSelectionJsonAdapter;", "Lcom/squareup/moshi/JsonAdapter;", "Lcom/coinbase/walletengine/services/bitcoincash/CoinSelection;", "", "toString", "()Ljava/lang/String;", "Lcom/squareup/moshi/JsonReader;", "reader", "fromJson", "(Lcom/squareup/moshi/JsonReader;)Lcom/coinbase/walletengine/services/bitcoincash/CoinSelection;", "Lcom/squareup/moshi/JsonWriter;", "writer", "value_", "Lkotlin/x;", "toJson", "(Lcom/squareup/moshi/JsonWriter;Lcom/coinbase/walletengine/services/bitcoincash/CoinSelection;)V", "Ljava/math/BigInteger;", "bigIntegerAdapter", "Lcom/squareup/moshi/JsonAdapter;", "", "Lcom/coinbase/walletengine/services/bitcoincash/UTXO;", "listOfUTXOAdapter", "Lcom/coinbase/walletengine/services/bitcoincash/Output;", "listOfOutputAdapter", "Lcom/squareup/moshi/JsonReader$Options;", "options", "Lcom/squareup/moshi/JsonReader$Options;", "Lcom/squareup/moshi/Moshi;", "moshi", "<init>", "(Lcom/squareup/moshi/Moshi;)V", "wallet-engine_release"}, k = 1, mv = {1, 5, 1})
...
public final class CoinSelectionJsonAdapter extends JsonAdapter<CoinSelection> {
    ...
    public CoinSelectionJsonAdapter(Moshi moshi) {
        ...
        kotlin.jvm.internal.m.f(of, "of(\"inputs\", \"outputs\", \"fee\")");
        this.options = of;
        ...
        kotlin.jvm.internal.m.f(adapter, "moshi.adapter(Types.newParameterizedType(List::class.java, UTXO::class.java), emptySet(),\n      \"inputs\")");
        ...
        kotlin.jvm.internal.m.f(adapter2, "moshi.adapter(Types.newParameterizedType(List::class.java, Output::class.java), emptySet(),\n      \"outputs\")");
    ...
    public CoinSelection fromJson(JsonReader reader) {
        ...
        while (reader.hasNext()) {
            ...
            if (selectName == -1) {
                ...
                if (list == null) {
                    ...
                    kotlin.jvm.internal.m.f(unexpectedNull, "unexpectedNull(\"inputs\",\n            \"inputs\", reader)");
                ...
                if (list2 == null) {
                    ...
                    kotlin.jvm.internal.m.f(unexpectedNull2, "unexpectedNull(\"outputs\",\n            \"outputs\", reader)");
                ...
                kotlin.jvm.internal.m.f(unexpectedNull3, "unexpectedNull(\"fee\", \"fee\",\n            reader)");
        ...
        if (list == null) {
            ...
            kotlin.jvm.internal.m.f(missingProperty, "missingProperty(\"inputs\", \"inputs\", reader)");
            throw missingProperty;
        } else if (list2 == null) {
            JsonDataException missingProperty2 = Util.missingProperty("outputs", "outputs", reader);
            kotlin.jvm.internal.m.f(missingProperty2, "missingProperty(\"outputs\", \"outputs\", reader)");
            ...
            kotlin.jvm.internal.m.f(missingProperty3, "missingProperty(\"fee\", \"fee\", reader)");
