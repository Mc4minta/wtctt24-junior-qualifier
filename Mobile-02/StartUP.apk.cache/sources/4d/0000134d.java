...
final class Blockchain_BitcoinKt$BITCOIN$2 extends o implements a<Blockchain> {
    public static final Blockchain_BitcoinKt$BITCOIN$2 INSTANCE = new Blockchain_BitcoinKt$BITCOIN$2();

    Blockchain_BitcoinKt$BITCOIN$2() {
        super(0);
    }
