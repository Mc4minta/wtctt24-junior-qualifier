...
@Metadata(bv = {1, 0, 3}, d1 = {"\u0000\u0010\n\u0002\u0010\u000e\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\u0010\u0004\u001a\u00020\u00032\u000e\u0010\u0002\u001a\n \u0001*\u0004\u0018\u00010\u00000\u0000H\n¢\u0006\u0004\b\u0004\u0010\u0005"}, d2 = {"", "kotlin.jvm.PlatformType", "cryptoAmount", "Lkotlin/x;", "<anonymous>", "(Ljava/lang/String;)V"}, k = 3, mv = {1, 5, 1})
/* loaded from: classes.dex */
public final class ConsumerAmountPickerViewModel$observeAmountUpdates$3 extends kotlin.jvm.internal.o implements kotlin.e0.c.l<String, kotlin.x> {
    final /* synthetic */ ConsumerAmountPickerViewModel this$0;

    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public ConsumerAmountPickerViewModel$observeAmountUpdates$3(ConsumerAmountPickerViewModel consumerAmountPickerViewModel) {
        super(1);
    ...
    public final void invoke2(String cryptoAmount) {
        BigDecimal j2;
        ...
        kotlin.jvm.internal.m.f(cryptoAmount, "cryptoAmount");
        j2 = kotlin.l0.v.j(cryptoAmount);
        if (j2 == null) {
            j2 = BigDecimal.ZERO;
        }
        ...
        BigDecimal asBigDecimal = BigInteger_CommonKt.asBigDecimal(balance, consumerAccount2.getDecimals());
        onrampEnabled = this.this$0.getOnrampEnabled();
        boolean z = !onrampEnabled ? j2.compareTo(BigDecimal.ZERO) <= 0 || j2.compareTo(asBigDecimal) > 0 : j2.compareTo(BigDecimal.ZERO) <= 0;
