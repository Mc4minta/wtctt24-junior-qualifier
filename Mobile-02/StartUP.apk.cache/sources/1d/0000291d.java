...
public final class TxManagingModule_ProvidesStellarTxManaging$wallets_releaseFactory implements d<TxManaging> {
    ...
    public TxManagingModule_ProvidesStellarTxManaging$wallets_releaseFactory(Provider<StellarSignedTxDao> provider, Provider<CipherCoreInterface> provider2, Provider<TimeAPI> provider3, Provider<StellarService> provider4, Provider<AddressDao> provider5, Provider<WalletDao> provider6) {
    ...
    public static TxManagingModule_ProvidesStellarTxManaging$wallets_releaseFactory create(Provider<StellarSignedTxDao> provider, Provider<CipherCoreInterface> provider2, Provider<TimeAPI> provider3, Provider<StellarService> provider4, Provider<AddressDao> provider5, Provider<WalletDao> provider6) {
        return new TxManagingModule_ProvidesStellarTxManaging$wallets_releaseFactory(provider, provider2, provider3, provider4, provider5, provider6);
    }
    ...
    public static TxManaging providesStellarTxManaging$wallets_release(StellarSignedTxDao stellarSignedTxDao, CipherCoreInterface cipherCoreInterface, TimeAPI timeAPI, StellarService stellarService, AddressDao addressDao, WalletDao walletDao) {
        TxManaging providesStellarTxManaging$wallets_release;
        providesStellarTxManaging$wallets_release = TxManagingModule.Companion.providesStellarTxManaging$wallets_release(stellarSignedTxDao, cipherCoreInterface, timeAPI, stellarService, addressDao, walletDao);
        return (TxManaging) h.f(providesStellarTxManaging$wallets_release);
    }
