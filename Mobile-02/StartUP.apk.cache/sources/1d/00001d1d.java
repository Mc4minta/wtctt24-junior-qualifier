...
public final class RPC$postProtected$2 extends o implements l<Throwable, Boolean> {
    public static final RPC$postProtected$2 INSTANCE = new RPC$postProtected$2();

    public RPC$postProtected$2() {
        super(1);
    }
