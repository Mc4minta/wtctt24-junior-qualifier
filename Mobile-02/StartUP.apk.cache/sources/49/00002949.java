...
public final class WalletsRepositoriesModule_Companion_ProvidesLTCWalletRepositoryFactory implements d<WalletManaging> {
    ...
    public WalletsRepositoriesModule_Companion_ProvidesLTCWalletRepositoryFactory(Provider<AddressDao> provider, Provider<WalletDao> provider2, Provider<StoreInterface> provider3, Provider<CipherCoreInterface> provider4, Provider<LTCService> provider5, Provider<Tracing> provider6, Provider<BatchBalanceAPI> provider7) {
    ...
    public static WalletsRepositoriesModule_Companion_ProvidesLTCWalletRepositoryFactory create(Provider<AddressDao> provider, Provider<WalletDao> provider2, Provider<StoreInterface> provider3, Provider<CipherCoreInterface> provider4, Provider<LTCService> provider5, Provider<Tracing> provider6, Provider<BatchBalanceAPI> provider7) {
        return new WalletsRepositoriesModule_Companion_ProvidesLTCWalletRepositoryFactory(provider, provider2, provider3, provider4, provider5, provider6, provider7);
    }
    ...
    public static WalletManaging providesLTCWalletRepository(AddressDao addressDao, WalletDao walletDao, StoreInterface storeInterface, CipherCoreInterface cipherCoreInterface, LTCService lTCService, Tracing tracing, BatchBalanceAPI batchBalanceAPI) {
        return (WalletManaging) h.f(WalletsRepositoriesModule.Companion.providesLTCWalletRepository(addressDao, walletDao, storeInterface, cipherCoreInterface, lTCService, tracing, batchBalanceAPI));
    }
