...
public class i {
    ...
    public static class a {
        ...
        double[] f5129b = new double[3];

        /* renamed from: c  reason: collision with root package name */
        double[] f5130c = new double[3];

        /* renamed from: d  reason: collision with root package name */
        double[] f5131d = new double[3];

        /* renamed from: e  reason: collision with root package name */
        double[] f5132e = new double[3];
    ...
    public static void k(double[] dArr, a aVar) {
        e.f.k.a.a.a(dArr.length == 16);
        double[] dArr2 = aVar.a;
        double[] dArr3 = aVar.f5129b;
        double[] dArr4 = aVar.f5130c;
        double[] dArr5 = aVar.f5131d;
        double[] dArr6 = aVar.f5132e;
        if (o(dArr[15])) {
            return;
        }
        ...
        for (int i6 = 0; i6 < 3; i6++) {
            dArr9[i6][0] = dArr7[i6][0];
            dArr9[i6][1] = dArr7[i6][1];
            dArr9[i6][2] = dArr7[i6][2];
        }
        dArr3[0] = x(dArr9[0]);
