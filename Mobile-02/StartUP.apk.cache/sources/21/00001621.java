...
final class EventProperty_ConsumerKt$FiatSelected$2 extends o implements a<EventProperty> {
    public static final EventProperty_ConsumerKt$FiatSelected$2 INSTANCE = new EventProperty_ConsumerKt$FiatSelected$2();

    EventProperty_ConsumerKt$FiatSelected$2() {
        super(0);
    }
    ...
    public final EventProperty invoke() {
        return new EventProperty("fiat_selected");
    }
}