...
public abstract class Nat {
    ...
    public static int add(int i2, int[] iArr, int[] iArr2, int[] iArr3) {
        ...
        for (int i3 = 0; i3 < i2; i3++) {
            long j3 = j2 + (iArr[i3] & M) + (M & iArr2[i3]);
            iArr3[i3] = (int) j3;
            j2 = j3 >>> 32;
        }
        return (int) j2;
    ...
    public static int add33At(int i2, int i3, int[] iArr, int i4) {
        int i5 = i4 + 0;
        long j2 = (iArr[i5] & M) + (i3 & M);
        iArr[i5] = (int) j2;
        int i6 = i4 + 1;
        long j3 = (j2 >>> 32) + (M & iArr[i6]) + 1;
        iArr[i6] = (int) j3;
        if ((j3 >>> 32) == 0) {
            return 0;
        }
    ...
    public static int add33To(int i2, int i3, int[] iArr) {
        long j2 = (iArr[0] & M) + (i3 & M);
        iArr[0] = (int) j2;
        long j3 = (j2 >>> 32) + (M & iArr[1]) + 1;
        iArr[1] = (int) j3;
        if ((j3 >>> 32) == 0) {
            return 0;
        }
    ...
    public static int addBothTo(int i2, int[] iArr, int[] iArr2, int[] iArr3) {
        long j2 = 0;
        for (int i3 = 0; i3 < i2; i3++) {
            long j3 = j2 + (iArr[i3] & M) + (iArr2[i3] & M) + (M & iArr3[i3]);
            iArr3[i3] = (int) j3;
            j2 = j3 >>> 32;
        }
        return (int) j2;
    ...
    public static int addDWordAt(int i2, long j2, int[] iArr, int i3) {
        int i4 = i3 + 0;
        long j3 = (iArr[i4] & M) + (j2 & M);
        iArr[i4] = (int) j3;
        int i5 = i3 + 1;
        long j4 = (j3 >>> 32) + (M & iArr[i5]) + (j2 >>> 32);
        iArr[i5] = (int) j4;
        if ((j4 >>> 32) == 0) {
            return 0;
        }
    ...
    public static int addDWordTo(int i2, long j2, int[] iArr) {
        long j3 = (iArr[0] & M) + (j2 & M);
        iArr[0] = (int) j3;
        long j4 = (j3 >>> 32) + (M & iArr[1]) + (j2 >>> 32);
        iArr[1] = (int) j4;
        if ((j4 >>> 32) == 0) {
            return 0;
        }
    ...
    public static int mul31BothAdd(int i2, int i3, int[] iArr, int i4, int[] iArr2, int[] iArr3, int i5) {
        ...
        do {
            int i7 = i5 + i6;
            long j5 = j4 + ((iArr[i6] & M) * j2) + ((iArr2[i6] & M) * j3) + (iArr3[i7] & M);
            iArr3[i7] = (int) j5;
            j4 = j5 >>> 32;
            i6++;
        } while (i6 < i2);
    ...
    public static int mulAddTo(int i2, int[] iArr, int[] iArr2, int[] iArr3) {
        ...
        for (int i4 = 0; i4 < i2; i4++) {
            long mulWordAddTo = (mulWordAddTo(i2, iArr[i4], iArr2, 0, iArr3, i4) & M) + j2 + (M & iArr3[i3]);
    ...
    public static int mulWordAddTo(int i2, int i3, int[] iArr, int i4, int[] iArr2, int i5) {
        ...
        do {
            int i7 = i5 + i6;
            long j4 = j3 + ((iArr[i4 + i6] & M) * j2) + (iArr2[i7] & M);
            iArr2[i7] = (int) j4;
            j3 = j4 >>> 32;
            i6++;
        } while (i6 < i2);
    ...
    public static int mulWordDwordAddAt(int i2, int i3, long j2, int[] iArr, int i4) {
        long j3 = i3 & M;
        int i5 = i4 + 0;
        long j4 = ((j2 & M) * j3) + (iArr[i5] & M) + 0;
        iArr[i5] = (int) j4;
        long j5 = j3 * (j2 >>> 32);
        int i6 = i4 + 1;
        long j6 = (j4 >>> 32) + j5 + (iArr[i6] & M);
        iArr[i6] = (int) j6;
        int i7 = i4 + 2;
        long j7 = (j6 >>> 32) + (iArr[i7] & M);
        iArr[i7] = (int) j7;
        if ((j7 >>> 32) == 0) {
            return 0;
        }
    ...
    public static int squareWordAdd(int[] iArr, int i2, int[] iArr2) {
        ...
        do {
            int i4 = i2 + i3;
            long j4 = j3 + ((iArr[i3] & M) * j2) + (iArr2[i4] & M);
            iArr2[i4] = (int) j4;
            j3 = j4 >>> 32;
            i3++;
        } while (i3 < i2);
    ...
    public static int subBothFrom(int i2, int[] iArr, int[] iArr2, int[] iArr3) {
        long j2 = 0;
        for (int i3 = 0; i3 < i2; i3++) {
            long j3 = j2 + (((iArr3[i3] & M) - (iArr[i3] & M)) - (M & iArr2[i3]));
            iArr3[i3] = (int) j3;
            j2 = j3 >> 32;
        }
        return (int) j2;
    ...
    public static int subFrom(int i2, int[] iArr, int[] iArr2) {
        long j2 = 0;
        for (int i3 = 0; i3 < i2; i3++) {
            long j3 = j2 + ((iArr2[i3] & M) - (M & iArr[i3]));
            iArr2[i3] = (int) j3;
            j2 = j3 >> 32;
        }
        return (int) j2;
    ...
    public static int addBothTo(int i2, int[] iArr, int i3, int[] iArr2, int i4, int[] iArr3, int i5) {
        ...
        for (int i6 = 0; i6 < i2; i6++) {
            int i7 = i5 + i6;
            long j3 = j2 + (iArr[i3 + i6] & M) + (iArr2[i4 + i6] & M) + (M & iArr3[i7]);
            iArr3[i7] = (int) j3;
            j2 = j3 >>> 32;
        }
        return (int) j2;
    ...
    public static int addTo(int i2, int[] iArr, int i3, int[] iArr2, int i4) {
        ...
        for (int i5 = 0; i5 < i2; i5++) {
            int i6 = i4 + i5;
            long j3 = j2 + (iArr[i3 + i5] & M) + (M & iArr2[i6]);
            iArr2[i6] = (int) j3;
            j2 = j3 >>> 32;
        }
        return (int) j2;
    ...
    public static int sub(int i2, int[] iArr, int i3, int[] iArr2, int i4, int[] iArr3, int i5) {
        long j2 = 0;
        for (int i6 = 0; i6 < i2; i6++) {
            long j3 = j2 + ((iArr[i3 + i6] & M) - (M & iArr2[i4 + i6]));
            iArr3[i5 + i6] = (int) j3;
            j2 = j3 >> 32;
        }
        return (int) j2;
    ...
    public static int subBothFrom(int i2, int[] iArr, int i3, int[] iArr2, int i4, int[] iArr3, int i5) {
        ...
        for (int i6 = 0; i6 < i2; i6++) {
            int i7 = i5 + i6;
            long j3 = j2 + (((iArr3[i7] & M) - (iArr[i3 + i6] & M)) - (M & iArr2[i4 + i6]));
            iArr3[i7] = (int) j3;
            j2 = j3 >> 32;
        }
        return (int) j2;
    ...
    public static int subFrom(int i2, int[] iArr, int i3, int[] iArr2, int i4) {
        ...
        for (int i5 = 0; i5 < i2; i5++) {
            int i6 = i4 + i5;
            long j3 = j2 + ((iArr2[i6] & M) - (M & iArr[i3 + i5]));
            iArr2[i6] = (int) j3;
            j2 = j3 >> 32;
        }
        return (int) j2;
    ...
    public static int mulAddTo(int i2, int[] iArr, int i3, int[] iArr2, int i4, int[] iArr3, int i5) {
        ...
        for (int i8 = 0; i8 < i2; i8++) {
            long mulWordAddTo = (mulWordAddTo(i2, iArr[i3 + i8], iArr2, i4, iArr3, i7) & M) + j2 + (M & iArr3[i6]);
            iArr3[i7 + i2] = (int) mulWordAddTo;
            j2 = mulWordAddTo >>> 32;
            i7++;
        }
        return (int) j2;
    ...
    public static int squareWordAdd(int[] iArr, int i2, int i3, int[] iArr2, int i4) {
        int i5;
        long j2 = iArr[i2 + i3] & M;
        int i6 = 0;
        long j3 = 0;
        int i7 = i4;
        do {
            long j4 = j3 + ((iArr[i2 + i6] & M) * j2) + (iArr2[i5] & M);
            iArr2[i3 + i7] = (int) j4;
            j3 = j4 >>> 32;
            i7++;
            i6++;
    ...
    public static int add33At(int i2, int i3, int[] iArr, int i4, int i5) {
        int i6 = i4 + i5;
        long j2 = (iArr[i6] & M) + (i3 & M);
        iArr[i6] = (int) j2;
        int i7 = i6 + 1;
        long j3 = (j2 >>> 32) + (M & iArr[i7]) + 1;
        iArr[i7] = (int) j3;
        if ((j3 >>> 32) == 0) {
            return 0;
        }
    ...
    public static int addDWordAt(int i2, long j2, int[] iArr, int i3, int i4) {
        int i5 = i3 + i4;
        long j3 = (iArr[i5] & M) + (j2 & M);
        iArr[i5] = (int) j3;
        int i6 = i5 + 1;
        long j4 = (j3 >>> 32) + (M & iArr[i6]) + (j2 >>> 32);
        iArr[i6] = (int) j4;
        if ((j4 >>> 32) == 0) {
            return 0;
        }
