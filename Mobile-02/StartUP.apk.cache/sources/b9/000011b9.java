...
final class EventProperty_ApplicationKt$Type$2 extends o implements a<EventProperty> {
    public static final EventProperty_ApplicationKt$Type$2 INSTANCE = new EventProperty_ApplicationKt$Type$2();

    EventProperty_ApplicationKt$Type$2() {
        super(0);
    }
