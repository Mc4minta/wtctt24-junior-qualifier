...
public class LazySubstitutingClassDescriptor extends ModuleAwareClassDescriptor {
    ...
    */
    ...
    private TypeSubstitutor getSubstitutor() {
        ...
        if (this.newSubstitutor == null) {
            if (this.originalSubstitutor.isEmpty()) {
                ...
                U = z.U(this.typeConstructorParameters, new l<TypeParameterDescriptor, Boolean>() { // from class: kotlin.reflect.jvm.internal.impl.descriptors.impl.LazySubstitutingClassDescriptor.1
    ...
    public ClassDescriptor mo2205getCompanionObjectDescriptor() {
        return this.original.mo2205getCompanionObjectDescriptor();
    }
    ...
    public ClassConstructorDescriptor mo2206getUnsubstitutedPrimaryConstructor() {
        return this.original.mo2206getUnsubstitutedPrimaryConstructor();
    }
