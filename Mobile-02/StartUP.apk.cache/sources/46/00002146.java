...
public final class MessageSignerViewModel$sign$4 extends kotlin.jvm.internal.o implements kotlin.e0.c.l<Throwable, x> {
    final /* synthetic */ MessageSignerViewModel this$0;

    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public MessageSignerViewModel$sign$4(MessageSignerViewModel messageSignerViewModel) {
        super(1);
    ...
    public final void invoke2(Throwable it) {
        ...
        signatureRequestEventSubject.onNext(new SigningSessionEvent.Failure(this.this$0.getViewState().getUuid(), new Error(it)));
    }
}