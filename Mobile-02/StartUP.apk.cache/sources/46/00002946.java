...
public final class WalletsRepositoriesModule_Companion_ProvidesBCHWalletRepositoryFactory implements d<WalletManaging> {
    ...
    public WalletsRepositoriesModule_Companion_ProvidesBCHWalletRepositoryFactory(Provider<AddressDao> provider, Provider<WalletDao> provider2, Provider<StoreInterface> provider3, Provider<CipherCoreInterface> provider4, Provider<BCHService> provider5, Provider<Tracing> provider6, Provider<BatchBalanceAPI> provider7) {
    ...
    public static WalletsRepositoriesModule_Companion_ProvidesBCHWalletRepositoryFactory create(Provider<AddressDao> provider, Provider<WalletDao> provider2, Provider<StoreInterface> provider3, Provider<CipherCoreInterface> provider4, Provider<BCHService> provider5, Provider<Tracing> provider6, Provider<BatchBalanceAPI> provider7) {
        return new WalletsRepositoriesModule_Companion_ProvidesBCHWalletRepositoryFactory(provider, provider2, provider3, provider4, provider5, provider6, provider7);
    }
    ...
    public static WalletManaging providesBCHWalletRepository(AddressDao addressDao, WalletDao walletDao, StoreInterface storeInterface, CipherCoreInterface cipherCoreInterface, BCHService bCHService, Tracing tracing, BatchBalanceAPI batchBalanceAPI) {
        return (WalletManaging) h.f(WalletsRepositoriesModule.Companion.providesBCHWalletRepository(addressDao, walletDao, storeInterface, cipherCoreInterface, bCHService, tracing, batchBalanceAPI));
    }
