...
final class EventProperty_ApplicationKt$AmountType$2 extends o implements a<EventProperty> {
    public static final EventProperty_ApplicationKt$AmountType$2 INSTANCE = new EventProperty_ApplicationKt$AmountType$2();

    EventProperty_ApplicationKt$AmountType$2() {
        super(0);
    }
    ...
    public final EventProperty invoke() {
        return new EventProperty("amount_type");
    }
}