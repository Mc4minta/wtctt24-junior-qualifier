...
final class AddressKind_DogecoinKt$Dogecoin$2 extends o implements a<AddressType> {
    public static final AddressKind_DogecoinKt$Dogecoin$2 INSTANCE = new AddressKind_DogecoinKt$Dogecoin$2();

    AddressKind_DogecoinKt$Dogecoin$2() {
        super(0);
    }
    ...
    public final AddressType invoke() {
        return new AddressType("DogeCoin");
    }
}