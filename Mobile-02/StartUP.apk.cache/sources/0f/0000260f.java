package com.coinbase.wallet.stellar.daos;
...
/* compiled from: StellarSignedTxDao.kt */
@Metadata(bv = {1, 0, 3}, d1 = {"\u00008\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010 \n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0005\u0018\u00002\u00020\u0001B\u0013\u0012\n\u0010\u0011\u001a\u0006\u0012\u0002\b\u00030\u0010¢\u0006\u0004\b\u0013\u0010\u0014J#\u0010\u0006\u001a\u000e\u0012\n\u0012\b\u0012\u0004\u0012\u00020\u00020\u00050\u00042\u0006\u0010\u0003\u001a\u00020\u0002H\u0007¢\u0006\u0004\b\u0006\u0010\u0007J#\u0010\u000b\u001a\u000e\u0012\n\u0012\b\u0012\u0004\u0012\u00020\u00020\n0\u00042\u0006\u0010\t\u001a\u00020\bH\u0007¢\u0006\u0004\b\u000b\u0010\fJ\u0015\u0010\u000e\u001a\b\u0012\u0004\u0012\u00020\u00020\rH\u0007¢\u0006\u0004\b\u000e\u0010\u000fR\u001a\u0010\u0011\u001a\u0006\u0012\u0002\b\u00030\u00108\u0002@\u0002X\u0082\u0004¢\u0006\u0006\n\u0004\b\u0011\u0010\u0012¨\u0006\u0015"}, d2 = {"Lcom/coinbase/wallet/stellar/daos/StellarSignedTxDao;", "", "Lcom/coinbase/wallet/stellar/models/StellarSignedTx;", "tx", "Lh/c/b0;", "Lcom/coinbase/wallet/core/util/Optional;", "save", "(Lcom/coinbase/wallet/stellar/models/StellarSignedTx;)Lh/c/b0;", "Lcom/coinbase/wallet/blockchains/models/Network;", "network", "", "getPendingTxs", "(Lcom/coinbase/wallet/blockchains/models/Network;)Lh/c/b0;", "Lh/c/s;", "observeSignedTx", "()Lh/c/s;", "Lcom/coinbase/wallet/libraries/databases/db/Database;", "database", "Lcom/coinbase/wallet/libraries/databases/db/Database;", "<init>", "(Lcom/coinbase/wallet/libraries/databases/db/Database;)V", "stellar_release"}, k = 1, mv = {1, 5, 1})
/* loaded from: classes2.dex */
public final class StellarSignedTxDao {
    private final Database<?> database;

    public StellarSignedTxDao(Database<?> database) {
        m.g(database, "database");
        this.database = database;
    }

    public final b0<List<StellarSignedTx>> getPendingTxs(Network network) {
        m.g(network, "network");
        ...
        b0<List<StellarSignedTx>> observeOn = b0.create(new f0() { // from class: com.coinbase.wallet.stellar.daos.StellarSignedTxDao$getPendingTxs$$inlined$fetch$1
            @Override // h.c.f0
            public final void subscribe(d0<List<? extends T>> emitter) {
                Lock readLock;
                List<? extends T> fetch;
                m.g(emitter, "emitter");
                int i2 = StellarSignedTxDao$getPendingTxs$$inlined$fetch$1$1$wm$Storage$perform$1$WhenMappings.$EnumSwitchMapping$0[DatabaseOperation.this.ordinal()];
                boolean z = true;
                if (i2 == 1) {
                ...
                DatabaseDaoInterface<?> databaseDaoInterface = storage.getModelDaos().get(StellarSignedTx.class);
                ...
                if (databaseDaoInterface2 == null) {
                    emitter.onError(new DatabaseException.MissingDao(StellarSignedTx.class));
                    return;
                }
                readLock.lock();
    ...
    public final s<StellarSignedTx> observeSignedTx() {
        b<?> bVar;
        s sVar;
        ...
        try {
            if (storage.isDestroyed()) {
                ...
                synchronized (storage) {
                    b<?> bVar2 = storage.getObservers().get(StellarSignedTx.class);
                    bVar = bVar2 instanceof b ? bVar2 : null;
                    if (bVar == null) {
                        bVar = b.d();
                        storage.getObservers().put(StellarSignedTx.class, bVar);
                    }
                }
                sVar = bVar.hide();
            }
    ...
    public final b0<Optional<StellarSignedTx>> save(StellarSignedTx tx) {
        final List b2;
        m.g(tx, "tx");
        final Database<?> database = this.database;
        b2 = q.b(tx);
        ...
        b0 observeOn = b0.create(new f0() { // from class: com.coinbase.wallet.stellar.daos.StellarSignedTxDao$save$$inlined$addOrUpdate$1
            @Override // h.c.f0
            public final void subscribe(d0<Optional<? extends List<? extends T>>> emitter) {
                Lock readLock;
                m.g(emitter, "emitter");
                int i2 = StellarSignedTxDao$save$$inlined$addOrUpdate$1$1$wm$Storage$perform$1$WhenMappings.$EnumSwitchMapping$0[DatabaseOperation.this.ordinal()];
                if (i2 == 1) {
                    readLock = storage.getMultiReadSingleWriteLock().readLock();
                    m.f(readLock, "multiReadSingleWriteLock.readLock()");
                } else if (i2 != 2) {
        ...
        m.f(observeOn, "@Suppress(\"UNCHECKED_CAST\")\n    inline fun <reified T, reified R> perform(\n        operation: DatabaseOperation,\n        crossinline work: (dao: DatabaseDaoInterface<T>) -> R\n    ): Single<R> = Single\n        .create<R> { emitter ->\n            val lock: Lock = when (operation) {\n                DatabaseOperation.READ -> multiReadSingleWriteLock.readLock()\n                DatabaseOperation.WRITE -> multiReadSingleWriteLock.writeLock()\n            }\n\n            val dao = modelDaos[T::class.java] as? DatabaseDaoInterface<T>\n                ?: return@create emitter.onError(DatabaseException.MissingDao(T::class.java))\n\n            lock.lock()\n\n            if (isDestroyed) {\n                lock.unlock()\n                return@create emitter.onError(DatabaseException.DatabaseDestroyed)\n            }\n\n            try {\n                val result = work(dao) as? R ?: throw IllegalArgumentException(\"Invalid result\")\n                emitter.onSuccess(result)\n            } catch (err: Throwable) {\n                emitter.onError(err)\n            } finally {\n                lock.unlock()\n            }\n        }\n        .subscribeOn(scheduler)\n        .observeOn(scheduler)");
        b0 doAfterSuccess = observeOn.doAfterSuccess(new f() { // from class: com.coinbase.wallet.stellar.daos.StellarSignedTxDao$save$$inlined$addOrUpdate$2
                    ...
                    try {
                        ...
                        if (databaseModelObject2 != null) {
                            synchronized (storage2) {
                                b<?> bVar2 = storage2.getObservers().get(StellarSignedTx.class);
                                bVar = bVar2 instanceof b ? bVar2 : null;
                                if (bVar == null) {
                                    bVar = b.d();
                                    storage2.getObservers().put(StellarSignedTx.class, bVar);
                                }
                            }
        ...
        b0<Optional<StellarSignedTx>> map = doAfterSuccess.map(new n() { // from class: com.coinbase.wallet.stellar.daos.StellarSignedTxDao$save$$inlined$addOrUpdate$3
