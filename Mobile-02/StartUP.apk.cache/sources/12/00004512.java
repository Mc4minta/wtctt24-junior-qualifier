...
public final class h {
    ...
    private static final ThreadLocal<Path> f11966b = new b();

    /* renamed from: c  reason: collision with root package name */
    private static final ThreadLocal<Path> f11967c = new c();

    /* renamed from: d  reason: collision with root package name */
    private static final ThreadLocal<float[]> f11968d = new d();

    /* renamed from: e  reason: collision with root package name */
    private static final float f11969e = (float) (Math.sqrt(2.0d) / 2.0d);

    /* renamed from: f  reason: collision with root package name */
    private static float f11970f = -1.0f;
    ...
    public static void a(Path path, float f2, float f3, float f4) {
        e.a.a.c.a("applyTrimPathIfNeeded");
        PathMeasure pathMeasure = a.get();
        Path path2 = f11966b.get();
        Path path3 = f11967c.get();
        pathMeasure.setPath(path, false);
        float length = pathMeasure.getLength();
        if (f2 == 1.0f && f3 == 0.0f) {
            e.a.a.c.b("applyTrimPathIfNeeded");
    ...
    public static void b(Path path, s sVar) {
        ...
        a(path, ((e.a.a.u.c.c) sVar.h()).o() / 100.0f, ((e.a.a.u.c.c) sVar.e()).o() / 100.0f, ((e.a.a.u.c.c) sVar.g()).o() / 360.0f);
    }
    ...
    public static float e() {
        if (f11970f == -1.0f) {
            f11970f = Resources.getSystem().getDisplayMetrics().density;
        }
        return f11970f;
    }
    ...
    public static void n(Canvas canvas, RectF rectF, Paint paint, int i2) {
        e.a.a.c.a("Utils#saveLayer");
        if (Build.VERSION.SDK_INT < 23) {
            canvas.saveLayer(rectF, paint, i2);
        } else {
            canvas.saveLayer(rectF, paint);
        }
        e.a.a.c.b("Utils#saveLayer");
    }
}