...
public class IntegerPolynomial implements Polynomial {
    ...
    static {
        ...
        while (true) {
            ...
            BIGINT_PRIMES.add(BigInteger.valueOf(iArr[i2]));
            i2++;
        }
    }
        ...
        if (length <= 32) {
            ...
            for (int i4 = 0; i4 < i3; i4++) {
                for (int max = Math.max(0, (i4 - length) + 1); max <= Math.min(i4, length - 1); max++) {
                    ...
                    iArr3[i4] = iArr3[i4] + (iArr2[max] * iArr[i4 - max]);
                }
            }
    ...
    private BigInteger squareSum() {
        ...
        while (true) {
            ...
            bigInteger = bigInteger.add(BigInteger.valueOf(iArr[i2] * iArr[i2]));
            i2++;
        }
    }
    ...
    public void div(int i2) {
        ...
        while (true) {
            ...
            iArr[i4] = iArr[i4] + (iArr[i4] > 0 ? i3 : -i3);
            iArr[i4] = iArr[i4] / i2;
            i4++;
        }
    }
    ...
    public Resultant resultant() {
        ...
        for (int i3 = 0; i3 < length; i3++) {
            ...
            if (bigInteger3.compareTo(divide2) > 0) {
                bigIntPolynomial.coeffs[i3] = bigInteger3.subtract(multiply);
            }
            if (bigInteger3.compareTo(negate2) < 0) {
                bigIntPolynomial.coeffs[i3] = bigInteger3.add(multiply);
            }
        }
    ...
    */
    ...
    void shiftGap(int i2) {
        ...
        int i5 = 0;
        int i6 = 0;
        while (i4 < clone.length - 1) {
            int i7 = i4 + 1;
            int i8 = clone[i7] - clone[i4];
            if (i8 > i5) {
                i6 = clone[i4];
                i5 = i8;
            }
    ...
    public ModularResultant resultant(int i2) {
        ...
        while (degree > 0) {
            int invert = (Util.invert(integerPolynomial9.coeffs[degree], i2) * integerPolynomial8.coeffs[i6]) % i2;
            int i7 = i6 - degree;
            integerPolynomial8.multShiftSub(integerPolynomial9, invert, i7, i2);
            integerPolynomial6.multShiftSub(integerPolynomial7, invert, i7, i2);
            i6 = integerPolynomial8.degree();
            if (i6 < degree) {
                i4 = (i4 * Util.pow(integerPolynomial9.coeffs[degree], i5 - i6, i2)) % i2;
                if (i5 % 2 == 1 && degree % 2 == 1) {
                    i4 = (-i4) % i2;
                }
                i5 = degree;
                degree = i6;
        ...
        int pow = (i4 * Util.pow(integerPolynomial9.coeffs[0], i6, i2)) % i2;
        ...
        return new ModularResultant(new BigIntPolynomial(integerPolynomial7), BigInteger.valueOf(pow), BigInteger.valueOf(i2));
    }
}