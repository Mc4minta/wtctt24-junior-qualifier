...
public final class AdjustableMinerFeePresetAdapter$MinerFeeCustomHolder$bind$1 extends o implements l<View, x> {
    final /* synthetic */ AdjustableMinerFeePresetAdapter.MinerFeeCustomHolder this$0;

    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public AdjustableMinerFeePresetAdapter$MinerFeeCustomHolder$bind$1(AdjustableMinerFeePresetAdapter.MinerFeeCustomHolder minerFeeCustomHolder) {
        super(1);
    ...
    public final void invoke2(View it) {
        EditText editText;
        m.g(it, "it");
        editText = this.this$0.gasPriceField;
