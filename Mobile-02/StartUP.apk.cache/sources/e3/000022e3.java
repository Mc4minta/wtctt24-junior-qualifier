...
public final class SwapDisclaimerFragment$special$$inlined$viewModel$3 extends o implements kotlin.e0.c.a<f0> {
    final /* synthetic */ kotlin.e0.c.a $ownerProducer;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public SwapDisclaimerFragment$special$$inlined$viewModel$3(kotlin.e0.c.a aVar) {
        super(0);
