...
final class f {
    ...
    private int d() {
        ...
        for (int i2 = 1; i2 < this.f10101d + 1; i2++) {
            d[] d2 = this.f10099b[i2].d();
    ...
    private void e(int i2, int i3, d[] dVarArr) {
        d dVar = dVarArr[i3];
        d[] d2 = this.f10099b[i2 - 1].d();
        g[] gVarArr = this.f10099b;
        int i4 = i2 + 1;
    ...
    private void g() {
        g[] gVarArr = this.f10099b;
        if (gVarArr[0] == null || gVarArr[this.f10101d + 1] == null) {
            return;
        }
        d[] d2 = gVarArr[0].d();
        d[] d3 = this.f10099b[this.f10101d + 1].d();
        for (int i2 = 0; i2 < d2.length; i2++) {
            if (d2[i2] != null && d3[i2] != null && d2[i2].c() == d3[i2].c()) {
                for (int i3 = 1; i3 <= this.f10101d; i3++) {
                    d dVar = this.f10099b[i3].d()[i2];
                    if (dVar != null) {
                        dVar.i(d2[i2].c());
                        if (!dVar.g()) {
                            this.f10099b[i3].d()[i2] = null;
                        }
                    }
                }
            }
    ...
    private int h() {
        ...
        for (int i3 = 0; i3 < d2.length; i3++) {
            if (d2[i3] != null) {
                int c2 = d2[i3].c();
                int i4 = 0;
                for (int i5 = 1; i5 < this.f10101d + 1 && i4 < 2; i5++) {
                    d dVar = this.f10099b[i5].d()[i3];
                    if (dVar != null) {
                        i4 = c(c2, i4, dVar);
                        if (!dVar.g()) {
                            i2++;
    ...
    private int i() {
        ...
        for (int i4 = 0; i4 < d2.length; i4++) {
            if (d2[i4] != null) {
                int c2 = d2[i4].c();
                int i5 = 0;
                for (int i6 = this.f10101d + 1; i6 > 0 && i5 < 2; i6--) {
                    d dVar = this.f10099b[i6].d()[i4];
                    if (dVar != null) {
                        i5 = c(c2, i5, dVar);
                        if (!dVar.g()) {
                            i3++;
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public g n(int i2) {
        return this.f10099b[i2];
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    public g[] o() {
        a(this.f10099b[0]);
        a(this.f10099b[this.f10101d + 1]);
        int i2 = 928;
        while (true) {
            int d2 = d();
            if (d2 <= 0 || d2 >= i2) {
    ...
    public String toString() {
        ...
        g gVar = gVarArr[0];
        if (gVar == null) {
            gVar = gVarArr[this.f10101d + 1];
        }
        Formatter formatter = new Formatter();
        for (int i2 = 0; i2 < gVar.d().length; i2++) {
            try {
                formatter.format("CW %3d:", Integer.valueOf(i2));
                for (int i3 = 0; i3 < this.f10101d + 2; i3++) {
                    g[] gVarArr2 = this.f10099b;
                    if (gVarArr2[i3] == null) {
