...
final class EventProperty_ConsumerKt$OAuthType$2 extends o implements a<EventProperty> {
    public static final EventProperty_ConsumerKt$OAuthType$2 INSTANCE = new EventProperty_ConsumerKt$OAuthType$2();

    EventProperty_ConsumerKt$OAuthType$2() {
        super(0);
    }
    ...
    public final EventProperty invoke() {
        return new EventProperty("oauth_type");
    }
}