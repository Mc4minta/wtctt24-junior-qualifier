...
public enum NoLookupLocation implements LookupLocation {
    ...
    public static NoLookupLocation[] valuesCustom() {
        NoLookupLocation[] valuesCustom = values();
        NoLookupLocation[] noLookupLocationArr = new NoLookupLocation[valuesCustom.length];
        System.arraycopy(valuesCustom, 0, noLookupLocationArr, 0, valuesCustom.length);
