...
class LongArray implements Cloneable {
    ...
    private static long interleave3_13to65(int i2) {
        ...
        return (iArr[i2 & 127] & 4294967295L) | ((iArr[i2 >>> 7] & 4294967295L) << 35);
    }
    ...
    private static long interleave3_21to63(int i2) {
        ...
        return (i3 & 4294967295L) | ((iArr[i2 >>> 14] & 4294967295L) << 42) | ((i4 & 4294967295L) << 21);
    }

    private static long interleave4_16to64(int i2) {
        int[] iArr = INTERLEAVE4_TABLE;
        return (iArr[i2 & 255] & 4294967295L) | ((iArr[i2 >>> 8] & 4294967295L) << 32);
    }
    ...
    private static long interleave2_n(long j2, int i2) {
        while (i2 > 1) {
            i2 -= 2;
            j2 = (interleave4_16to64(((int) (j2 >>> 48)) & Settings.DEFAULT_INITIAL_WINDOW_SIZE) << 3) | (interleave4_16to64(((int) (j2 >>> 16)) & Settings.DEFAULT_INITIAL_WINDOW_SIZE) << 1) | interleave4_16to64(((int) j2) & Settings.DEFAULT_INITIAL_WINDOW_SIZE) | (interleave4_16to64(((int) (j2 >>> 32)) & Settings.DEFAULT_INITIAL_WINDOW_SIZE) << 2);
        }
        if (i2 > 0) {
