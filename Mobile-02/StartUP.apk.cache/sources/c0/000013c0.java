...
@Metadata(bv = {1, 0, 3}, d1 = {"\u0000.\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0010 \n\u0002\b\u0005\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0005\u0018\u00002\u00020\u0001B\u0013\u0012\n\u0010\u0011\u001a\u0006\u0012\u0002\b\u00030\u0010¢\u0006\u0004\b\u0013\u0010\u0014J\u001b\u0010\u0005\u001a\b\u0012\u0004\u0012\u00020\u00020\u00042\u0006\u0010\u0003\u001a\u00020\u0002¢\u0006\u0004\b\u0005\u0010\u0006J'\u0010\t\u001a\u000e\u0012\n\u0012\b\u0012\u0004\u0012\u00020\u00020\u00070\u00042\f\u0010\b\u001a\b\u0012\u0004\u0012\u00020\u00020\u0007¢\u0006\u0004\b\t\u0010\nJ\u0019\u0010\u000b\u001a\u000e\u0012\n\u0012\b\u0012\u0004\u0012\u00020\u00020\u00070\u0004¢\u0006\u0004\b\u000b\u0010\fJ\u0019\u0010\u000e\u001a\u000e\u0012\n\u0012\b\u0012\u0004\u0012\u00020\u00020\u00070\r¢\u0006\u0004\b\u000e\u0010\u000fR\u001a\u0010\u0011\u001a\u0006\u0012\u0002\b\u00030\u00108\u0002@\u0002X\u0082\u0004¢\u0006\u0006\n\u0004\b\u0011\u0010\u0012¨\u0006\u0015"}, d2 = {"Lcom/coinbase/wallet/blockchains/daos/WalletDao;", "", "Lcom/coinbase/wallet/blockchains/models/Wallet;", "wallet", "Lh/c/b0;", "save", "(Lcom/coinbase/wallet/blockchains/models/Wallet;)Lh/c/b0;", "", "wallets", "saveAll", "(Ljava/util/List;)Lh/c/b0;", "getWallets", "()Lh/c/b0;", "Lh/c/s;", "observeWallets", "()Lh/c/s;", "Lcom/coinbase/wallet/libraries/databases/db/Database;", "database", "Lcom/coinbase/wallet/libraries/databases/db/Database;", "<init>", "(Lcom/coinbase/wallet/libraries/databases/db/Database;)V", "blockchains_release"}, k = 1, mv = {1, 5, 1})
/* loaded from: classes.dex */
public final class WalletDao {
    private final Database<?> database;

    public WalletDao(Database<?> database) {
        m.g(database, "database");
        this.database = database;
    }

    public static /* synthetic */ List a(List list, Optional optional) {
        return m783saveAll$lambda1(list, optional);
    }

    public static /* synthetic */ Wallet b(Wallet wallet, Optional optional) {
        return m782save$lambda0(wallet, optional);
    }

    public static /* synthetic */ x c(WalletDao walletDao, Wallet wallet) {
        return m781observeWallets$lambda2(walletDao, wallet);
    }

    /* renamed from: observeWallets$lambda-2 */
    public static final x m781observeWallets$lambda2(WalletDao this$0, Wallet it) {
        m.g(this$0, "this$0");
        m.g(it, "it");
        return this$0.getWallets().toObservable();
    }

    /* renamed from: save$lambda-0 */
    public static final Wallet m782save$lambda0(Wallet wallet, Optional it) {
        m.g(wallet, "$wallet");
        m.g(it, "it");
        Wallet wallet2 = (Wallet) it.toNullable();
        if (wallet2 != null) {
            return wallet2;
        }
        throw new WalletException.UnableToSaveWallet(wallet);
    }

    /* renamed from: saveAll$lambda-1 */
    public static final List m783saveAll$lambda1(List wallets, Optional it) {
        m.g(wallets, "$wallets");
        m.g(it, "it");
        ...
        throw new WalletException.UnableToSaveWallets(wallets);
    }

    public final b0<List<Wallet>> getWallets() {
        ...
        b0<List<Wallet>> observeOn = b0.create(new f0() { // from class: com.coinbase.wallet.blockchains.daos.WalletDao$getWallets$$inlined$fetch$1
            @Override // h.c.f0
            public final void subscribe(d0<List<? extends T>> emitter) {
                Lock readLock;
                List<? extends T> fetch;
                m.g(emitter, "emitter");
                int i2 = WalletDao$getWallets$$inlined$fetch$1$1$wm$Storage$perform$1$WhenMappings.$EnumSwitchMapping$0[DatabaseOperation.this.ordinal()];
                boolean z = true;
                if (i2 == 1) {
                ...
                DatabaseDaoInterface<?> databaseDaoInterface = storage.getModelDaos().get(Wallet.class);
                ...
                if (databaseDaoInterface2 == null) {
                    emitter.onError(new DatabaseException.MissingDao(Wallet.class));
                    return;
                }
                readLock.lock();
    ...
    public final s<List<Wallet>> observeWallets() {
        h.c.v0.b<?> bVar;
        s<?> hide;
        ...
        try {
            if (storage.isDestroyed()) {
                hide = s.error(DatabaseException.DatabaseDestroyed.INSTANCE);
            } else {
                synchronized (storage) {
                    h.c.v0.b<?> bVar2 = storage.getObservers().get(Wallet.class);
                    bVar = bVar2 instanceof h.c.v0.b ? bVar2 : null;
                    if (bVar == null) {
                        bVar = h.c.v0.b.d();
                        storage.getObservers().put(Wallet.class, bVar);
                    }
                }
                hide = bVar.hide();
            }
            ...
            s<List<Wallet>> merge = s.merge(getWallets().toObservable(), hide.throttleLast(500L, TimeUnit.MILLISECONDS).flatMap(new n() { // from class: com.coinbase.wallet.blockchains.daos.e
                @Override // h.c.m0.n
                public final Object apply(Object obj) {
                    return WalletDao.c(WalletDao.this, (Wallet) obj);
                }
            }).distinctUntilChanged());
            m.f(merge, "merge(getWallets().toObservable(), continuousObserver)");
            return merge;
        } catch (Throwable th) {
            readLock.unlock();
            throw th;
    ...
    public final b0<Wallet> save(final Wallet wallet) {
        final List b2;
        m.g(wallet, "wallet");
        final Database<?> database = this.database;
        b2 = q.b(wallet);
        ...
        b0 observeOn = b0.create(new f0() { // from class: com.coinbase.wallet.blockchains.daos.WalletDao$save$$inlined$addOrUpdate$1
            @Override // h.c.f0
            public final void subscribe(d0<Optional<? extends List<? extends T>>> emitter) {
                Lock readLock;
                m.g(emitter, "emitter");
                int i2 = WalletDao$save$$inlined$addOrUpdate$1$1$wm$Storage$perform$1$WhenMappings.$EnumSwitchMapping$0[DatabaseOperation.this.ordinal()];
                if (i2 == 1) {
                    readLock = storage.getMultiReadSingleWriteLock().readLock();
                    m.f(readLock, "multiReadSingleWriteLock.readLock()");
                } else if (i2 != 2) {
        ...
        m.f(observeOn, "@Suppress(\"UNCHECKED_CAST\")\n    inline fun <reified T, reified R> perform(\n        operation: DatabaseOperation,\n        crossinline work: (dao: DatabaseDaoInterface<T>) -> R\n    ): Single<R> = Single\n        .create<R> { emitter ->\n            val lock: Lock = when (operation) {\n                DatabaseOperation.READ -> multiReadSingleWriteLock.readLock()\n                DatabaseOperation.WRITE -> multiReadSingleWriteLock.writeLock()\n            }\n\n            val dao = modelDaos[T::class.java] as? DatabaseDaoInterface<T>\n                ?: return@create emitter.onError(DatabaseException.MissingDao(T::class.java))\n\n            lock.lock()\n\n            if (isDestroyed) {\n                lock.unlock()\n                return@create emitter.onError(DatabaseException.DatabaseDestroyed)\n            }\n\n            try {\n                val result = work(dao) as? R ?: throw IllegalArgumentException(\"Invalid result\")\n                emitter.onSuccess(result)\n            } catch (err: Throwable) {\n                emitter.onError(err)\n            } finally {\n                lock.unlock()\n            }\n        }\n        .subscribeOn(scheduler)\n        .observeOn(scheduler)");
        b0 doAfterSuccess = observeOn.doAfterSuccess(new f() { // from class: com.coinbase.wallet.blockchains.daos.WalletDao$save$$inlined$addOrUpdate$2
                    ...
                    try {
                        ...
                        if (databaseModelObject2 != null) {
                            synchronized (storage2) {
                                h.c.v0.b<?> bVar2 = storage2.getObservers().get(Wallet.class);
                                bVar = bVar2 instanceof h.c.v0.b ? bVar2 : null;
                                if (bVar == null) {
                                    bVar = h.c.v0.b.d();
                                    storage2.getObservers().put(Wallet.class, bVar);
                                }
                            }
        ...
        b0 map = doAfterSuccess.map(new n() { // from class: com.coinbase.wallet.blockchains.daos.WalletDao$save$$inlined$addOrUpdate$3
        ...
        b0<Wallet> map2 = map.map(new n() { // from class: com.coinbase.wallet.blockchains.daos.d
            @Override // h.c.m0.n
            public final Object apply(Object obj) {
                return WalletDao.b(Wallet.this, (Optional) obj);
            }
        });
        m.f(map2, "database.addOrUpdate(wallet)\n        .map { it.toNullable() ?: throw WalletException.UnableToSaveWallet(wallet) }");
        return map2;
    }

    public final b0<List<Wallet>> saveAll(final List<Wallet> wallets) {
        m.g(wallets, "wallets");
        final Database<?> database = this.database;
        final Storage<?> storage = database.getStorage();
        final DatabaseOperation databaseOperation = DatabaseOperation.WRITE;
        b0 observeOn = b0.create(new f0() { // from class: com.coinbase.wallet.blockchains.daos.WalletDao$saveAll$$inlined$addOrUpdate$1
            @Override // h.c.f0
            public final void subscribe(d0<Optional<? extends List<? extends T>>> emitter) {
                Lock readLock;
                m.g(emitter, "emitter");
                int i2 = WalletDao$saveAll$$inlined$addOrUpdate$1$1$wm$Storage$perform$1$WhenMappings.$EnumSwitchMapping$0[DatabaseOperation.this.ordinal()];
                if (i2 == 1) {
                    readLock = storage.getMultiReadSingleWriteLock().readLock();
                    m.f(readLock, "multiReadSingleWriteLock.readLock()");
                } else if (i2 != 2) {
                ...
                try {
                    databaseDaoInterface2.addOrUpdate(wallets);
                    Optional<? extends List<? extends T>> optional2 = OptionalKt.toOptional(wallets);
                    if (optional2 instanceof Optional) {
                        optional = optional2;
                    }
                } finally {
        ...
        m.f(observeOn, "@Suppress(\"UNCHECKED_CAST\")\n    inline fun <reified T, reified R> perform(\n        operation: DatabaseOperation,\n        crossinline work: (dao: DatabaseDaoInterface<T>) -> R\n    ): Single<R> = Single\n        .create<R> { emitter ->\n            val lock: Lock = when (operation) {\n                DatabaseOperation.READ -> multiReadSingleWriteLock.readLock()\n                DatabaseOperation.WRITE -> multiReadSingleWriteLock.writeLock()\n            }\n\n            val dao = modelDaos[T::class.java] as? DatabaseDaoInterface<T>\n                ?: return@create emitter.onError(DatabaseException.MissingDao(T::class.java))\n\n            lock.lock()\n\n            if (isDestroyed) {\n                lock.unlock()\n                return@create emitter.onError(DatabaseException.DatabaseDestroyed)\n            }\n\n            try {\n                val result = work(dao) as? R ?: throw IllegalArgumentException(\"Invalid result\")\n                emitter.onSuccess(result)\n            } catch (err: Throwable) {\n                emitter.onError(err)\n            } finally {\n                lock.unlock()\n            }\n        }\n        .subscribeOn(scheduler)\n        .observeOn(scheduler)");
        b0 doAfterSuccess = observeOn.doAfterSuccess(new f() { // from class: com.coinbase.wallet.blockchains.daos.WalletDao$saveAll$$inlined$addOrUpdate$2
            public final void accept(Optional<? extends List<? extends T>> optional) {
                h.c.v0.b<?> bVar;
                List<DatabaseModelObject> list = wallets;
                Database database2 = database;
                for (DatabaseModelObject databaseModelObject : list) {
                    Storage storage2 = database2.getStorage();
                    Optional optional2 = OptionalKt.toOptional(databaseModelObject);
        ...
        m.f(doAfterSuccess, "T : RoomDatabaseProvider> private constructor() {\n    /**\n     * Manages the data underlying storage.\n     */\n    @PublishedApi\n    internal lateinit var storage: Storage<T>\n        private set\n\n    constructor(disk: DiskOptions<T>) : this() {\n        storage = Storage(disk)\n    }\n\n    constructor(memory: MemoryOptions<T>) : this() {\n        storage = Storage(memory)\n    }\n\n    /**\n     * Adds a new model to the database.\n     *\n     * @param model The model to add to the database.\n     *\n     * @return A Single wrapping an optional model indicating whether the add succeeded.\n     */\n    inline fun <reified T : DatabaseModelObject> add(\n        model: T\n    ): Single<Optional<T>> = add(listOf(model)).map { it.value?.firstOrNull().toOptional() }\n\n    /**\n     * Adds new models to the database.\n     *\n     * @param models The models to add to the database.\n     *\n     * @return A Single wrapping an optional list of models indicating whether the add succeeded.\n     */\n    @Suppress(\"UNCHECKED_CAST\")\n    inline fun <reified T : DatabaseModelObject> add(\n        models: List<T>\n    ): Single<Optional<List<T>>> = storage\n        .perform<T, Optional<List<T>>>(DatabaseOperation.WRITE) { dao ->\n            dao.add(models)\n\n            models.toOptional()\n        }\n        .doAfterSuccess { models.forEach { storage.notifyObservers(it.toOptional()) } }\n\n    /**\n     * Adds a new model or update if an existing record is found.\n     *\n     * @param model The model to add to the database.\n     *\n     * @return A Single wrapping an optional model indicating whether the add/update succeeded.\n     */\n    inline fun <reified T : DatabaseModelObject> addOrUpdate(\n        model: T\n    ): Single<Optional<T>> = addOrUpdate(listOf(model)).map { it.value?.firstOrNull().toOptional() }\n\n    /**\n     * Adds new models or update if existing records are found.\n     *\n     * @param models The models to add to the database.\n     *\n     * @return A Single wrapping an optional list of models indicating whether the add/update succeeded.\n     */\n    @Suppress(\"UNCHECKED_CAST\")\n    inline fun <reified T : DatabaseModelObject> addOrUpdate(\n        models: List<T>\n    ): Single<Optional<List<T>>> = storage\n        .perform<T, Optional<List<T>>>(DatabaseOperation.WRITE) { dao ->\n            dao.addOrUpdate(models)\n\n            models.toOptional()\n        }\n        .doAfterSuccess { models.forEach { storage.notifyObservers(it.toOptional()) } }");
        b0<List<Wallet>> map = doAfterSuccess.map(new n() { // from class: com.coinbase.wallet.blockchains.daos.c
            @Override // h.c.m0.n
            public final Object apply(Object obj) {
                return WalletDao.a(wallets, (Optional) obj);
            }
        });
        m.f(map, "database.addOrUpdate(wallets)\n        .map { it.toNullable() ?: throw WalletException.UnableToSaveWallets(wallets) }");
        return map;
    }
}