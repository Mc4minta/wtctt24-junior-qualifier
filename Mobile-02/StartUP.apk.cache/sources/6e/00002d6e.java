...
public class JavaMethodWrapper implements NativeModule.NativeMethod {
    ...
    private static final boolean DEBUG = c.a().a(a.f12128d);
                    ...
                    if (cls != Double.class && cls != Double.TYPE) {
                        if (cls != Float.class && cls != Float.TYPE) {
                            if (cls == String.class) {
                                ...
                                e.f.k.a.a.b(i2 == clsArr.length - 1, "Promise must be used as last parameter only");
    ...
    private int calculateJSArgumentsNeeded() {
        int i2 = 0;
        for (ArgumentExtractor argumentExtractor : (ArgumentExtractor[]) e.f.k.a.a.c(this.mArgumentExtractors)) {
    ...
    private void processArguments() {
        ...
        b.AbstractC0130b a = b.a(0L, "processArguments");
        a.b("method", this.mModuleWrapper.getName() + "." + this.mMethod.getName()).c();
        try {
    ...
    public String getSignature() {
        ...
        return (String) e.f.k.a.a.c(this.mSignature);
    }
    ...
    public void invoke(JSInstance jSInstance, ReadableArray readableArray) {
        ...
        int i2 = 0;
        if (DEBUG) {
            c.a().b(a.f12128d, "JS->Java: %s.%s()", this.mModuleWrapper.getName(), this.mMethod.getName());
        }
        try {
            if (!this.mArgumentsProcessed) {
                processArguments();
