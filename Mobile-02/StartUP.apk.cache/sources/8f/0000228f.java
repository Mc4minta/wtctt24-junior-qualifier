...
public final class SwapAmountPickerAdapter$setupListeners$1 extends o implements l<View, x> {
    final /* synthetic */ SwapAmountPickerAdapter this$0;

    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public SwapAmountPickerAdapter$setupListeners$1(SwapAmountPickerAdapter swapAmountPickerAdapter) {
        super(1);
    ...
    public final void invoke2(View it) {
        ...
        swapAmountPickerViewModel.selectAsset(AmountBase.Target.INSTANCE);
    }
}