...
final class EventProperty_ApplicationKt$BackupService$2 extends o implements a<EventProperty> {
    public static final EventProperty_ApplicationKt$BackupService$2 INSTANCE = new EventProperty_ApplicationKt$BackupService$2();

    EventProperty_ApplicationKt$BackupService$2() {
        super(0);
    }
    ...
    public final EventProperty invoke() {
        return new EventProperty("backup_service");
    }
}