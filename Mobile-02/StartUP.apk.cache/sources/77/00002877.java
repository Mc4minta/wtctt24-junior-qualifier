...
@Metadata(bv = {1, 0, 3}, d1 = {"\u0000,\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\u0010 \n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0005\b\u0000\u0018\u00002\u00020\u0001B\u0013\u0012\n\u0010\u000e\u001a\u0006\u0012\u0002\b\u00030\r¢\u0006\u0004\b\u0010\u0010\u0011J-\u0010\u0007\u001a\u0014\u0012\u0010\u0012\u000e\u0012\n\u0012\b\u0012\u0004\u0012\u00020\u00030\u00020\u00060\u00052\f\u0010\u0004\u001a\b\u0012\u0004\u0012\u00020\u00030\u0002¢\u0006\u0004\b\u0007\u0010\bJ\u0019\u0010\t\u001a\u000e\u0012\n\u0012\b\u0012\u0004\u0012\u00020\u00030\u00020\u0005¢\u0006\u0004\b\t\u0010\nJ'\u0010\t\u001a\u000e\u0012\n\u0012\b\u0012\u0004\u0012\u00020\u00030\u00020\u00052\f\u0010\f\u001a\b\u0012\u0004\u0012\u00020\u000b0\u0002¢\u0006\u0004\b\t\u0010\bR\u001a\u0010\u000e\u001a\u0006\u0012\u0002\b\u00030\r8\u0002@\u0002X\u0082\u0004¢\u0006\u0006\n\u0004\b\u000e\u0010\u000f¨\u0006\u0012"}, d2 = {"Lcom/coinbase/wallet/wallets/daos/CryptoCurrencyDAO;", "", "", "Lcom/coinbase/wallet/wallets/models/CryptoCurrency;", "cryptoCurrencies", "Lh/c/b0;", "Lcom/coinbase/wallet/core/util/Optional;", "saveCryptoCurrencies", "(Ljava/util/List;)Lh/c/b0;", "getCryptoCurrencies", "()Lh/c/b0;", "Lcom/coinbase/wallet/blockchains/models/CurrencyCode;", "currencyCodes", "Lcom/coinbase/wallet/libraries/databases/db/Database;", "database", "Lcom/coinbase/wallet/libraries/databases/db/Database;", "<init>", "(Lcom/coinbase/wallet/libraries/databases/db/Database;)V", "wallets_release"}, k = 1, mv = {1, 5, 1})
/* loaded from: classes2.dex */
public final class CryptoCurrencyDAO {
    private final Database<?> database;

    public CryptoCurrencyDAO(Database<?> database) {
        m.g(database, "database");
        this.database = database;
    }

    public final b0<List<CryptoCurrency>> getCryptoCurrencies() {
        ...
        b0<List<CryptoCurrency>> observeOn = b0.create(new f0() { // from class: com.coinbase.wallet.wallets.daos.CryptoCurrencyDAO$getCryptoCurrencies$$inlined$fetch$1
            @Override // h.c.f0
            public final void subscribe(d0<List<? extends T>> emitter) {
                Lock readLock;
                List<? extends T> fetch;
                m.g(emitter, "emitter");
                int i2 = CryptoCurrencyDAO$getCryptoCurrencies$$inlined$fetch$1$1$wm$Storage$perform$1$WhenMappings.$EnumSwitchMapping$0[DatabaseOperation.this.ordinal()];
                boolean z = true;
                if (i2 == 1) {
                ...
                DatabaseDaoInterface<?> databaseDaoInterface = storage.getModelDaos().get(CryptoCurrency.class);
                ...
                if (databaseDaoInterface2 == null) {
                    emitter.onError(new DatabaseException.MissingDao(CryptoCurrency.class));
                    return;
                }
                readLock.lock();
    ...
    public final b0<Optional<List<CryptoCurrency>>> saveCryptoCurrencies(final List<CryptoCurrency> cryptoCurrencies) {
        m.g(cryptoCurrencies, "cryptoCurrencies");
        final Database<?> database = this.database;
        final Storage<?> storage = database.getStorage();
        final DatabaseOperation databaseOperation = DatabaseOperation.WRITE;
        b0 observeOn = b0.create(new f0() { // from class: com.coinbase.wallet.wallets.daos.CryptoCurrencyDAO$saveCryptoCurrencies$$inlined$addOrUpdate$1
            @Override // h.c.f0
            public final void subscribe(d0<Optional<? extends List<? extends T>>> emitter) {
                Lock readLock;
                m.g(emitter, "emitter");
                int i2 = CryptoCurrencyDAO$saveCryptoCurrencies$$inlined$addOrUpdate$1$1$wm$Storage$perform$1$WhenMappings.$EnumSwitchMapping$0[DatabaseOperation.this.ordinal()];
                if (i2 == 1) {
                    readLock = storage.getMultiReadSingleWriteLock().readLock();
                    m.f(readLock, "multiReadSingleWriteLock.readLock()");
                } else if (i2 != 2) {
                ...
                try {
                    databaseDaoInterface2.addOrUpdate(cryptoCurrencies);
                    Optional<? extends List<? extends T>> optional2 = OptionalKt.toOptional(cryptoCurrencies);
        ...
        m.f(observeOn, "@Suppress(\"UNCHECKED_CAST\")\n    inline fun <reified T, reified R> perform(\n        operation: DatabaseOperation,\n        crossinline work: (dao: DatabaseDaoInterface<T>) -> R\n    ): Single<R> = Single\n        .create<R> { emitter ->\n            val lock: Lock = when (operation) {\n                DatabaseOperation.READ -> multiReadSingleWriteLock.readLock()\n                DatabaseOperation.WRITE -> multiReadSingleWriteLock.writeLock()\n            }\n\n            val dao = modelDaos[T::class.java] as? DatabaseDaoInterface<T>\n                ?: return@create emitter.onError(DatabaseException.MissingDao(T::class.java))\n\n            lock.lock()\n\n            if (isDestroyed) {\n                lock.unlock()\n                return@create emitter.onError(DatabaseException.DatabaseDestroyed)\n            }\n\n            try {\n                val result = work(dao) as? R ?: throw IllegalArgumentException(\"Invalid result\")\n                emitter.onSuccess(result)\n            } catch (err: Throwable) {\n                emitter.onError(err)\n            } finally {\n                lock.unlock()\n            }\n        }\n        .subscribeOn(scheduler)\n        .observeOn(scheduler)");
        b0<Optional<List<CryptoCurrency>>> doAfterSuccess = observeOn.doAfterSuccess(new f() { // from class: com.coinbase.wallet.wallets.daos.CryptoCurrencyDAO$saveCryptoCurrencies$$inlined$addOrUpdate$2
            public final void accept(Optional<? extends List<? extends T>> optional) {
                b<?> bVar;
                List<DatabaseModelObject> list = cryptoCurrencies;
                Database database2 = database;
                    ...
                    try {
                        ...
                        if (databaseModelObject2 != null) {
                            synchronized (storage2) {
                                b<?> bVar2 = storage2.getObservers().get(CryptoCurrency.class);
                                bVar = bVar2 instanceof b ? bVar2 : null;
                                if (bVar == null) {
                                    bVar = b.d();
                                    storage2.getObservers().put(CryptoCurrency.class, bVar);
                                }
                            }
    ...
    public final b0<List<CryptoCurrency>> getCryptoCurrencies(List<CurrencyCode> currencyCodes) {
        int r;
        m.g(currencyCodes, "currencyCodes");
        final Database<?> database = this.database;
        final Object[] objArr = new Object[1];
        r = s.r(currencyCodes, 10);
        ...
        final Storage<?> storage = database.getStorage();
        final DatabaseOperation databaseOperation = DatabaseOperation.READ;
        b0<List<CryptoCurrency>> observeOn = b0.create(new f0() { // from class: com.coinbase.wallet.wallets.daos.CryptoCurrencyDAO$getCryptoCurrencies$$inlined$fetch$2
            @Override // h.c.f0
            public final void subscribe(d0<List<? extends T>> emitter) {
                Lock readLock;
                List<? extends T> fetch;
                m.g(emitter, "emitter");
                int i2 = CryptoCurrencyDAO$getCryptoCurrencies$$inlined$fetch$2$1$wm$Storage$perform$1$WhenMappings.$EnumSwitchMapping$0[DatabaseOperation.this.ordinal()];
                boolean z = true;
                if (i2 == 1) {
                    readLock = storage.getMultiReadSingleWriteLock().readLock();
                    m.f(readLock, "multiReadSingleWriteLock.readLock()");
